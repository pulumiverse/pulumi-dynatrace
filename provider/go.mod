...
require (
	github.com/dynatrace-oss/terraform-provider-dynatrace v1.102.0
...
require (
	...
	github.com/dynatrace/dynatrace-configuration-as-code-core v0.9.1-0.20260707095607-540d9090df78 // indirect
