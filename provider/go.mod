...
require (
	github.com/dynatrace-oss/terraform-provider-dynatrace v1.104.0
...
require (
	...
	github.com/dynatrace/dynatrace-configuration-as-code-core v0.9.1-0.20260818115934-1cf513833d69 // indirect
