...
require (
	github.com/dynatrace-oss/terraform-provider-dynatrace v1.100.0
...
require (
	...
	github.com/dynatrace/dynatrace-configuration-as-code-core v0.9.1-0.20260603140430-e4e946cfe203 // indirect
