...
require (
	github.com/dynatrace-oss/terraform-provider-dynatrace v1.83.0
...
require (
	...
	github.com/dynatrace/dynatrace-configuration-as-code-core v0.9.1-0.20250723103928-4514849be7dd // indirect
