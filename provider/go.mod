...
require (
	github.com/dynatrace-oss/terraform-provider-dynatrace v1.68.1
...
require (
	...
	github.com/dynatrace/dynatrace-configuration-as-code-core v0.6.2-0.20240820151300-7a1e1fd15eb5 // indirect
