...
require (
	github.com/dynatrace-oss/terraform-provider-dynatrace v1.80.0
...
require (
	...
	github.com/dynatrace/dynatrace-configuration-as-code-core v0.8.1-0.20250514143234-94fb2ef0c525 // indirect
