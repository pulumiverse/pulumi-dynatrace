...
require (
	github.com/dynatrace-oss/terraform-provider-dynatrace v1.86.0
...
require (
	...
	github.com/dynatrace/dynatrace-configuration-as-code-core v0.9.1-0.20251009114407-8d3182906541 // indirect
