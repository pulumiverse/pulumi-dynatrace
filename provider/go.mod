...
require (
	github.com/dynatrace-oss/terraform-provider-dynatrace v1.96.0
...
require (
	...
	github.com/dynatrace/dynatrace-configuration-as-code-core v0.9.1-0.20260428113012-406b6ed7b4eb // indirect
