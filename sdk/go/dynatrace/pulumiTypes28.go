...
type GetIamEnvironmentsEnvironment struct {
...
// GetIamEnvironmentsEnvironmentInput is an input type that accepts GetIamEnvironmentsEnvironmentArgs and GetIamEnvironmentsEnvironmentOutput values.
// You can construct a concrete instance of `GetIamEnvironmentsEnvironmentInput` via:
//
//	GetIamEnvironmentsEnvironmentArgs{...}
type GetIamEnvironmentsEnvironmentInput interface {
	pulumi.Input

	ToGetIamEnvironmentsEnvironmentOutput() GetIamEnvironmentsEnvironmentOutput
	ToGetIamEnvironmentsEnvironmentOutputWithContext(context.Context) GetIamEnvironmentsEnvironmentOutput
}

type GetIamEnvironmentsEnvironmentArgs struct {
	// Property to determine if environment is active
...
func (GetIamEnvironmentsEnvironmentArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetIamEnvironmentsEnvironment)(nil)).Elem()
}

func (i GetIamEnvironmentsEnvironmentArgs) ToGetIamEnvironmentsEnvironmentOutput() GetIamEnvironmentsEnvironmentOutput {
	return i.ToGetIamEnvironmentsEnvironmentOutputWithContext(context.Background())
}

func (i GetIamEnvironmentsEnvironmentArgs) ToGetIamEnvironmentsEnvironmentOutputWithContext(ctx context.Context) GetIamEnvironmentsEnvironmentOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetIamEnvironmentsEnvironmentOutput)
}

// GetIamEnvironmentsEnvironmentArrayInput is an input type that accepts GetIamEnvironmentsEnvironmentArray and GetIamEnvironmentsEnvironmentArrayOutput values.
// You can construct a concrete instance of `GetIamEnvironmentsEnvironmentArrayInput` via:
//
//	GetIamEnvironmentsEnvironmentArray{ GetIamEnvironmentsEnvironmentArgs{...} }
type GetIamEnvironmentsEnvironmentArrayInput interface {
	pulumi.Input

	ToGetIamEnvironmentsEnvironmentArrayOutput() GetIamEnvironmentsEnvironmentArrayOutput
	ToGetIamEnvironmentsEnvironmentArrayOutputWithContext(context.Context) GetIamEnvironmentsEnvironmentArrayOutput
}

type GetIamEnvironmentsEnvironmentArray []GetIamEnvironmentsEnvironmentInput

func (GetIamEnvironmentsEnvironmentArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetIamEnvironmentsEnvironment)(nil)).Elem()
}

func (i GetIamEnvironmentsEnvironmentArray) ToGetIamEnvironmentsEnvironmentArrayOutput() GetIamEnvironmentsEnvironmentArrayOutput {
	return i.ToGetIamEnvironmentsEnvironmentArrayOutputWithContext(context.Background())
}

func (i GetIamEnvironmentsEnvironmentArray) ToGetIamEnvironmentsEnvironmentArrayOutputWithContext(ctx context.Context) GetIamEnvironmentsEnvironmentArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetIamEnvironmentsEnvironmentArrayOutput)
}

type GetIamEnvironmentsEnvironmentOutput struct{ *pulumi.OutputState }

func (GetIamEnvironmentsEnvironmentOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetIamEnvironmentsEnvironment)(nil)).Elem()
}

func (o GetIamEnvironmentsEnvironmentOutput) ToGetIamEnvironmentsEnvironmentOutput() GetIamEnvironmentsEnvironmentOutput {
	return o
}

func (o GetIamEnvironmentsEnvironmentOutput) ToGetIamEnvironmentsEnvironmentOutputWithContext(ctx context.Context) GetIamEnvironmentsEnvironmentOutput {
	return o
}

// Property to determine if environment is active
func (o GetIamEnvironmentsEnvironmentOutput) Active() pulumi.BoolOutput {
	return o.ApplyT(func(v GetIamEnvironmentsEnvironment) bool { return v.Active }).(pulumi.BoolOutput)
}

// The ID of the environment
func (o GetIamEnvironmentsEnvironmentOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v GetIamEnvironmentsEnvironment) string { return v.Id }).(pulumi.StringOutput)
}

// Friendly name of the environment
func (o GetIamEnvironmentsEnvironmentOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v GetIamEnvironmentsEnvironment) string { return v.Name }).(pulumi.StringOutput)
}

// The URL of the environment
func (o GetIamEnvironmentsEnvironmentOutput) Url() pulumi.StringOutput {
	return o.ApplyT(func(v GetIamEnvironmentsEnvironment) string { return v.Url }).(pulumi.StringOutput)
}

type GetIamEnvironmentsEnvironmentArrayOutput struct{ *pulumi.OutputState }

func (GetIamEnvironmentsEnvironmentArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetIamEnvironmentsEnvironment)(nil)).Elem()
}

func (o GetIamEnvironmentsEnvironmentArrayOutput) ToGetIamEnvironmentsEnvironmentArrayOutput() GetIamEnvironmentsEnvironmentArrayOutput {
	return o
}

func (o GetIamEnvironmentsEnvironmentArrayOutput) ToGetIamEnvironmentsEnvironmentArrayOutputWithContext(ctx context.Context) GetIamEnvironmentsEnvironmentArrayOutput {
	return o
}

func (o GetIamEnvironmentsEnvironmentArrayOutput) Index(i pulumi.IntInput) GetIamEnvironmentsEnvironmentOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GetIamEnvironmentsEnvironment {
		return vs[0].([]GetIamEnvironmentsEnvironment)[vs[1].(int)]
	}).(GetIamEnvironmentsEnvironmentOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GetIamEnvironmentsEnvironmentInput)(nil)).Elem(), GetIamEnvironmentsEnvironmentArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetIamEnvironmentsEnvironmentArrayInput)(nil)).Elem(), GetIamEnvironmentsEnvironmentArray{})
	...
	pulumi.RegisterOutputType(GetIamEnvironmentsEnvironmentOutput{})
	pulumi.RegisterOutputType(GetIamEnvironmentsEnvironmentArrayOutput{})
