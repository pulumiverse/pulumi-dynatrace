...
@CustomType
public final class ManagementZoneRuleConditionIntegerComparison {
    ...
    public static Builder builder(ManagementZoneRuleConditionIntegerComparison defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer value;
        public Builder() {}
        public Builder(ManagementZoneRuleConditionIntegerComparison defaults) {
        ...
        public ManagementZoneRuleConditionIntegerComparison build() {
            final var o = new ManagementZoneRuleConditionIntegerComparison();
            o.negate = negate;
            o.operator = operator;
            o.type = type;
            o.unknowns = unknowns;
