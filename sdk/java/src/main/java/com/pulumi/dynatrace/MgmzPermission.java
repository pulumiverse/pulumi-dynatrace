...
import com.pulumi.dynatrace.inputs.MgmzPermissionState;
import java.lang.String;
import java.util.List;
import javax.annotation.Nullable;

@ResourceType(type="dynatrace:index/mgmzPermission:MgmzPermission")
public class MgmzPermission extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public MgmzPermission(String name) {
        this(name, MgmzPermissionArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public MgmzPermission(String name, MgmzPermissionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("dynatrace:index/mgmzPermission:MgmzPermission", name, args == null ? MgmzPermissionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private MgmzPermission(String name, Output<String> id, @Nullable MgmzPermissionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("dynatrace:index/mgmzPermission:MgmzPermission", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static MgmzPermission get(String name, Output<String> id, @Nullable MgmzPermissionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
