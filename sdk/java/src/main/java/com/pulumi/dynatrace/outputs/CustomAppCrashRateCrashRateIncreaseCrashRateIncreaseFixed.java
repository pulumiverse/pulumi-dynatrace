...
@CustomType
public final class CustomAppCrashRateCrashRateIncreaseCrashRateIncreaseFixed {
    ...
    public static Builder builder(CustomAppCrashRateCrashRateIncreaseCrashRateIncreaseFixed defaults) {
    ...
    public static final class Builder {
        ...
        private Integer concurrentUsers;
        public Builder() {}
        public Builder(CustomAppCrashRateCrashRateIncreaseCrashRateIncreaseFixed defaults) {
        ...
        public CustomAppCrashRateCrashRateIncreaseCrashRateIncreaseFixed build() {
            final var o = new CustomAppCrashRateCrashRateIncreaseCrashRateIncreaseFixed();
