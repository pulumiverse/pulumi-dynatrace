...
public final class CustomAppAnomaliesUnexpectedHighLoadArgs extends com.pulumi.resources.ResourceArgs {

    public static final CustomAppAnomaliesUnexpectedHighLoadArgs Empty = new CustomAppAnomaliesUnexpectedHighLoadArgs();
    ...
    private CustomAppAnomaliesUnexpectedHighLoadArgs() {}

    private CustomAppAnomaliesUnexpectedHighLoadArgs(CustomAppAnomaliesUnexpectedHighLoadArgs $) {
    ...
    public static Builder builder(CustomAppAnomaliesUnexpectedHighLoadArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CustomAppAnomaliesUnexpectedHighLoadArgs();
        }

        public Builder(CustomAppAnomaliesUnexpectedHighLoadArgs defaults) {
            $ = new CustomAppAnomaliesUnexpectedHighLoadArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CustomAppAnomaliesUnexpectedHighLoadArgs build() {
