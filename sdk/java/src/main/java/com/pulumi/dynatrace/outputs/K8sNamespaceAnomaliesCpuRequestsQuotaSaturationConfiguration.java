...
@CustomType
public final class K8sNamespaceAnomaliesCpuRequestsQuotaSaturationConfiguration {
    ...
    public static Builder builder(K8sNamespaceAnomaliesCpuRequestsQuotaSaturationConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer threshold;
        public Builder() {}
        public Builder(K8sNamespaceAnomaliesCpuRequestsQuotaSaturationConfiguration defaults) {
        ...
        public K8sNamespaceAnomaliesCpuRequestsQuotaSaturationConfiguration build() {
            final var o = new K8sNamespaceAnomaliesCpuRequestsQuotaSaturationConfiguration();
