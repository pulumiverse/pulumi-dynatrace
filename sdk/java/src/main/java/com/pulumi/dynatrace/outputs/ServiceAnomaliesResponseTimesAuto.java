...
@CustomType
public final class ServiceAnomaliesResponseTimesAuto {
    /**
    ...
    public static Builder builder(ServiceAnomaliesResponseTimesAuto defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String unknowns;
        public Builder() {}
        public Builder(ServiceAnomaliesResponseTimesAuto defaults) {
        ...
        public ServiceAnomaliesResponseTimesAuto build() {
            final var o = new ServiceAnomaliesResponseTimesAuto();
            o.load = load;
