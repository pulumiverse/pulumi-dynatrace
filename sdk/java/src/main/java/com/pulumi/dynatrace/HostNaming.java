...
import com.pulumi.dynatrace.HostNamingArgs;
import com.pulumi.dynatrace.Utilities;
import com.pulumi.dynatrace.inputs.HostNamingState;
import com.pulumi.dynatrace.outputs.HostNamingCondition;
...
@ResourceType(type="dynatrace:index/hostNaming:HostNaming")
public class HostNaming extends com.pulumi.resources.CustomResource {
    /**
     * A list of matching conditions of the rule. The rule applies only if **all** conditions are fulfilled
     * 
     */
    @Export(name="conditions", type=List.class, parameters={HostNamingCondition.class})
    private Output</* @Nullable */ List<HostNamingCondition>> conditions;

    /**
     * @return A list of matching conditions of the rule. The rule applies only if **all** conditions are fulfilled
     * 
     */
    public Output<Optional<List<HostNamingCondition>>> conditions() {
     ...
     */
    public HostNaming(String name) {
        this(name, HostNamingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public HostNaming(String name, HostNamingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("dynatrace:index/hostNaming:HostNaming", name, args == null ? HostNamingArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private HostNaming(String name, Output<String> id, @Nullable HostNamingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("dynatrace:index/hostNaming:HostNaming", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static HostNaming get(String name, Output<String> id, @Nullable HostNamingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
