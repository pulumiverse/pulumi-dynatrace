...
public final class DiskAnomaliesState extends com.pulumi.resources.ResourceArgs {

    public static final DiskAnomaliesState Empty = new DiskAnomaliesState();
     ...
     */
    @Import(name="samples")
    private @Nullable Output<Integer> samples;

    /**
     * @return The number of samples to evaluate
     * 
     */
    public Optional<Output<Integer>> samples() {
     ...
     * 
     */
    @Import(name="violatingSamples")
    private @Nullable Output<Integer> violatingSamples;
     ...
     * 
     */
    public Optional<Output<Integer>> violatingSamples() {
        return Optional.ofNullable(this.violatingSamples);
    }

    private DiskAnomaliesState() {}

    private DiskAnomaliesState(DiskAnomaliesState $) {
    ...
    public static Builder builder(DiskAnomaliesState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DiskAnomaliesState();
        }

        public Builder(DiskAnomaliesState defaults) {
            $ = new DiskAnomaliesState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder samples(@Nullable Output<Integer> samples) {
            $.samples = samples;
            return this;
        }
         ...
         * 
         */
        public Builder violatingSamples(@Nullable Output<Integer> violatingSamples) {
        ...
        public DiskAnomaliesState build() {
            return $;
        }
    }
