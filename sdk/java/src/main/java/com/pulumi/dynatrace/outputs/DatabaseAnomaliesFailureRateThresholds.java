...
@CustomType
public final class DatabaseAnomaliesFailureRateThresholds {
    ...
    public static Builder builder(DatabaseAnomaliesFailureRateThresholds defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String unknowns;
        public Builder() {}
        public Builder(DatabaseAnomaliesFailureRateThresholds defaults) {
        ...
        public DatabaseAnomaliesFailureRateThresholds build() {
            final var o = new DatabaseAnomaliesFailureRateThresholds();
