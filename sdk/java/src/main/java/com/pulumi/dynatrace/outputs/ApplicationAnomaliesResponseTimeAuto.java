...
@CustomType
public final class ApplicationAnomaliesResponseTimeAuto {
    private String load;
    ...
    public static Builder builder(ApplicationAnomaliesResponseTimeAuto defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String unknowns;
        public Builder() {}
        public Builder(ApplicationAnomaliesResponseTimeAuto defaults) {
        ...
        public ApplicationAnomaliesResponseTimeAuto build() {
            final var o = new ApplicationAnomaliesResponseTimeAuto();
            o.load = load;
