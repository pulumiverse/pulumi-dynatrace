...
public final class DatabaseAnomaliesV2LoadSpikesArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatabaseAnomaliesV2LoadSpikesArgs Empty = new DatabaseAnomaliesV2LoadSpikesArgs();
    ...
    private DatabaseAnomaliesV2LoadSpikesArgs() {}

    private DatabaseAnomaliesV2LoadSpikesArgs(DatabaseAnomaliesV2LoadSpikesArgs $) {
    ...
    public static Builder builder(DatabaseAnomaliesV2LoadSpikesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatabaseAnomaliesV2LoadSpikesArgs();
        }

        public Builder(DatabaseAnomaliesV2LoadSpikesArgs defaults) {
            $ = new DatabaseAnomaliesV2LoadSpikesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DatabaseAnomaliesV2LoadSpikesArgs build() {
