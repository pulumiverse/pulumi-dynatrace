...
public final class DduPoolLogMonitoringArgs extends com.pulumi.resources.ResourceArgs {

    public static final DduPoolLogMonitoringArgs Empty = new DduPoolLogMonitoringArgs();
    ...
    private DduPoolLogMonitoringArgs() {}

    private DduPoolLogMonitoringArgs(DduPoolLogMonitoringArgs $) {
    ...
    public static Builder builder(DduPoolLogMonitoringArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DduPoolLogMonitoringArgs();
        }

        public Builder(DduPoolLogMonitoringArgs defaults) {
            $ = new DduPoolLogMonitoringArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DduPoolLogMonitoringArgs build() {
