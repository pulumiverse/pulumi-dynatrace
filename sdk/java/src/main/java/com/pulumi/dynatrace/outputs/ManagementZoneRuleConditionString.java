...
@CustomType
public final class ManagementZoneRuleConditionString {
    ...
    public static Builder builder(ManagementZoneRuleConditionString defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(ManagementZoneRuleConditionString defaults) {
        ...
        public ManagementZoneRuleConditionString build() {
            final var o = new ManagementZoneRuleConditionString();
