...
public final class DashboardSharingArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardSharingArgs Empty = new DashboardSharingArgs();
    ...
    private DashboardSharingArgs() {}

    private DashboardSharingArgs(DashboardSharingArgs $) {
    ...
    public static Builder builder(DashboardSharingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardSharingArgs();
        }

        public Builder(DashboardSharingArgs defaults) {
            $ = new DashboardSharingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardSharingArgs build() {
