...
@CustomType
public final class DatabaseAnomaliesV2LoadSpikes {
    /**
    ...
    public static Builder builder(DatabaseAnomaliesV2LoadSpikes defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer minutesAbnormalState;
        public Builder() {}
        public Builder(DatabaseAnomaliesV2LoadSpikes defaults) {
        ...
        public DatabaseAnomaliesV2LoadSpikes build() {
            final var o = new DatabaseAnomaliesV2LoadSpikes();
            o.enabled = enabled;
