...
public final class K8sClusterAnomaliesMemoryRequestsSaturationConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final K8sClusterAnomaliesMemoryRequestsSaturationConfigurationArgs Empty = new K8sClusterAnomaliesMemoryRequestsSaturationConfigurationArgs();
    ...
    private K8sClusterAnomaliesMemoryRequestsSaturationConfigurationArgs() {}

    private K8sClusterAnomaliesMemoryRequestsSaturationConfigurationArgs(K8sClusterAnomaliesMemoryRequestsSaturationConfigurationArgs $) {
    ...
    public static Builder builder(K8sClusterAnomaliesMemoryRequestsSaturationConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new K8sClusterAnomaliesMemoryRequestsSaturationConfigurationArgs();
        }

        public Builder(K8sClusterAnomaliesMemoryRequestsSaturationConfigurationArgs defaults) {
            $ = new K8sClusterAnomaliesMemoryRequestsSaturationConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public K8sClusterAnomaliesMemoryRequestsSaturationConfigurationArgs build() {
