...
public final class ProcessAvailabilityState extends com.pulumi.resources.ResourceArgs {

    public static final ProcessAvailabilityState Empty = new ProcessAvailabilityState();
    ...
    private ProcessAvailabilityState() {}

    private ProcessAvailabilityState(ProcessAvailabilityState $) {
    ...
    public static Builder builder(ProcessAvailabilityState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProcessAvailabilityState();
        }

        public Builder(ProcessAvailabilityState defaults) {
            $ = new ProcessAvailabilityState(Objects.requireNonNull(defaults));
        }
        ...
        public ProcessAvailabilityState build() {
            return $;
        }
    }
