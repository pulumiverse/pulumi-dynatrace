...
@CustomType
public final class ServiceAnomaliesResponseTimesThresholds {
    /**
    ...
    public static Builder builder(ServiceAnomaliesResponseTimesThresholds defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String unknowns;
        public Builder() {}
        public Builder(ServiceAnomaliesResponseTimesThresholds defaults) {
        ...
        public ServiceAnomaliesResponseTimesThresholds build() {
            final var o = new ServiceAnomaliesResponseTimesThresholds();
            o.load = load;
