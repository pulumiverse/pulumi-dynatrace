...
import com.pulumi.dynatrace.outputs.DashboardTileFilterManagementZone;
...
@CustomType
public final class DashboardTileFilter {
    private @Nullable List<DashboardTileFilterManagementZone> managementZones;
    ...
    public List<DashboardTileFilterManagementZone> managementZones() {
    ...
    public static Builder builder(DashboardTileFilter defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String unknowns;
        public Builder() {}
        public Builder(DashboardTileFilter defaults) {
        ...
        @CustomType.Setter
        public Builder managementZones(@Nullable List<DashboardTileFilterManagementZone> managementZones) {
            this.managementZones = managementZones;
            return this;
        }
        public Builder managementZones(DashboardTileFilterManagementZone... managementZones) {
        ...
        public DashboardTileFilter build() {
            final var o = new DashboardTileFilter();
