...
@CustomType
public final class ServiceAnomaliesV2ResponseTimeAutoDetectionOverAlertingProtection {
    ...
    public static Builder builder(ServiceAnomaliesV2ResponseTimeAutoDetectionOverAlertingProtection defaults) {
    ...
    public static final class Builder {
        ...
        private Double requestsPerMinute;
        public Builder() {}
        public Builder(ServiceAnomaliesV2ResponseTimeAutoDetectionOverAlertingProtection defaults) {
        ...
        public ServiceAnomaliesV2ResponseTimeAutoDetectionOverAlertingProtection build() {
            final var o = new ServiceAnomaliesV2ResponseTimeAutoDetectionOverAlertingProtection();
