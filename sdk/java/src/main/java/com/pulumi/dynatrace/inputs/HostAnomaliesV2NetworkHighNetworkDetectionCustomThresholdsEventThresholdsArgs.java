...
public final class HostAnomaliesV2NetworkHighNetworkDetectionCustomThresholdsEventThresholdsArgs extends com.pulumi.resources.ResourceArgs {

    public static final HostAnomaliesV2NetworkHighNetworkDetectionCustomThresholdsEventThresholdsArgs Empty = new HostAnomaliesV2NetworkHighNetworkDetectionCustomThresholdsEventThresholdsArgs();
    ...
    private HostAnomaliesV2NetworkHighNetworkDetectionCustomThresholdsEventThresholdsArgs() {}

    private HostAnomaliesV2NetworkHighNetworkDetectionCustomThresholdsEventThresholdsArgs(HostAnomaliesV2NetworkHighNetworkDetectionCustomThresholdsEventThresholdsArgs $) {
    ...
    public static Builder builder(HostAnomaliesV2NetworkHighNetworkDetectionCustomThresholdsEventThresholdsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HostAnomaliesV2NetworkHighNetworkDetectionCustomThresholdsEventThresholdsArgs();
        }

        public Builder(HostAnomaliesV2NetworkHighNetworkDetectionCustomThresholdsEventThresholdsArgs defaults) {
            $ = new HostAnomaliesV2NetworkHighNetworkDetectionCustomThresholdsEventThresholdsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HostAnomaliesV2NetworkHighNetworkDetectionCustomThresholdsEventThresholdsArgs build() {
