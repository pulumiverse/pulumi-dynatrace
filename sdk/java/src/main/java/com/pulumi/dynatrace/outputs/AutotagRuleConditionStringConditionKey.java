...
@CustomType
public final class AutotagRuleConditionStringConditionKey {
    ...
    private AutotagRuleConditionStringConditionKey() {}
    ...
    public static Builder builder(AutotagRuleConditionStringConditionKey defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String unknowns;
        public Builder() {}
        public Builder(AutotagRuleConditionStringConditionKey defaults) {
        ...
        public AutotagRuleConditionStringConditionKey build() {
            final var o = new AutotagRuleConditionStringConditionKey();
