...
public final class K8sWorkloadAnomaliesContainerRestartsConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final K8sWorkloadAnomaliesContainerRestartsConfigurationArgs Empty = new K8sWorkloadAnomaliesContainerRestartsConfigurationArgs();
    ...
    private K8sWorkloadAnomaliesContainerRestartsConfigurationArgs() {}

    private K8sWorkloadAnomaliesContainerRestartsConfigurationArgs(K8sWorkloadAnomaliesContainerRestartsConfigurationArgs $) {
    ...
    public static Builder builder(K8sWorkloadAnomaliesContainerRestartsConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new K8sWorkloadAnomaliesContainerRestartsConfigurationArgs();
        }

        public Builder(K8sWorkloadAnomaliesContainerRestartsConfigurationArgs defaults) {
            $ = new K8sWorkloadAnomaliesContainerRestartsConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public K8sWorkloadAnomaliesContainerRestartsConfigurationArgs build() {
