...
@CustomType
public final class ServiceAnomaliesV2ResponseTimeAutoDetectionResponseTimeSlowest {
    ...
    public static Builder builder(ServiceAnomaliesV2ResponseTimeAutoDetectionResponseTimeSlowest defaults) {
    ...
    public static final class Builder {
        ...
        private Double slowestDegradationPercent;
        public Builder() {}
        public Builder(ServiceAnomaliesV2ResponseTimeAutoDetectionResponseTimeSlowest defaults) {
        ...
        public ServiceAnomaliesV2ResponseTimeAutoDetectionResponseTimeSlowest build() {
            final var o = new ServiceAnomaliesV2ResponseTimeAutoDetectionResponseTimeSlowest();
