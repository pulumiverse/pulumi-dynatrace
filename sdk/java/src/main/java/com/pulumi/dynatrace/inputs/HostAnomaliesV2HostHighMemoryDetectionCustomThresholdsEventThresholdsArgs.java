...
public final class HostAnomaliesV2HostHighMemoryDetectionCustomThresholdsEventThresholdsArgs extends com.pulumi.resources.ResourceArgs {

    public static final HostAnomaliesV2HostHighMemoryDetectionCustomThresholdsEventThresholdsArgs Empty = new HostAnomaliesV2HostHighMemoryDetectionCustomThresholdsEventThresholdsArgs();
    ...
    private HostAnomaliesV2HostHighMemoryDetectionCustomThresholdsEventThresholdsArgs() {}

    private HostAnomaliesV2HostHighMemoryDetectionCustomThresholdsEventThresholdsArgs(HostAnomaliesV2HostHighMemoryDetectionCustomThresholdsEventThresholdsArgs $) {
    ...
    public static Builder builder(HostAnomaliesV2HostHighMemoryDetectionCustomThresholdsEventThresholdsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HostAnomaliesV2HostHighMemoryDetectionCustomThresholdsEventThresholdsArgs();
        }

        public Builder(HostAnomaliesV2HostHighMemoryDetectionCustomThresholdsEventThresholdsArgs defaults) {
            $ = new HostAnomaliesV2HostHighMemoryDetectionCustomThresholdsEventThresholdsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HostAnomaliesV2HostHighMemoryDetectionCustomThresholdsEventThresholdsArgs build() {
