...
@CustomType
public final class AutotagRuleConditionAzureSkus {
    ...
    public static Builder builder(AutotagRuleConditionAzureSkus defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(AutotagRuleConditionAzureSkus defaults) {
        ...
        public AutotagRuleConditionAzureSkus build() {
            final var o = new AutotagRuleConditionAzureSkus();
            o.negate = negate;
            o.operator = operator;
            o.unknowns = unknowns;
            o.value = value;
