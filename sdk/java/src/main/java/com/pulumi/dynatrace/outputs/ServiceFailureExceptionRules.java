...
import com.pulumi.dynatrace.outputs.ServiceFailureExceptionRulesCustomErrorRules;
import com.pulumi.dynatrace.outputs.ServiceFailureExceptionRulesCustomHandledExceptions;
import com.pulumi.dynatrace.outputs.ServiceFailureExceptionRulesIgnoredExceptions;
import com.pulumi.dynatrace.outputs.ServiceFailureExceptionRulesSuccessForcingExceptions;
...
@CustomType
public final class ServiceFailureExceptionRules {
    /**
     ...
     * 
     */
    private @Nullable ServiceFailureExceptionRulesCustomErrorRules customErrorRules;
    /**
     ...
     * 
     */
    private @Nullable ServiceFailureExceptionRulesCustomHandledExceptions customHandledExceptions;
    /**
     ...
     * 
     */
    private @Nullable ServiceFailureExceptionRulesIgnoredExceptions ignoredExceptions;
    /**
     ...
     * 
     */
    private @Nullable ServiceFailureExceptionRulesSuccessForcingExceptions successForcingExceptions;
     ...
     * 
     */
    public Optional<ServiceFailureExceptionRulesCustomErrorRules> customErrorRules() {
     ...
     * 
     */
    public Optional<ServiceFailureExceptionRulesCustomHandledExceptions> customHandledExceptions() {
     ...
     * 
     */
    public Optional<ServiceFailureExceptionRulesIgnoredExceptions> ignoredExceptions() {
     ...
     * 
     */
    public Optional<ServiceFailureExceptionRulesSuccessForcingExceptions> successForcingExceptions() {
    ...
    public static Builder builder(ServiceFailureExceptionRules defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable ServiceFailureExceptionRulesSuccessForcingExceptions successForcingExceptions;
        public Builder() {}
        public Builder(ServiceFailureExceptionRules defaults) {
        ...
        @CustomType.Setter
        public Builder customErrorRules(@Nullable ServiceFailureExceptionRulesCustomErrorRules customErrorRules) {
            this.customErrorRules = customErrorRules;
            return this;
        }
        @CustomType.Setter
        public Builder customHandledExceptions(@Nullable ServiceFailureExceptionRulesCustomHandledExceptions customHandledExceptions) {
        ...
        @CustomType.Setter
        public Builder ignoredExceptions(@Nullable ServiceFailureExceptionRulesIgnoredExceptions ignoredExceptions) {
            this.ignoredExceptions = ignoredExceptions;
            return this;
        }
        @CustomType.Setter
        public Builder successForcingExceptions(@Nullable ServiceFailureExceptionRulesSuccessForcingExceptions successForcingExceptions) {
            this.successForcingExceptions = successForcingExceptions;
            return this;
        }
        public ServiceFailureExceptionRules build() {
            final var o = new ServiceFailureExceptionRules();
