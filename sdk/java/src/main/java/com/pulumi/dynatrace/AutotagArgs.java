...
public final class AutotagArgs extends com.pulumi.resources.ResourceArgs {

    public static final AutotagArgs Empty = new AutotagArgs();
    ...
    private AutotagArgs(AutotagArgs $) {
    ...
    public static Builder builder(AutotagArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AutotagArgs defaults) {
            $ = new AutotagArgs(Objects.requireNonNull(defaults));
        }
