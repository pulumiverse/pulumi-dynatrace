...
public final class HostAnomaliesV2HostHighCpuSaturationDetectionCustomThresholdsEventThresholdsArgs extends com.pulumi.resources.ResourceArgs {

    public static final HostAnomaliesV2HostHighCpuSaturationDetectionCustomThresholdsEventThresholdsArgs Empty = new HostAnomaliesV2HostHighCpuSaturationDetectionCustomThresholdsEventThresholdsArgs();
    ...
    private HostAnomaliesV2HostHighCpuSaturationDetectionCustomThresholdsEventThresholdsArgs() {}

    private HostAnomaliesV2HostHighCpuSaturationDetectionCustomThresholdsEventThresholdsArgs(HostAnomaliesV2HostHighCpuSaturationDetectionCustomThresholdsEventThresholdsArgs $) {
    ...
    public static Builder builder(HostAnomaliesV2HostHighCpuSaturationDetectionCustomThresholdsEventThresholdsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HostAnomaliesV2HostHighCpuSaturationDetectionCustomThresholdsEventThresholdsArgs();
        }

        public Builder(HostAnomaliesV2HostHighCpuSaturationDetectionCustomThresholdsEventThresholdsArgs defaults) {
            $ = new HostAnomaliesV2HostHighCpuSaturationDetectionCustomThresholdsEventThresholdsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HostAnomaliesV2HostHighCpuSaturationDetectionCustomThresholdsEventThresholdsArgs build() {
