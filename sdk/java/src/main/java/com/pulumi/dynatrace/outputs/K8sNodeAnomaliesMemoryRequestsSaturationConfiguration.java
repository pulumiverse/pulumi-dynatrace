...
@CustomType
public final class K8sNodeAnomaliesMemoryRequestsSaturationConfiguration {
    ...
    public static Builder builder(K8sNodeAnomaliesMemoryRequestsSaturationConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer threshold;
        public Builder() {}
        public Builder(K8sNodeAnomaliesMemoryRequestsSaturationConfiguration defaults) {
        ...
        public K8sNodeAnomaliesMemoryRequestsSaturationConfiguration build() {
            final var o = new K8sNodeAnomaliesMemoryRequestsSaturationConfiguration();
