...
public final class ServiceFailureExceptionRulesCustomErrorRulesCustomErrorRuleConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceFailureExceptionRulesCustomErrorRulesCustomErrorRuleConditionArgs Empty = new ServiceFailureExceptionRulesCustomErrorRulesCustomErrorRuleConditionArgs();
    ...
    private ServiceFailureExceptionRulesCustomErrorRulesCustomErrorRuleConditionArgs() {}

    private ServiceFailureExceptionRulesCustomErrorRulesCustomErrorRuleConditionArgs(ServiceFailureExceptionRulesCustomErrorRulesCustomErrorRuleConditionArgs $) {
    ...
    public static Builder builder(ServiceFailureExceptionRulesCustomErrorRulesCustomErrorRuleConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceFailureExceptionRulesCustomErrorRulesCustomErrorRuleConditionArgs();
        }

        public Builder(ServiceFailureExceptionRulesCustomErrorRulesCustomErrorRuleConditionArgs defaults) {
            $ = new ServiceFailureExceptionRulesCustomErrorRulesCustomErrorRuleConditionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceFailureExceptionRulesCustomErrorRulesCustomErrorRuleConditionArgs build() {
