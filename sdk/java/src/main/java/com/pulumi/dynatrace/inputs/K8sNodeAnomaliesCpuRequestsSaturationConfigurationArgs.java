...
public final class K8sNodeAnomaliesCpuRequestsSaturationConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final K8sNodeAnomaliesCpuRequestsSaturationConfigurationArgs Empty = new K8sNodeAnomaliesCpuRequestsSaturationConfigurationArgs();
    ...
    private K8sNodeAnomaliesCpuRequestsSaturationConfigurationArgs() {}

    private K8sNodeAnomaliesCpuRequestsSaturationConfigurationArgs(K8sNodeAnomaliesCpuRequestsSaturationConfigurationArgs $) {
    ...
    public static Builder builder(K8sNodeAnomaliesCpuRequestsSaturationConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new K8sNodeAnomaliesCpuRequestsSaturationConfigurationArgs();
        }

        public Builder(K8sNodeAnomaliesCpuRequestsSaturationConfigurationArgs defaults) {
            $ = new K8sNodeAnomaliesCpuRequestsSaturationConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public K8sNodeAnomaliesCpuRequestsSaturationConfigurationArgs build() {
