...
public final class ServiceFullWebServiceIdContributorsApplicationIdServiceIdContributorTransformationsTransformationArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceFullWebServiceIdContributorsApplicationIdServiceIdContributorTransformationsTransformationArgs Empty = new ServiceFullWebServiceIdContributorsApplicationIdServiceIdContributorTransformationsTransformationArgs();
    ...
    private ServiceFullWebServiceIdContributorsApplicationIdServiceIdContributorTransformationsTransformationArgs() {}

    private ServiceFullWebServiceIdContributorsApplicationIdServiceIdContributorTransformationsTransformationArgs(ServiceFullWebServiceIdContributorsApplicationIdServiceIdContributorTransformationsTransformationArgs $) {
    ...
    public static Builder builder(ServiceFullWebServiceIdContributorsApplicationIdServiceIdContributorTransformationsTransformationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceFullWebServiceIdContributorsApplicationIdServiceIdContributorTransformationsTransformationArgs();
        }

        public Builder(ServiceFullWebServiceIdContributorsApplicationIdServiceIdContributorTransformationsTransformationArgs defaults) {
            $ = new ServiceFullWebServiceIdContributorsApplicationIdServiceIdContributorTransformationsTransformationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceFullWebServiceIdContributorsApplicationIdServiceIdContributorTransformationsTransformationArgs build() {
