...
@CustomType
public final class ServiceAnomaliesV2FailureRateFixedDetectionOverAlertingProtection {
    ...
    public static Builder builder(ServiceAnomaliesV2FailureRateFixedDetectionOverAlertingProtection defaults) {
    ...
    public static final class Builder {
        ...
        private Double requestsPerMinute;
        public Builder() {}
        public Builder(ServiceAnomaliesV2FailureRateFixedDetectionOverAlertingProtection defaults) {
        ...
        public ServiceAnomaliesV2FailureRateFixedDetectionOverAlertingProtection build() {
            final var o = new ServiceAnomaliesV2FailureRateFixedDetectionOverAlertingProtection();
