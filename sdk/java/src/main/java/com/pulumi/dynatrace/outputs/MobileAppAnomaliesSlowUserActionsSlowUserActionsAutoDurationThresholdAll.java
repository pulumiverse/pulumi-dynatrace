...
@CustomType
public final class MobileAppAnomaliesSlowUserActionsSlowUserActionsAutoDurationThresholdAll {
    ...
    public static Builder builder(MobileAppAnomaliesSlowUserActionsSlowUserActionsAutoDurationThresholdAll defaults) {
    ...
    public static final class Builder {
        ...
        private Double slowdownPercentage;
        public Builder() {}
        public Builder(MobileAppAnomaliesSlowUserActionsSlowUserActionsAutoDurationThresholdAll defaults) {
        ...
        public MobileAppAnomaliesSlowUserActionsSlowUserActionsAutoDurationThresholdAll build() {
            final var o = new MobileAppAnomaliesSlowUserActionsSlowUserActionsAutoDurationThresholdAll();
