...
public final class K8sWorkloadAnomaliesHighCpuUsageConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final K8sWorkloadAnomaliesHighCpuUsageConfigurationArgs Empty = new K8sWorkloadAnomaliesHighCpuUsageConfigurationArgs();
    ...
    private K8sWorkloadAnomaliesHighCpuUsageConfigurationArgs() {}

    private K8sWorkloadAnomaliesHighCpuUsageConfigurationArgs(K8sWorkloadAnomaliesHighCpuUsageConfigurationArgs $) {
    ...
    public static Builder builder(K8sWorkloadAnomaliesHighCpuUsageConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new K8sWorkloadAnomaliesHighCpuUsageConfigurationArgs();
        }

        public Builder(K8sWorkloadAnomaliesHighCpuUsageConfigurationArgs defaults) {
            $ = new K8sWorkloadAnomaliesHighCpuUsageConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public K8sWorkloadAnomaliesHighCpuUsageConfigurationArgs build() {
