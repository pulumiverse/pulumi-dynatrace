...
import com.pulumi.dynatrace.outputs.RequestNamingPlaceholdersPlaceholderSource;
...
@CustomType
public final class RequestNamingPlaceholdersPlaceholder {
    ...
    private @Nullable RequestNamingPlaceholdersPlaceholderSource source;
    private @Nullable String unknowns;
    private @Nullable Boolean useFromChildCalls;

    private RequestNamingPlaceholdersPlaceholder() {}
    ...
    public Optional<RequestNamingPlaceholdersPlaceholderSource> source() {
    ...
    public static Builder builder(RequestNamingPlaceholdersPlaceholder defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean useFromChildCalls;
        public Builder() {}
        public Builder(RequestNamingPlaceholdersPlaceholder defaults) {
        ...
        @CustomType.Setter
        public Builder source(@Nullable RequestNamingPlaceholdersPlaceholderSource source) {
            this.source = source;
            return this;
        }
        @CustomType.Setter
        ...
        public RequestNamingPlaceholdersPlaceholder build() {
            final var o = new RequestNamingPlaceholdersPlaceholder();
