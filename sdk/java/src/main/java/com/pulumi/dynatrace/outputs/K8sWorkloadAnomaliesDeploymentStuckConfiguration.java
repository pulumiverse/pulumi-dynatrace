...
@CustomType
public final class K8sWorkloadAnomaliesDeploymentStuckConfiguration {
    ...
    public static Builder builder(K8sWorkloadAnomaliesDeploymentStuckConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer samplePeriodInMinutes;
        public Builder() {}
        public Builder(K8sWorkloadAnomaliesDeploymentStuckConfiguration defaults) {
        ...
        public K8sWorkloadAnomaliesDeploymentStuckConfiguration build() {
            final var o = new K8sWorkloadAnomaliesDeploymentStuckConfiguration();
