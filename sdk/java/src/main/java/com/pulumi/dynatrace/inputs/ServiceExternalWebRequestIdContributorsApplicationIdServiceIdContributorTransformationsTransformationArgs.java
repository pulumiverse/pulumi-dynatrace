...
public final class ServiceExternalWebRequestIdContributorsApplicationIdServiceIdContributorTransformationsTransformationArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceExternalWebRequestIdContributorsApplicationIdServiceIdContributorTransformationsTransformationArgs Empty = new ServiceExternalWebRequestIdContributorsApplicationIdServiceIdContributorTransformationsTransformationArgs();
    ...
    private ServiceExternalWebRequestIdContributorsApplicationIdServiceIdContributorTransformationsTransformationArgs() {}

    private ServiceExternalWebRequestIdContributorsApplicationIdServiceIdContributorTransformationsTransformationArgs(ServiceExternalWebRequestIdContributorsApplicationIdServiceIdContributorTransformationsTransformationArgs $) {
    ...
    public static Builder builder(ServiceExternalWebRequestIdContributorsApplicationIdServiceIdContributorTransformationsTransformationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceExternalWebRequestIdContributorsApplicationIdServiceIdContributorTransformationsTransformationArgs();
        }

        public Builder(ServiceExternalWebRequestIdContributorsApplicationIdServiceIdContributorTransformationsTransformationArgs defaults) {
            $ = new ServiceExternalWebRequestIdContributorsApplicationIdServiceIdContributorTransformationsTransformationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceExternalWebRequestIdContributorsApplicationIdServiceIdContributorTransformationsTransformationArgs build() {
