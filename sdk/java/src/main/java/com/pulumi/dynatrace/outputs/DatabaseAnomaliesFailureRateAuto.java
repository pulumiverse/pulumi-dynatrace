...
@CustomType
public final class DatabaseAnomaliesFailureRateAuto {
    ...
    public static Builder builder(DatabaseAnomaliesFailureRateAuto defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String unknowns;
        public Builder() {}
        public Builder(DatabaseAnomaliesFailureRateAuto defaults) {
        ...
        public DatabaseAnomaliesFailureRateAuto build() {
            final var o = new DatabaseAnomaliesFailureRateAuto();
            o.absolute = absolute;
            o.relative = relative;
            o.unknowns = unknowns;
            return o;
