...
public final class K8sNodeAnomaliesMemoryRequestsSaturationConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final K8sNodeAnomaliesMemoryRequestsSaturationConfigurationArgs Empty = new K8sNodeAnomaliesMemoryRequestsSaturationConfigurationArgs();
    ...
    private K8sNodeAnomaliesMemoryRequestsSaturationConfigurationArgs() {}

    private K8sNodeAnomaliesMemoryRequestsSaturationConfigurationArgs(K8sNodeAnomaliesMemoryRequestsSaturationConfigurationArgs $) {
    ...
    public static Builder builder(K8sNodeAnomaliesMemoryRequestsSaturationConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new K8sNodeAnomaliesMemoryRequestsSaturationConfigurationArgs();
        }

        public Builder(K8sNodeAnomaliesMemoryRequestsSaturationConfigurationArgs defaults) {
            $ = new K8sNodeAnomaliesMemoryRequestsSaturationConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public K8sNodeAnomaliesMemoryRequestsSaturationConfigurationArgs build() {
