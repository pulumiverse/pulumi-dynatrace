...
@CustomType
public final class DatabaseAnomaliesV2FailureRateFixedDetectionOverAlertingProtection {
    ...
    public static Builder builder(DatabaseAnomaliesV2FailureRateFixedDetectionOverAlertingProtection defaults) {
    ...
    public static final class Builder {
        ...
        private Double requestsPerMinute;
        public Builder() {}
        public Builder(DatabaseAnomaliesV2FailureRateFixedDetectionOverAlertingProtection defaults) {
        ...
        public DatabaseAnomaliesV2FailureRateFixedDetectionOverAlertingProtection build() {
            final var o = new DatabaseAnomaliesV2FailureRateFixedDetectionOverAlertingProtection();
