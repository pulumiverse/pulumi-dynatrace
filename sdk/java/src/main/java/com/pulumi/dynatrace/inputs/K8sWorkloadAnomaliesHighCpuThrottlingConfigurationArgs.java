...
public final class K8sWorkloadAnomaliesHighCpuThrottlingConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final K8sWorkloadAnomaliesHighCpuThrottlingConfigurationArgs Empty = new K8sWorkloadAnomaliesHighCpuThrottlingConfigurationArgs();
    ...
    private K8sWorkloadAnomaliesHighCpuThrottlingConfigurationArgs() {}

    private K8sWorkloadAnomaliesHighCpuThrottlingConfigurationArgs(K8sWorkloadAnomaliesHighCpuThrottlingConfigurationArgs $) {
    ...
    public static Builder builder(K8sWorkloadAnomaliesHighCpuThrottlingConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new K8sWorkloadAnomaliesHighCpuThrottlingConfigurationArgs();
        }

        public Builder(K8sWorkloadAnomaliesHighCpuThrottlingConfigurationArgs defaults) {
            $ = new K8sWorkloadAnomaliesHighCpuThrottlingConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public K8sWorkloadAnomaliesHighCpuThrottlingConfigurationArgs build() {
