...
public final class K8sClusterAnomaliesCpuRequestsSaturationConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final K8sClusterAnomaliesCpuRequestsSaturationConfigurationArgs Empty = new K8sClusterAnomaliesCpuRequestsSaturationConfigurationArgs();
    ...
    private K8sClusterAnomaliesCpuRequestsSaturationConfigurationArgs() {}

    private K8sClusterAnomaliesCpuRequestsSaturationConfigurationArgs(K8sClusterAnomaliesCpuRequestsSaturationConfigurationArgs $) {
    ...
    public static Builder builder(K8sClusterAnomaliesCpuRequestsSaturationConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new K8sClusterAnomaliesCpuRequestsSaturationConfigurationArgs();
        }

        public Builder(K8sClusterAnomaliesCpuRequestsSaturationConfigurationArgs defaults) {
            $ = new K8sClusterAnomaliesCpuRequestsSaturationConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public K8sClusterAnomaliesCpuRequestsSaturationConfigurationArgs build() {
