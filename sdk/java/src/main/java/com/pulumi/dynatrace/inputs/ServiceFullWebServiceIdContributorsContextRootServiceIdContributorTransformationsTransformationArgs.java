...
public final class ServiceFullWebServiceIdContributorsContextRootServiceIdContributorTransformationsTransformationArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceFullWebServiceIdContributorsContextRootServiceIdContributorTransformationsTransformationArgs Empty = new ServiceFullWebServiceIdContributorsContextRootServiceIdContributorTransformationsTransformationArgs();
    ...
    private ServiceFullWebServiceIdContributorsContextRootServiceIdContributorTransformationsTransformationArgs() {}

    private ServiceFullWebServiceIdContributorsContextRootServiceIdContributorTransformationsTransformationArgs(ServiceFullWebServiceIdContributorsContextRootServiceIdContributorTransformationsTransformationArgs $) {
    ...
    public static Builder builder(ServiceFullWebServiceIdContributorsContextRootServiceIdContributorTransformationsTransformationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceFullWebServiceIdContributorsContextRootServiceIdContributorTransformationsTransformationArgs();
        }

        public Builder(ServiceFullWebServiceIdContributorsContextRootServiceIdContributorTransformationsTransformationArgs defaults) {
            $ = new ServiceFullWebServiceIdContributorsContextRootServiceIdContributorTransformationsTransformationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceFullWebServiceIdContributorsContextRootServiceIdContributorTransformationsTransformationArgs build() {
