...
public final class HostAnomaliesV2NetworkNetworkErrorsDetectionCustomThresholdsEventThresholdsArgs extends com.pulumi.resources.ResourceArgs {

    public static final HostAnomaliesV2NetworkNetworkErrorsDetectionCustomThresholdsEventThresholdsArgs Empty = new HostAnomaliesV2NetworkNetworkErrorsDetectionCustomThresholdsEventThresholdsArgs();
    ...
    private HostAnomaliesV2NetworkNetworkErrorsDetectionCustomThresholdsEventThresholdsArgs() {}

    private HostAnomaliesV2NetworkNetworkErrorsDetectionCustomThresholdsEventThresholdsArgs(HostAnomaliesV2NetworkNetworkErrorsDetectionCustomThresholdsEventThresholdsArgs $) {
    ...
    public static Builder builder(HostAnomaliesV2NetworkNetworkErrorsDetectionCustomThresholdsEventThresholdsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HostAnomaliesV2NetworkNetworkErrorsDetectionCustomThresholdsEventThresholdsArgs();
        }

        public Builder(HostAnomaliesV2NetworkNetworkErrorsDetectionCustomThresholdsEventThresholdsArgs defaults) {
            $ = new HostAnomaliesV2NetworkNetworkErrorsDetectionCustomThresholdsEventThresholdsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HostAnomaliesV2NetworkNetworkErrorsDetectionCustomThresholdsEventThresholdsArgs build() {
