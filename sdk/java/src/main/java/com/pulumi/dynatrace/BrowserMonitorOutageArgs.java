...
public final class BrowserMonitorOutageArgs extends com.pulumi.resources.ResourceArgs {

    public static final BrowserMonitorOutageArgs Empty = new BrowserMonitorOutageArgs();
     ...
     * 
     */
    @Import(name="retryOnError", required=true)
    ...
    private BrowserMonitorOutageArgs() {}

    private BrowserMonitorOutageArgs(BrowserMonitorOutageArgs $) {
    ...
    public static Builder builder(BrowserMonitorOutageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BrowserMonitorOutageArgs();
        }

        public Builder(BrowserMonitorOutageArgs defaults) {
            $ = new BrowserMonitorOutageArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder retryOnError(Output<Boolean> retryOnError) {
        ...
        public BrowserMonitorOutageArgs build() {
            ...
            $.retryOnError = Objects.requireNonNull($.retryOnError, "expected parameter 'retryOnError' to be non-null");
            return $;
        }
    }
