...
@CustomType
public final class K8sNodeAnomaliesCpuRequestsSaturationConfiguration {
    ...
    public static Builder builder(K8sNodeAnomaliesCpuRequestsSaturationConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer threshold;
        public Builder() {}
        public Builder(K8sNodeAnomaliesCpuRequestsSaturationConfiguration defaults) {
        ...
        public K8sNodeAnomaliesCpuRequestsSaturationConfiguration build() {
            final var o = new K8sNodeAnomaliesCpuRequestsSaturationConfiguration();
