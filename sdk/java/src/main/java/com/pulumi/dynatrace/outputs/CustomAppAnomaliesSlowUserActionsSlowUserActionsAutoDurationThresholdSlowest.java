...
@CustomType
public final class CustomAppAnomaliesSlowUserActionsSlowUserActionsAutoDurationThresholdSlowest {
    ...
    public static Builder builder(CustomAppAnomaliesSlowUserActionsSlowUserActionsAutoDurationThresholdSlowest defaults) {
    ...
    public static final class Builder {
        ...
        private Double slowdownPercentage;
        public Builder() {}
        public Builder(CustomAppAnomaliesSlowUserActionsSlowUserActionsAutoDurationThresholdSlowest defaults) {
        ...
        public CustomAppAnomaliesSlowUserActionsSlowUserActionsAutoDurationThresholdSlowest build() {
            final var o = new CustomAppAnomaliesSlowUserActionsSlowUserActionsAutoDurationThresholdSlowest();
