...
@CustomType
public final class WebApplicationLoadActionApdexSettings {
    /**
    ...
    private WebApplicationLoadActionApdexSettings() {}
    /**
     * @return Fallback threshold of an XHR action, defining a tolerable user experience, when the configured KPM is not available. Values between 0 and 240000 are allowed.
     * 
     */
    ...
    public static Builder builder(WebApplicationLoadActionApdexSettings defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer toleratedThreshold;
        public Builder() {}
        public Builder(WebApplicationLoadActionApdexSettings defaults) {
        ...
        public WebApplicationLoadActionApdexSettings build() {
            final var o = new WebApplicationLoadActionApdexSettings();
