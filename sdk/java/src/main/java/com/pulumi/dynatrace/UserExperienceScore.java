...
import com.pulumi.dynatrace.UserExperienceScoreArgs;
import com.pulumi.dynatrace.Utilities;
import com.pulumi.dynatrace.inputs.UserExperienceScoreState;
import java.lang.Boolean;
import java.lang.Integer;
import javax.annotation.Nullable;

@ResourceType(type="dynatrace:index/userExperienceScore:UserExperienceScore")
public class UserExperienceScore extends com.pulumi.resources.CustomResource {
    /**
     * If last user action in a session is classified as Frustrating, classify the entire session as Frustrating
     * 
     */
    @Export(name="considerLastAction", refs={Boolean.class}, tree="[0]")
     ...
     * 
     */
    @Export(name="considerRageClick", refs={Boolean.class}, tree="[0]")
     ...
     * 
     */
    @Export(name="maxFrustratedUserActionsThreshold", refs={Integer.class}, tree="[0]")
     ...
     * 
     */
    @Export(name="minSatisfiedUserActionsThreshold", refs={Integer.class}, tree="[0]")
     ...
     */
    public UserExperienceScore(String name) {
        this(name, UserExperienceScoreArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public UserExperienceScore(String name, UserExperienceScoreArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("dynatrace:index/userExperienceScore:UserExperienceScore", name, args == null ? UserExperienceScoreArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private UserExperienceScore(String name, Output<String> id, @Nullable UserExperienceScoreState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("dynatrace:index/userExperienceScore:UserExperienceScore", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static UserExperienceScore get(String name, Output<String> id, @Nullable UserExperienceScoreState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
