...
@CustomType
public final class WebAppAnomaliesResponseTimeResponseTimeFixedOverAlertingProtection {
    ...
    public static Builder builder(WebAppAnomaliesResponseTimeResponseTimeFixedOverAlertingProtection defaults) {
    ...
    public static final class Builder {
        ...
        private Double minutesAbnormalState;
        public Builder() {}
        public Builder(WebAppAnomaliesResponseTimeResponseTimeFixedOverAlertingProtection defaults) {
        ...
        public WebAppAnomaliesResponseTimeResponseTimeFixedOverAlertingProtection build() {
            final var o = new WebAppAnomaliesResponseTimeResponseTimeFixedOverAlertingProtection();
