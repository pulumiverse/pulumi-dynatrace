...
@CustomType
public final class K8sWorkloadAnomaliesHighMemoryUsageConfiguration {
    ...
    public static Builder builder(K8sWorkloadAnomaliesHighMemoryUsageConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer threshold;
        public Builder() {}
        public Builder(K8sWorkloadAnomaliesHighMemoryUsageConfiguration defaults) {
        ...
        public K8sWorkloadAnomaliesHighMemoryUsageConfiguration build() {
            final var o = new K8sWorkloadAnomaliesHighMemoryUsageConfiguration();
