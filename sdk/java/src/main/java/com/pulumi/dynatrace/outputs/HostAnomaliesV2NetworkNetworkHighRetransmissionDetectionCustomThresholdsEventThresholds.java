...
@CustomType
public final class HostAnomaliesV2NetworkNetworkHighRetransmissionDetectionCustomThresholdsEventThresholds {
    ...
    public static Builder builder(HostAnomaliesV2NetworkNetworkHighRetransmissionDetectionCustomThresholdsEventThresholds defaults) {
    ...
    public static final class Builder {
        ...
        private Integer violatingSamples;
        public Builder() {}
        public Builder(HostAnomaliesV2NetworkNetworkHighRetransmissionDetectionCustomThresholdsEventThresholds defaults) {
        ...
        public HostAnomaliesV2NetworkNetworkHighRetransmissionDetectionCustomThresholdsEventThresholds build() {
            final var o = new HostAnomaliesV2NetworkNetworkHighRetransmissionDetectionCustomThresholdsEventThresholds();
