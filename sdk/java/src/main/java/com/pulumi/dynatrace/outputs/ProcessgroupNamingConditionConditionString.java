...
@CustomType
public final class ProcessgroupNamingConditionConditionString {
    ...
    public static Builder builder(ProcessgroupNamingConditionConditionString defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(ProcessgroupNamingConditionConditionString defaults) {
        ...
        public ProcessgroupNamingConditionConditionString build() {
            final var o = new ProcessgroupNamingConditionConditionString();
