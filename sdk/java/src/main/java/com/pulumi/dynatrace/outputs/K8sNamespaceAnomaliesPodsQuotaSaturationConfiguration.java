...
@CustomType
public final class K8sNamespaceAnomaliesPodsQuotaSaturationConfiguration {
    ...
    public static Builder builder(K8sNamespaceAnomaliesPodsQuotaSaturationConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer threshold;
        public Builder() {}
        public Builder(K8sNamespaceAnomaliesPodsQuotaSaturationConfiguration defaults) {
        ...
        public K8sNamespaceAnomaliesPodsQuotaSaturationConfiguration build() {
            final var o = new K8sNamespaceAnomaliesPodsQuotaSaturationConfiguration();
