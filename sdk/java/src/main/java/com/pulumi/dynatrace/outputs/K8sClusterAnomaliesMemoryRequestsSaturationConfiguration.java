...
@CustomType
public final class K8sClusterAnomaliesMemoryRequestsSaturationConfiguration {
    ...
    public static Builder builder(K8sClusterAnomaliesMemoryRequestsSaturationConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer threshold;
        public Builder() {}
        public Builder(K8sClusterAnomaliesMemoryRequestsSaturationConfiguration defaults) {
        ...
        public K8sClusterAnomaliesMemoryRequestsSaturationConfiguration build() {
            final var o = new K8sClusterAnomaliesMemoryRequestsSaturationConfiguration();
