...
public final class DatabaseAnomaliesV2FailureRateAutoDetectionOverAlertingProtectionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatabaseAnomaliesV2FailureRateAutoDetectionOverAlertingProtectionArgs Empty = new DatabaseAnomaliesV2FailureRateAutoDetectionOverAlertingProtectionArgs();
    ...
    private DatabaseAnomaliesV2FailureRateAutoDetectionOverAlertingProtectionArgs() {}

    private DatabaseAnomaliesV2FailureRateAutoDetectionOverAlertingProtectionArgs(DatabaseAnomaliesV2FailureRateAutoDetectionOverAlertingProtectionArgs $) {
    ...
    public static Builder builder(DatabaseAnomaliesV2FailureRateAutoDetectionOverAlertingProtectionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatabaseAnomaliesV2FailureRateAutoDetectionOverAlertingProtectionArgs();
        }

        public Builder(DatabaseAnomaliesV2FailureRateAutoDetectionOverAlertingProtectionArgs defaults) {
            $ = new DatabaseAnomaliesV2FailureRateAutoDetectionOverAlertingProtectionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DatabaseAnomaliesV2FailureRateAutoDetectionOverAlertingProtectionArgs build() {
