...
public final class K8sClusterAnomaliesMonitoringIssuesConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final K8sClusterAnomaliesMonitoringIssuesConfigurationArgs Empty = new K8sClusterAnomaliesMonitoringIssuesConfigurationArgs();
    ...
    private K8sClusterAnomaliesMonitoringIssuesConfigurationArgs() {}

    private K8sClusterAnomaliesMonitoringIssuesConfigurationArgs(K8sClusterAnomaliesMonitoringIssuesConfigurationArgs $) {
    ...
    public static Builder builder(K8sClusterAnomaliesMonitoringIssuesConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new K8sClusterAnomaliesMonitoringIssuesConfigurationArgs();
        }

        public Builder(K8sClusterAnomaliesMonitoringIssuesConfigurationArgs defaults) {
            $ = new K8sClusterAnomaliesMonitoringIssuesConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public K8sClusterAnomaliesMonitoringIssuesConfigurationArgs build() {
