...
public final class ProcessGroupDetectionProcessDetectionArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProcessGroupDetectionProcessDetectionArgs Empty = new ProcessGroupDetectionProcessDetectionArgs();

    /**
     * The substring to be contained in the value `property` refers to. Case Sensitive
     * 
     */
    @Import(name="containedString", required=true)
    private Output<String> containedString;

    /**
     * @return The substring to be contained in the value `property` refers to. Case Sensitive
     * 
     */
    public Output<String> containedString() {
     ...
     * 
     */
    @Import(name="restrictToProcessType")
    private @Nullable Output<String> restrictToProcessType;
     ...
     * 
     */
    public Optional<Output<String>> restrictToProcessType() {
        return Optional.ofNullable(this.restrictToProcessType);
    }

    private ProcessGroupDetectionProcessDetectionArgs() {}

    private ProcessGroupDetectionProcessDetectionArgs(ProcessGroupDetectionProcessDetectionArgs $) {
    ...
    public static Builder builder(ProcessGroupDetectionProcessDetectionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProcessGroupDetectionProcessDetectionArgs();
        }

        public Builder(ProcessGroupDetectionProcessDetectionArgs defaults) {
            $ = new ProcessGroupDetectionProcessDetectionArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param containedString The substring to be contained in the value `property` refers to. Case Sensitive
         * 
         * @return builder
         * 
         */
        public Builder containedString(Output<String> containedString) {
        ...
        public Builder containedString(String containedString) {
            return containedString(Output.of(containedString));
        }
        ...
        /**
         * @param restrictToProcessType Restrict this rule to specific process types. Note: Not all types can be detected at startup. Possible values: `PROCESS_TYPE_APACHE_HTTPD`, `PROCESS_TYPE_GLASSFISH`, `PROCESS_TYPE_GO`, `PROCESS_TYPE_IIS_APP_POOL`, `PROCESS_TYPE_JBOSS`, `PROCESS_TYPE_JAVA`, `PROCESS_TYPE_NGINX`, `PROCESS_TYPE_NODE_JS`, `PROCESS_TYPE_PHP`, `PROCESS_TYPE_TOMCAT`, `PROCESS_TYPE_WEBLOGIC`, `PROCESS_TYPE_WEBSPHERE`
         * 
         * @return builder
         * 
         */
        public Builder restrictToProcessType(@Nullable Output<String> restrictToProcessType) {
            $.restrictToProcessType = restrictToProcessType;
            return this;
        }
         ...
         * 
         */
        public Builder restrictToProcessType(String restrictToProcessType) {
            return restrictToProcessType(Output.of(restrictToProcessType));
        }

        public ProcessGroupDetectionProcessDetectionArgs build() {
            $.containedString = Objects.requireNonNull($.containedString, "expected parameter 'containedString' to be non-null");
