...
@CustomType
public final class CustomAppEnablementRum {
    /**
    ...
    public static Builder builder(CustomAppEnablementRum defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean enabled;
        public Builder() {}
        public Builder(CustomAppEnablementRum defaults) {
        ...
        public CustomAppEnablementRum build() {
            final var o = new CustomAppEnablementRum();
