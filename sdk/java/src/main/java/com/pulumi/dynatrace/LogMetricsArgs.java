...
public final class LogMetricsArgs extends com.pulumi.resources.ResourceArgs {

    public static final LogMetricsArgs Empty = new LogMetricsArgs();
    ...
    private LogMetricsArgs() {}

    private LogMetricsArgs(LogMetricsArgs $) {
    ...
    public static Builder builder(LogMetricsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LogMetricsArgs defaults) {
            $ = new LogMetricsArgs(Objects.requireNonNull(defaults));
        }
