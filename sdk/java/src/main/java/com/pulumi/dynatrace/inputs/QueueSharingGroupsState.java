...
public final class QueueSharingGroupsState extends com.pulumi.resources.ResourceArgs {

    public static final QueueSharingGroupsState Empty = new QueueSharingGroupsState();
    ...
    private QueueSharingGroupsState() {}

    private QueueSharingGroupsState(QueueSharingGroupsState $) {
        this.name = $.name;
    ...
    public static Builder builder(QueueSharingGroupsState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new QueueSharingGroupsState();
        }

        public Builder(QueueSharingGroupsState defaults) {
            $ = new QueueSharingGroupsState(Objects.requireNonNull(defaults));
        }
        ...
        public QueueSharingGroupsState build() {
            return $;
        }
    }
