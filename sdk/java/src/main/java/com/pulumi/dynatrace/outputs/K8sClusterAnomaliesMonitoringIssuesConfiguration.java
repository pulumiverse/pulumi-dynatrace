...
@CustomType
public final class K8sClusterAnomaliesMonitoringIssuesConfiguration {
    ...
    public static Builder builder(K8sClusterAnomaliesMonitoringIssuesConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer samplePeriodInMinutes;
        public Builder() {}
        public Builder(K8sClusterAnomaliesMonitoringIssuesConfiguration defaults) {
        ...
        public K8sClusterAnomaliesMonitoringIssuesConfiguration build() {
            final var o = new K8sClusterAnomaliesMonitoringIssuesConfiguration();
