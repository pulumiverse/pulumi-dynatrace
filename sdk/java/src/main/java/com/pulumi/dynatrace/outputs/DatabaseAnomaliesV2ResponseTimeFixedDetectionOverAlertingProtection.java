...
@CustomType
public final class DatabaseAnomaliesV2ResponseTimeFixedDetectionOverAlertingProtection {
    ...
    public static Builder builder(DatabaseAnomaliesV2ResponseTimeFixedDetectionOverAlertingProtection defaults) {
    ...
    public static final class Builder {
        ...
        private Double requestsPerMinute;
        public Builder() {}
        public Builder(DatabaseAnomaliesV2ResponseTimeFixedDetectionOverAlertingProtection defaults) {
        ...
        public DatabaseAnomaliesV2ResponseTimeFixedDetectionOverAlertingProtection build() {
            final var o = new DatabaseAnomaliesV2ResponseTimeFixedDetectionOverAlertingProtection();
