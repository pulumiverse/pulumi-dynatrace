...
@CustomType
public final class K8sNodeAnomaliesPodsSaturationConfiguration {
    ...
    public static Builder builder(K8sNodeAnomaliesPodsSaturationConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer threshold;
        public Builder() {}
        public Builder(K8sNodeAnomaliesPodsSaturationConfiguration defaults) {
        ...
        public K8sNodeAnomaliesPodsSaturationConfiguration build() {
            final var o = new K8sNodeAnomaliesPodsSaturationConfiguration();
