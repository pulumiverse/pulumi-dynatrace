...
@CustomType
public final class K8sClusterAnomaliesCpuRequestsSaturationConfiguration {
    ...
    public static Builder builder(K8sClusterAnomaliesCpuRequestsSaturationConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer threshold;
        public Builder() {}
        public Builder(K8sClusterAnomaliesCpuRequestsSaturationConfiguration defaults) {
        ...
        public K8sClusterAnomaliesCpuRequestsSaturationConfiguration build() {
            final var o = new K8sClusterAnomaliesCpuRequestsSaturationConfiguration();
