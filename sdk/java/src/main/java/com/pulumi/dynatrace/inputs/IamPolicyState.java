...
public final class IamPolicyState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param account The UUID of the account (`urn:dtaccount:&lt;account-uuid&gt;`) in case the policy should be applied to all environments of this account. The prefix `urn:dtaccount:` MUST be omitted here.
         * 
         * @return builder
         * 
         */
