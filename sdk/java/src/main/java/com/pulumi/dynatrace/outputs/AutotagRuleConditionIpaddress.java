...
@CustomType
public final class AutotagRuleConditionIpaddress {
    ...
    private AutotagRuleConditionIpaddress() {}
    ...
    public static Builder builder(AutotagRuleConditionIpaddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(AutotagRuleConditionIpaddress defaults) {
        ...
        public AutotagRuleConditionIpaddress build() {
            final var o = new AutotagRuleConditionIpaddress();
