...
public final class DduPoolArgs extends com.pulumi.resources.ResourceArgs {

    public static final DduPoolArgs Empty = new DduPoolArgs();
    ...
    private DduPoolArgs(DduPoolArgs $) {
        this.events = $.events;
    ...
    public static Builder builder(DduPoolArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DduPoolArgs defaults) {
            $ = new DduPoolArgs(Objects.requireNonNull(defaults));
        }
