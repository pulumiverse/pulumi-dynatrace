...
@CustomType
public final class MobileAppAnomaliesUnexpectedHighLoad {
    /**
    ...
    public static Builder builder(MobileAppAnomaliesUnexpectedHighLoad defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double thresholdPercentage;
        public Builder() {}
        public Builder(MobileAppAnomaliesUnexpectedHighLoad defaults) {
        ...
        public MobileAppAnomaliesUnexpectedHighLoad build() {
            final var o = new MobileAppAnomaliesUnexpectedHighLoad();
            o.enabled = enabled;
