...
@CustomType
public final class FailureDetectionParametersBrokenLinks {
    /**
    ...
    public static Builder builder(FailureDetectionParametersBrokenLinks defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean http404NotFoundFailures;
        public Builder() {}
        public Builder(FailureDetectionParametersBrokenLinks defaults) {
        ...
        public FailureDetectionParametersBrokenLinks build() {
            final var o = new FailureDetectionParametersBrokenLinks();
