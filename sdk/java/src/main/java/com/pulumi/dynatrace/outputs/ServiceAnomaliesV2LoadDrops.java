...
@CustomType
public final class ServiceAnomaliesV2LoadDrops {
    /**
    ...
    public static Builder builder(ServiceAnomaliesV2LoadDrops defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer minutesAbnormalState;
        public Builder() {}
        public Builder(ServiceAnomaliesV2LoadDrops defaults) {
        ...
        public ServiceAnomaliesV2LoadDrops build() {
            final var o = new ServiceAnomaliesV2LoadDrops();
            o.enabled = enabled;
