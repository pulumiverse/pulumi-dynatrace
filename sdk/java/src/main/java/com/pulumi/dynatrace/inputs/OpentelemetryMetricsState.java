...
public final class OpentelemetryMetricsState extends com.pulumi.resources.ResourceArgs {

    public static final OpentelemetryMetricsState Empty = new OpentelemetryMetricsState();
     ...
     * 
     */
    @Import(name="additionalAttributesToDimensionEnabled")
    private @Nullable Output<Boolean> additionalAttributesToDimensionEnabled;

    /**
     * @return Add the resource and scope attributes configured below as dimensions
     * 
     */
    public Optional<Output<Boolean>> additionalAttributesToDimensionEnabled() {
        return Optional.ofNullable(this.additionalAttributesToDimensionEnabled);
    }
     ...
     * 
     */
    @Import(name="meterNameToDimensionEnabled")
    private @Nullable Output<Boolean> meterNameToDimensionEnabled;
     ...
     * 
     */
    public Optional<Output<Boolean>> meterNameToDimensionEnabled() {
        return Optional.ofNullable(this.meterNameToDimensionEnabled);
    }
    ...
    private OpentelemetryMetricsState() {}

    private OpentelemetryMetricsState(OpentelemetryMetricsState $) {
    ...
    public static Builder builder(OpentelemetryMetricsState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OpentelemetryMetricsState();
        }

        public Builder(OpentelemetryMetricsState defaults) {
            $ = new OpentelemetryMetricsState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder additionalAttributesToDimensionEnabled(@Nullable Output<Boolean> additionalAttributesToDimensionEnabled) {
         ...
         * 
         */
        public Builder meterNameToDimensionEnabled(@Nullable Output<Boolean> meterNameToDimensionEnabled) {
        ...
        public OpentelemetryMetricsState build() {
            return $;
        }
    }
