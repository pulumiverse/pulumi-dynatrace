...
@CustomType
public final class K8sNamespaceAnomaliesCpuLimitsQuotaSaturationConfiguration {
    ...
    public static Builder builder(K8sNamespaceAnomaliesCpuLimitsQuotaSaturationConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer threshold;
        public Builder() {}
        public Builder(K8sNamespaceAnomaliesCpuLimitsQuotaSaturationConfiguration defaults) {
        ...
        public K8sNamespaceAnomaliesCpuLimitsQuotaSaturationConfiguration build() {
            final var o = new K8sNamespaceAnomaliesCpuLimitsQuotaSaturationConfiguration();
