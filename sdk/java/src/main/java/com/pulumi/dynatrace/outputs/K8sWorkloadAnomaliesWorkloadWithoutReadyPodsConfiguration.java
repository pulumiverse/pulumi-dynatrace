...
@CustomType
public final class K8sWorkloadAnomaliesWorkloadWithoutReadyPodsConfiguration {
    ...
    public static Builder builder(K8sWorkloadAnomaliesWorkloadWithoutReadyPodsConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer samplePeriodInMinutes;
        public Builder() {}
        public Builder(K8sWorkloadAnomaliesWorkloadWithoutReadyPodsConfiguration defaults) {
        ...
        public K8sWorkloadAnomaliesWorkloadWithoutReadyPodsConfiguration build() {
            final var o = new K8sWorkloadAnomaliesWorkloadWithoutReadyPodsConfiguration();
