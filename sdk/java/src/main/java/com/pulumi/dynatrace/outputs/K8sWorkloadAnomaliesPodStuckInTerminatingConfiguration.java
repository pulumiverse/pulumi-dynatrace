...
@CustomType
public final class K8sWorkloadAnomaliesPodStuckInTerminatingConfiguration {
    ...
    public static Builder builder(K8sWorkloadAnomaliesPodStuckInTerminatingConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer samplePeriodInMinutes;
        public Builder() {}
        public Builder(K8sWorkloadAnomaliesPodStuckInTerminatingConfiguration defaults) {
        ...
        public K8sWorkloadAnomaliesPodStuckInTerminatingConfiguration build() {
            final var o = new K8sWorkloadAnomaliesPodStuckInTerminatingConfiguration();
