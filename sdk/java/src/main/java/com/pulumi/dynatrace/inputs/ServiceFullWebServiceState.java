...
public final class ServiceFullWebServiceState extends com.pulumi.resources.ResourceArgs {

    public static final ServiceFullWebServiceState Empty = new ServiceFullWebServiceState();
    ...
    private @Nullable Output<ServiceFullWebServiceIdContributorsArgs> idContributors;

    /**
     * @return Contributors to the Service Identifier calculation. All of the Contributors always get applied.
     * 
     */
    public Optional<Output<ServiceFullWebServiceIdContributorsArgs>> idContributors() {
    ...
    private ServiceFullWebServiceState() {}

    private ServiceFullWebServiceState(ServiceFullWebServiceState $) {
    ...
    public static Builder builder(ServiceFullWebServiceState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceFullWebServiceState();
        }

        public Builder(ServiceFullWebServiceState defaults) {
            $ = new ServiceFullWebServiceState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder idContributors(@Nullable Output<ServiceFullWebServiceIdContributorsArgs> idContributors) {
        ...
        public ServiceFullWebServiceState build() {
            return $;
        }
    }
