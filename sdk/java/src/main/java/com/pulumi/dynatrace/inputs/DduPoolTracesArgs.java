...
public final class DduPoolTracesArgs extends com.pulumi.resources.ResourceArgs {

    public static final DduPoolTracesArgs Empty = new DduPoolTracesArgs();
    ...
    private DduPoolTracesArgs() {}

    private DduPoolTracesArgs(DduPoolTracesArgs $) {
    ...
    public static Builder builder(DduPoolTracesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DduPoolTracesArgs();
        }

        public Builder(DduPoolTracesArgs defaults) {
            $ = new DduPoolTracesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DduPoolTracesArgs build() {
