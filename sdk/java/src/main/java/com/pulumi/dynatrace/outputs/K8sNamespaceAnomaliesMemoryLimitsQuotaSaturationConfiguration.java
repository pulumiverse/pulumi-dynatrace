...
@CustomType
public final class K8sNamespaceAnomaliesMemoryLimitsQuotaSaturationConfiguration {
    ...
    public static Builder builder(K8sNamespaceAnomaliesMemoryLimitsQuotaSaturationConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer threshold;
        public Builder() {}
        public Builder(K8sNamespaceAnomaliesMemoryLimitsQuotaSaturationConfiguration defaults) {
        ...
        public K8sNamespaceAnomaliesMemoryLimitsQuotaSaturationConfiguration build() {
            final var o = new K8sNamespaceAnomaliesMemoryLimitsQuotaSaturationConfiguration();
