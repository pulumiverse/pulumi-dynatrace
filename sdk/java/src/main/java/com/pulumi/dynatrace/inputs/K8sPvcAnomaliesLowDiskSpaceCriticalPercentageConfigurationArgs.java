...
public final class K8sPvcAnomaliesLowDiskSpaceCriticalPercentageConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final K8sPvcAnomaliesLowDiskSpaceCriticalPercentageConfigurationArgs Empty = new K8sPvcAnomaliesLowDiskSpaceCriticalPercentageConfigurationArgs();
    ...
    private K8sPvcAnomaliesLowDiskSpaceCriticalPercentageConfigurationArgs() {}

    private K8sPvcAnomaliesLowDiskSpaceCriticalPercentageConfigurationArgs(K8sPvcAnomaliesLowDiskSpaceCriticalPercentageConfigurationArgs $) {
    ...
    public static Builder builder(K8sPvcAnomaliesLowDiskSpaceCriticalPercentageConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new K8sPvcAnomaliesLowDiskSpaceCriticalPercentageConfigurationArgs();
        }

        public Builder(K8sPvcAnomaliesLowDiskSpaceCriticalPercentageConfigurationArgs defaults) {
            $ = new K8sPvcAnomaliesLowDiskSpaceCriticalPercentageConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public K8sPvcAnomaliesLowDiskSpaceCriticalPercentageConfigurationArgs build() {
