...
@CustomType
public final class DatabaseAnomaliesV2FailureRateAutoDetectionOverAlertingProtection {
    ...
    public static Builder builder(DatabaseAnomaliesV2FailureRateAutoDetectionOverAlertingProtection defaults) {
    ...
    public static final class Builder {
        ...
        private Double requestsPerMinute;
        public Builder() {}
        public Builder(DatabaseAnomaliesV2FailureRateAutoDetectionOverAlertingProtection defaults) {
        ...
        public DatabaseAnomaliesV2FailureRateAutoDetectionOverAlertingProtection build() {
            final var o = new DatabaseAnomaliesV2FailureRateAutoDetectionOverAlertingProtection();
