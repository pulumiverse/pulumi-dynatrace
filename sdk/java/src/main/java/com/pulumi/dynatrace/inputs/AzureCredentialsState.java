...
public final class AzureCredentialsState extends com.pulumi.resources.ResourceArgs {

    public static final AzureCredentialsState Empty = new AzureCredentialsState();
     ...
     * 
     */
    @Import(name="monitorOnlyTaggedEntities")
    private @Nullable Output<Boolean> monitorOnlyTaggedEntities;

    /**
     * @return Monitor only resources that have specified Azure tags (`true`) or all resources (`false`).
     * 
     */
    public Optional<Output<Boolean>> monitorOnlyTaggedEntities() {
        return Optional.ofNullable(this.monitorOnlyTaggedEntities);
    }
    ...
    private AzureCredentialsState() {}

    private AzureCredentialsState(AzureCredentialsState $) {
        this.active = $.active;
        this.appId = $.appId;
    ...
    public static Builder builder(AzureCredentialsState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureCredentialsState();
        }

        public Builder(AzureCredentialsState defaults) {
            $ = new AzureCredentialsState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder monitorOnlyTaggedEntities(@Nullable Output<Boolean> monitorOnlyTaggedEntities) {
        ...
        public AzureCredentialsState build() {
            return $;
        }
    }
