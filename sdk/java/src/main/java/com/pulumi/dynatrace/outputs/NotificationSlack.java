...
@CustomType
public final class NotificationSlack {
    /**
    ...
    public static Builder builder(NotificationSlack defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String url;
        public Builder() {}
        public Builder(NotificationSlack defaults) {
        ...
        public NotificationSlack build() {
            final var o = new NotificationSlack();
            o.active = active;
