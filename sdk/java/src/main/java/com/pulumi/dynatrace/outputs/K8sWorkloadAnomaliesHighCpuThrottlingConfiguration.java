...
@CustomType
public final class K8sWorkloadAnomaliesHighCpuThrottlingConfiguration {
    ...
    public static Builder builder(K8sWorkloadAnomaliesHighCpuThrottlingConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer threshold;
        public Builder() {}
        public Builder(K8sWorkloadAnomaliesHighCpuThrottlingConfiguration defaults) {
        ...
        public K8sWorkloadAnomaliesHighCpuThrottlingConfiguration build() {
            final var o = new K8sWorkloadAnomaliesHighCpuThrottlingConfiguration();
