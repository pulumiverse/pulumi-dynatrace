...
public final class K8sNodeAnomaliesPodsSaturationConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final K8sNodeAnomaliesPodsSaturationConfigurationArgs Empty = new K8sNodeAnomaliesPodsSaturationConfigurationArgs();
    ...
    private K8sNodeAnomaliesPodsSaturationConfigurationArgs() {}

    private K8sNodeAnomaliesPodsSaturationConfigurationArgs(K8sNodeAnomaliesPodsSaturationConfigurationArgs $) {
    ...
    public static Builder builder(K8sNodeAnomaliesPodsSaturationConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new K8sNodeAnomaliesPodsSaturationConfigurationArgs();
        }

        public Builder(K8sNodeAnomaliesPodsSaturationConfigurationArgs defaults) {
            $ = new K8sNodeAnomaliesPodsSaturationConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public K8sNodeAnomaliesPodsSaturationConfigurationArgs build() {
