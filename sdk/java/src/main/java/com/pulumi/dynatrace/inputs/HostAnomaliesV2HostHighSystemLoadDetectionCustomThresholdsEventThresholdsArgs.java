...
public final class HostAnomaliesV2HostHighSystemLoadDetectionCustomThresholdsEventThresholdsArgs extends com.pulumi.resources.ResourceArgs {

    public static final HostAnomaliesV2HostHighSystemLoadDetectionCustomThresholdsEventThresholdsArgs Empty = new HostAnomaliesV2HostHighSystemLoadDetectionCustomThresholdsEventThresholdsArgs();
    ...
    private HostAnomaliesV2HostHighSystemLoadDetectionCustomThresholdsEventThresholdsArgs() {}

    private HostAnomaliesV2HostHighSystemLoadDetectionCustomThresholdsEventThresholdsArgs(HostAnomaliesV2HostHighSystemLoadDetectionCustomThresholdsEventThresholdsArgs $) {
    ...
    public static Builder builder(HostAnomaliesV2HostHighSystemLoadDetectionCustomThresholdsEventThresholdsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HostAnomaliesV2HostHighSystemLoadDetectionCustomThresholdsEventThresholdsArgs();
        }

        public Builder(HostAnomaliesV2HostHighSystemLoadDetectionCustomThresholdsEventThresholdsArgs defaults) {
            $ = new HostAnomaliesV2HostHighSystemLoadDetectionCustomThresholdsEventThresholdsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HostAnomaliesV2HostHighSystemLoadDetectionCustomThresholdsEventThresholdsArgs build() {
