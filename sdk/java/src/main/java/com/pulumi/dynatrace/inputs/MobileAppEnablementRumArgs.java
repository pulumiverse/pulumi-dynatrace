...
public final class MobileAppEnablementRumArgs extends com.pulumi.resources.ResourceArgs {

    public static final MobileAppEnablementRumArgs Empty = new MobileAppEnablementRumArgs();
    ...
    private MobileAppEnablementRumArgs() {}

    private MobileAppEnablementRumArgs(MobileAppEnablementRumArgs $) {
    ...
    public static Builder builder(MobileAppEnablementRumArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MobileAppEnablementRumArgs();
        }

        public Builder(MobileAppEnablementRumArgs defaults) {
            $ = new MobileAppEnablementRumArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param costAndTrafficControl Percentage of user sessions captured and analyzed. By default, Dynatrace captures all user actions and user sessions for analysis. This approach ensures complete insight into your application’s performance and customer experience. You can optionally reduce the granularity of user-action and user-session analysis by capturing a lower percentage of user sessions. While this approach can reduce monitoring costs, it also results in lower visibility into how your customers are using your applications. For example, a setting of 10% results in Dynatrace analyzing only every tenth user session.
         * 
         * @return builder
         * 
         */
        ...
        public MobileAppEnablementRumArgs build() {
