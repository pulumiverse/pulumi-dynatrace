...
public final class ServiceFullWebRequestState extends com.pulumi.resources.ResourceArgs {

    public static final ServiceFullWebRequestState Empty = new ServiceFullWebRequestState();
    ...
    private @Nullable Output<ServiceFullWebRequestIdContributorsArgs> idContributors;

    /**
     * @return Contributors to the Service Identifier calculation. All of the Contributors always get applied.
     * 
     */
    public Optional<Output<ServiceFullWebRequestIdContributorsArgs>> idContributors() {
    ...
    private ServiceFullWebRequestState() {}

    private ServiceFullWebRequestState(ServiceFullWebRequestState $) {
    ...
    public static Builder builder(ServiceFullWebRequestState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceFullWebRequestState();
        }

        public Builder(ServiceFullWebRequestState defaults) {
            $ = new ServiceFullWebRequestState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder idContributors(@Nullable Output<ServiceFullWebRequestIdContributorsArgs> idContributors) {
        ...
        public ServiceFullWebRequestState build() {
            return $;
        }
    }
