...
public final class K8sWorkloadAnomaliesPendingPodsConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final K8sWorkloadAnomaliesPendingPodsConfigurationArgs Empty = new K8sWorkloadAnomaliesPendingPodsConfigurationArgs();
    ...
    private K8sWorkloadAnomaliesPendingPodsConfigurationArgs() {}

    private K8sWorkloadAnomaliesPendingPodsConfigurationArgs(K8sWorkloadAnomaliesPendingPodsConfigurationArgs $) {
    ...
    public static Builder builder(K8sWorkloadAnomaliesPendingPodsConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new K8sWorkloadAnomaliesPendingPodsConfigurationArgs();
        }

        public Builder(K8sWorkloadAnomaliesPendingPodsConfigurationArgs defaults) {
            $ = new K8sWorkloadAnomaliesPendingPodsConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public K8sWorkloadAnomaliesPendingPodsConfigurationArgs build() {
