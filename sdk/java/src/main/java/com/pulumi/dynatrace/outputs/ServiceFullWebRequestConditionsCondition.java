...
@CustomType
public final class ServiceFullWebRequestConditionsCondition {
    ...
    public static Builder builder(ServiceFullWebRequestConditionsCondition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> textValues;
        public Builder() {}
        public Builder(ServiceFullWebRequestConditionsCondition defaults) {
        ...
        public ServiceFullWebRequestConditionsCondition build() {
            final var o = new ServiceFullWebRequestConditionsCondition();
