...
public final class K8sClusterAnomaliesPodsSaturationConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final K8sClusterAnomaliesPodsSaturationConfigurationArgs Empty = new K8sClusterAnomaliesPodsSaturationConfigurationArgs();
    ...
    private K8sClusterAnomaliesPodsSaturationConfigurationArgs() {}

    private K8sClusterAnomaliesPodsSaturationConfigurationArgs(K8sClusterAnomaliesPodsSaturationConfigurationArgs $) {
    ...
    public static Builder builder(K8sClusterAnomaliesPodsSaturationConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new K8sClusterAnomaliesPodsSaturationConfigurationArgs();
        }

        public Builder(K8sClusterAnomaliesPodsSaturationConfigurationArgs defaults) {
            $ = new K8sClusterAnomaliesPodsSaturationConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public K8sClusterAnomaliesPodsSaturationConfigurationArgs build() {
