...
@CustomType
public final class K8sPvcAnomaliesLowDiskSpaceCriticalConfiguration {
    ...
    public static Builder builder(K8sPvcAnomaliesLowDiskSpaceCriticalConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer threshold;
        public Builder() {}
        public Builder(K8sPvcAnomaliesLowDiskSpaceCriticalConfiguration defaults) {
        ...
        public K8sPvcAnomaliesLowDiskSpaceCriticalConfiguration build() {
            final var o = new K8sPvcAnomaliesLowDiskSpaceCriticalConfiguration();
