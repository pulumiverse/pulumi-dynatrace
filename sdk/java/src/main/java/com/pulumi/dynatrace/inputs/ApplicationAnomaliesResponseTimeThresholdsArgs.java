...
public final class ApplicationAnomaliesResponseTimeThresholdsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApplicationAnomaliesResponseTimeThresholdsArgs Empty = new ApplicationAnomaliesResponseTimeThresholdsArgs();
    ...
    private ApplicationAnomaliesResponseTimeThresholdsArgs() {}

    private ApplicationAnomaliesResponseTimeThresholdsArgs(ApplicationAnomaliesResponseTimeThresholdsArgs $) {
        this.load = $.load;
    ...
    public static Builder builder(ApplicationAnomaliesResponseTimeThresholdsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplicationAnomaliesResponseTimeThresholdsArgs();
        }

        public Builder(ApplicationAnomaliesResponseTimeThresholdsArgs defaults) {
            $ = new ApplicationAnomaliesResponseTimeThresholdsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApplicationAnomaliesResponseTimeThresholdsArgs build() {
