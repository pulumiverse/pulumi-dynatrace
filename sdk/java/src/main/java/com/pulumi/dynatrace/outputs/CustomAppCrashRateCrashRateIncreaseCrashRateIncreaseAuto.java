...
@CustomType
public final class CustomAppCrashRateCrashRateIncreaseCrashRateIncreaseAuto {
    ...
    public static Builder builder(CustomAppCrashRateCrashRateIncreaseCrashRateIncreaseAuto defaults) {
    ...
    public static final class Builder {
        ...
        private String sensitivity;
        public Builder() {}
        public Builder(CustomAppCrashRateCrashRateIncreaseCrashRateIncreaseAuto defaults) {
        ...
        public CustomAppCrashRateCrashRateIncreaseCrashRateIncreaseAuto build() {
            final var o = new CustomAppCrashRateCrashRateIncreaseCrashRateIncreaseAuto();
