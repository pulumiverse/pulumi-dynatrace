...
@CustomType
public final class UserSessionMetricsFiltersFilter {
    ...
    public static Builder builder(UserSessionMetricsFiltersFilter defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> valueIns;
        public Builder() {}
        public Builder(UserSessionMetricsFiltersFilter defaults) {
        ...
        public UserSessionMetricsFiltersFilter build() {
            final var o = new UserSessionMetricsFiltersFilter();
