...
public final class HostAnomaliesV2HostHighGcActivityDetectionCustomThresholdsEventThresholdsArgs extends com.pulumi.resources.ResourceArgs {

    public static final HostAnomaliesV2HostHighGcActivityDetectionCustomThresholdsEventThresholdsArgs Empty = new HostAnomaliesV2HostHighGcActivityDetectionCustomThresholdsEventThresholdsArgs();
    ...
    private HostAnomaliesV2HostHighGcActivityDetectionCustomThresholdsEventThresholdsArgs() {}

    private HostAnomaliesV2HostHighGcActivityDetectionCustomThresholdsEventThresholdsArgs(HostAnomaliesV2HostHighGcActivityDetectionCustomThresholdsEventThresholdsArgs $) {
    ...
    public static Builder builder(HostAnomaliesV2HostHighGcActivityDetectionCustomThresholdsEventThresholdsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HostAnomaliesV2HostHighGcActivityDetectionCustomThresholdsEventThresholdsArgs();
        }

        public Builder(HostAnomaliesV2HostHighGcActivityDetectionCustomThresholdsEventThresholdsArgs defaults) {
            $ = new HostAnomaliesV2HostHighGcActivityDetectionCustomThresholdsEventThresholdsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HostAnomaliesV2HostHighGcActivityDetectionCustomThresholdsEventThresholdsArgs build() {
