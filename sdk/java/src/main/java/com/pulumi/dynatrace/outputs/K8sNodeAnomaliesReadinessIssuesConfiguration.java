...
@CustomType
public final class K8sNodeAnomaliesReadinessIssuesConfiguration {
    ...
    public static Builder builder(K8sNodeAnomaliesReadinessIssuesConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer samplePeriodInMinutes;
        public Builder() {}
        public Builder(K8sNodeAnomaliesReadinessIssuesConfiguration defaults) {
        ...
        public K8sNodeAnomaliesReadinessIssuesConfiguration build() {
            final var o = new K8sNodeAnomaliesReadinessIssuesConfiguration();
