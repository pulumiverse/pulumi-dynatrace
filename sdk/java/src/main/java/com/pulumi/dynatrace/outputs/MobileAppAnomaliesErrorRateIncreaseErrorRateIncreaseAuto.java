...
@CustomType
public final class MobileAppAnomaliesErrorRateIncreaseErrorRateIncreaseAuto {
    ...
    public static Builder builder(MobileAppAnomaliesErrorRateIncreaseErrorRateIncreaseAuto defaults) {
    ...
    public static final class Builder {
        ...
        private Double thresholdRelative;
        public Builder() {}
        public Builder(MobileAppAnomaliesErrorRateIncreaseErrorRateIncreaseAuto defaults) {
        ...
        public MobileAppAnomaliesErrorRateIncreaseErrorRateIncreaseAuto build() {
            final var o = new MobileAppAnomaliesErrorRateIncreaseErrorRateIncreaseAuto();
