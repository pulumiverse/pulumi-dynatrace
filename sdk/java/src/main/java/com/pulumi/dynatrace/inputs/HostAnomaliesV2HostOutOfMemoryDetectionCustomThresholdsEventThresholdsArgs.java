...
public final class HostAnomaliesV2HostOutOfMemoryDetectionCustomThresholdsEventThresholdsArgs extends com.pulumi.resources.ResourceArgs {

    public static final HostAnomaliesV2HostOutOfMemoryDetectionCustomThresholdsEventThresholdsArgs Empty = new HostAnomaliesV2HostOutOfMemoryDetectionCustomThresholdsEventThresholdsArgs();
    ...
    private HostAnomaliesV2HostOutOfMemoryDetectionCustomThresholdsEventThresholdsArgs() {}

    private HostAnomaliesV2HostOutOfMemoryDetectionCustomThresholdsEventThresholdsArgs(HostAnomaliesV2HostOutOfMemoryDetectionCustomThresholdsEventThresholdsArgs $) {
    ...
    public static Builder builder(HostAnomaliesV2HostOutOfMemoryDetectionCustomThresholdsEventThresholdsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HostAnomaliesV2HostOutOfMemoryDetectionCustomThresholdsEventThresholdsArgs();
        }

        public Builder(HostAnomaliesV2HostOutOfMemoryDetectionCustomThresholdsEventThresholdsArgs defaults) {
            $ = new HostAnomaliesV2HostOutOfMemoryDetectionCustomThresholdsEventThresholdsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HostAnomaliesV2HostOutOfMemoryDetectionCustomThresholdsEventThresholdsArgs build() {
