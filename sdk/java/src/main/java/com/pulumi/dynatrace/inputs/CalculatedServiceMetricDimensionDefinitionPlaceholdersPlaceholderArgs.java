...
import com.pulumi.dynatrace.inputs.CalculatedServiceMetricDimensionDefinitionPlaceholdersPlaceholderSourceArgs;
...
public final class CalculatedServiceMetricDimensionDefinitionPlaceholdersPlaceholderArgs extends com.pulumi.resources.ResourceArgs {

    public static final CalculatedServiceMetricDimensionDefinitionPlaceholdersPlaceholderArgs Empty = new CalculatedServiceMetricDimensionDefinitionPlaceholdersPlaceholderArgs();
    ...
    @Import(name="source")
    private @Nullable Output<CalculatedServiceMetricDimensionDefinitionPlaceholdersPlaceholderSourceArgs> source;

    public Optional<Output<CalculatedServiceMetricDimensionDefinitionPlaceholdersPlaceholderSourceArgs>> source() {
    ...
    private CalculatedServiceMetricDimensionDefinitionPlaceholdersPlaceholderArgs() {}

    private CalculatedServiceMetricDimensionDefinitionPlaceholdersPlaceholderArgs(CalculatedServiceMetricDimensionDefinitionPlaceholdersPlaceholderArgs $) {
    ...
    public static Builder builder(CalculatedServiceMetricDimensionDefinitionPlaceholdersPlaceholderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CalculatedServiceMetricDimensionDefinitionPlaceholdersPlaceholderArgs();
        }

        public Builder(CalculatedServiceMetricDimensionDefinitionPlaceholdersPlaceholderArgs defaults) {
            $ = new CalculatedServiceMetricDimensionDefinitionPlaceholdersPlaceholderArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder source(@Nullable Output<CalculatedServiceMetricDimensionDefinitionPlaceholdersPlaceholderSourceArgs> source) {
            $.source = source;
            return this;
        }

        public Builder source(CalculatedServiceMetricDimensionDefinitionPlaceholdersPlaceholderSourceArgs source) {
        ...
        public CalculatedServiceMetricDimensionDefinitionPlaceholdersPlaceholderArgs build() {
