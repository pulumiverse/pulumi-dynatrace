...
@CustomType
public final class ServiceExternalWebServiceConditionsCondition {
    ...
    public static Builder builder(ServiceExternalWebServiceConditionsCondition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> textValues;
        public Builder() {}
        public Builder(ServiceExternalWebServiceConditionsCondition defaults) {
        ...
        public ServiceExternalWebServiceConditionsCondition build() {
            final var o = new ServiceExternalWebServiceConditionsCondition();
