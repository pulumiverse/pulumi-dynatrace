...
@CustomType
public final class K8sPvcAnomaliesLowDiskSpaceCriticalPercentageConfiguration {
    ...
    public static Builder builder(K8sPvcAnomaliesLowDiskSpaceCriticalPercentageConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer threshold;
        public Builder() {}
        public Builder(K8sPvcAnomaliesLowDiskSpaceCriticalPercentageConfiguration defaults) {
        ...
        public K8sPvcAnomaliesLowDiskSpaceCriticalPercentageConfiguration build() {
            final var o = new K8sPvcAnomaliesLowDiskSpaceCriticalPercentageConfiguration();
