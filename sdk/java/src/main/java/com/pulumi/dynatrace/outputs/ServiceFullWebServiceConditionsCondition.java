...
@CustomType
public final class ServiceFullWebServiceConditionsCondition {
    ...
    public static Builder builder(ServiceFullWebServiceConditionsCondition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> textValues;
        public Builder() {}
        public Builder(ServiceFullWebServiceConditionsCondition defaults) {
        ...
        public ServiceFullWebServiceConditionsCondition build() {
            final var o = new ServiceFullWebServiceConditionsCondition();
