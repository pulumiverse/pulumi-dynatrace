...
public final class QueueManagerState extends com.pulumi.resources.ResourceArgs {

    public static final QueueManagerState Empty = new QueueManagerState();
    ...
    private QueueManagerState() {}

    private QueueManagerState(QueueManagerState $) {
    ...
    public static Builder builder(QueueManagerState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new QueueManagerState();
        }

        public Builder(QueueManagerState defaults) {
            $ = new QueueManagerState(Objects.requireNonNull(defaults));
        }
        ...
        public QueueManagerState build() {
            return $;
        }
    }
