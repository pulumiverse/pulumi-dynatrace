...
@CustomType
public final class ApplicationAnomaliesFailureRateAuto {
    ...
    public static Builder builder(ApplicationAnomaliesFailureRateAuto defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String unknowns;
        public Builder() {}
        public Builder(ApplicationAnomaliesFailureRateAuto defaults) {
        ...
        public ApplicationAnomaliesFailureRateAuto build() {
            final var o = new ApplicationAnomaliesFailureRateAuto();
            o.absolute = absolute;
            o.relative = relative;
            o.unknowns = unknowns;
            return o;
