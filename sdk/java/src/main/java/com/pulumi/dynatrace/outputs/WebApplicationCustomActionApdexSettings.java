...
@CustomType
public final class WebApplicationCustomActionApdexSettings {
    /**
    ...
    public static Builder builder(WebApplicationCustomActionApdexSettings defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer toleratedThreshold;
        public Builder() {}
        public Builder(WebApplicationCustomActionApdexSettings defaults) {
        ...
        public WebApplicationCustomActionApdexSettings build() {
            final var o = new WebApplicationCustomActionApdexSettings();
