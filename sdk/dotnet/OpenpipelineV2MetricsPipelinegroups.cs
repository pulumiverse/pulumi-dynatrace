...
namespace Pulumiverse.Dynatrace
{
    ...
    /// ```
    /// </summary>
    [DynatraceResourceType("dynatrace:index/openpipelineV2MetricsPipelinegroups:OpenpipelineV2MetricsPipelinegroups")]
    public partial class OpenpipelineV2MetricsPipelinegroups : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Composition
        /// </summary>
        [Output("composition")]
        public Output<Outputs.OpenpipelineV2MetricsPipelinegroupsComposition?> Composition { get; private set; } = null!;
        ...
        /// </summary>
        [Output("memberStages")]
        public Output<Outputs.OpenpipelineV2MetricsPipelinegroupsMemberStages> MemberStages { get; private set; } = null!;
        ...
        public OpenpipelineV2MetricsPipelinegroups(string name, OpenpipelineV2MetricsPipelinegroupsArgs args, CustomResourceOptions? options = null)
            : base("dynatrace:index/openpipelineV2MetricsPipelinegroups:OpenpipelineV2MetricsPipelinegroups", name, args ?? new OpenpipelineV2MetricsPipelinegroupsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenpipelineV2MetricsPipelinegroups(string name, Input<string> id, OpenpipelineV2MetricsPipelinegroupsState? state = null, CustomResourceOptions? options = null)
            : base("dynatrace:index/openpipelineV2MetricsPipelinegroups:OpenpipelineV2MetricsPipelinegroups", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OpenpipelineV2MetricsPipelinegroups Get(string name, Input<string> id, OpenpipelineV2MetricsPipelinegroupsState? state = null, CustomResourceOptions? options = null)
        {
            return new OpenpipelineV2MetricsPipelinegroups(name, id, state, options);
        }
    }

    public sealed class OpenpipelineV2MetricsPipelinegroupsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Composition
        /// </summary>
        [Input("composition")]
        public Input<Inputs.OpenpipelineV2MetricsPipelinegroupsCompositionArgs>? Composition { get; set; }
        ...
        public Input<Inputs.OpenpipelineV2MetricsPipelinegroupsMemberStagesArgs> MemberStages { get; set; } = null!;

        public OpenpipelineV2MetricsPipelinegroupsArgs()
        {
        }
        public static new OpenpipelineV2MetricsPipelinegroupsArgs Empty => new OpenpipelineV2MetricsPipelinegroupsArgs();
    }

    public sealed class OpenpipelineV2MetricsPipelinegroupsState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Composition
        /// </summary>
        [Input("composition")]
        public Input<Inputs.OpenpipelineV2MetricsPipelinegroupsCompositionGetArgs>? Composition { get; set; }
        ...
        /// </summary>
        [Input("memberStages")]
        public Input<Inputs.OpenpipelineV2MetricsPipelinegroupsMemberStagesGetArgs>? MemberStages { get; set; }

        public OpenpipelineV2MetricsPipelinegroupsState()
        {
        }
        public static new OpenpipelineV2MetricsPipelinegroupsState Empty => new OpenpipelineV2MetricsPipelinegroupsState();
    }
}
