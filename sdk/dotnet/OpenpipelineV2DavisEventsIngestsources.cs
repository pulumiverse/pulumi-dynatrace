...
namespace Pulumiverse.Dynatrace
{
    ...
    /// ```
    /// </summary>
    [DynatraceResourceType("dynatrace:index/openpipelineV2DavisEventsIngestsources:OpenpipelineV2DavisEventsIngestsources")]
    public partial class OpenpipelineV2DavisEventsIngestsources : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Default Bucket
        /// </summary>
        ...
        /// </summary>
        [Output("metadataList")]
        public Output<Outputs.OpenpipelineV2DavisEventsIngestsourcesMetadataList?> MetadataList { get; private set; } = null!;
        ...
        /// </summary>
        [Output("processing")]
        public Output<Outputs.OpenpipelineV2DavisEventsIngestsourcesProcessing?> Processing { get; private set; } = null!;
        ...
        public Output<Outputs.OpenpipelineV2DavisEventsIngestsourcesStaticRouting?> StaticRouting { get; private set; } = null!;
        ...
        public OpenpipelineV2DavisEventsIngestsources(string name, OpenpipelineV2DavisEventsIngestsourcesArgs args, CustomResourceOptions? options = null)
            : base("dynatrace:index/openpipelineV2DavisEventsIngestsources:OpenpipelineV2DavisEventsIngestsources", name, args ?? new OpenpipelineV2DavisEventsIngestsourcesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenpipelineV2DavisEventsIngestsources(string name, Input<string> id, OpenpipelineV2DavisEventsIngestsourcesState? state = null, CustomResourceOptions? options = null)
            : base("dynatrace:index/openpipelineV2DavisEventsIngestsources:OpenpipelineV2DavisEventsIngestsources", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OpenpipelineV2DavisEventsIngestsources Get(string name, Input<string> id, OpenpipelineV2DavisEventsIngestsourcesState? state = null, CustomResourceOptions? options = null)
        {
            return new OpenpipelineV2DavisEventsIngestsources(name, id, state, options);
        }
    }

    public sealed class OpenpipelineV2DavisEventsIngestsourcesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Default Bucket
        /// </summary>
        ...
        /// </summary>
        [Input("metadataList")]
        public Input<Inputs.OpenpipelineV2DavisEventsIngestsourcesMetadataListArgs>? MetadataList { get; set; }
        ...
        /// </summary>
        [Input("processing")]
        public Input<Inputs.OpenpipelineV2DavisEventsIngestsourcesProcessingArgs>? Processing { get; set; }
        ...
        /// </summary>
        [Input("staticRouting")]
        public Input<Inputs.OpenpipelineV2DavisEventsIngestsourcesStaticRoutingArgs>? StaticRouting { get; set; }

        public OpenpipelineV2DavisEventsIngestsourcesArgs()
        {
        }
        public static new OpenpipelineV2DavisEventsIngestsourcesArgs Empty => new OpenpipelineV2DavisEventsIngestsourcesArgs();
    }

    public sealed class OpenpipelineV2DavisEventsIngestsourcesState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Default Bucket
        /// </summary>
        ...
        /// </summary>
        [Input("metadataList")]
        public Input<Inputs.OpenpipelineV2DavisEventsIngestsourcesMetadataListGetArgs>? MetadataList { get; set; }
        ...
        /// </summary>
        [Input("processing")]
        public Input<Inputs.OpenpipelineV2DavisEventsIngestsourcesProcessingGetArgs>? Processing { get; set; }
        ...
        /// </summary>
        [Input("staticRouting")]
        public Input<Inputs.OpenpipelineV2DavisEventsIngestsourcesStaticRoutingGetArgs>? StaticRouting { get; set; }

        public OpenpipelineV2DavisEventsIngestsourcesState()
        {
        }
        public static new OpenpipelineV2DavisEventsIngestsourcesState Empty => new OpenpipelineV2DavisEventsIngestsourcesState();
    }
}
