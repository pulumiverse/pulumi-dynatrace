...
namespace Pulumiverse.Dynatrace
{
    ...
    /// 
    /// - `terraform-provider-dynatrace -export dynatrace.OpenpipelineV2SecurityEventsIngestsources` downloads all existing OpenPipeline definitions for security events ingest sources
    /// 
    ...
    /// ```
    /// </summary>
    [DynatraceResourceType("dynatrace:index/openpipelineV2SecurityEventsIngestsources:OpenpipelineV2SecurityEventsIngestsources")]
    public partial class OpenpipelineV2SecurityEventsIngestsources : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Default Bucket
        /// </summary>
        ...
        /// </summary>
        [Output("metadataList")]
        public Output<Outputs.OpenpipelineV2SecurityEventsIngestsourcesMetadataList?> MetadataList { get; private set; } = null!;
        ...
        /// </summary>
        [Output("processing")]
        public Output<Outputs.OpenpipelineV2SecurityEventsIngestsourcesProcessing?> Processing { get; private set; } = null!;
        ...
        public Output<Outputs.OpenpipelineV2SecurityEventsIngestsourcesStaticRouting?> StaticRouting { get; private set; } = null!;
        ...
        public OpenpipelineV2SecurityEventsIngestsources(string name, OpenpipelineV2SecurityEventsIngestsourcesArgs args, CustomResourceOptions? options = null)
            : base("dynatrace:index/openpipelineV2SecurityEventsIngestsources:OpenpipelineV2SecurityEventsIngestsources", name, args ?? new OpenpipelineV2SecurityEventsIngestsourcesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenpipelineV2SecurityEventsIngestsources(string name, Input<string> id, OpenpipelineV2SecurityEventsIngestsourcesState? state = null, CustomResourceOptions? options = null)
            : base("dynatrace:index/openpipelineV2SecurityEventsIngestsources:OpenpipelineV2SecurityEventsIngestsources", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OpenpipelineV2SecurityEventsIngestsources Get(string name, Input<string> id, OpenpipelineV2SecurityEventsIngestsourcesState? state = null, CustomResourceOptions? options = null)
        {
            return new OpenpipelineV2SecurityEventsIngestsources(name, id, state, options);
        }
    }

    public sealed class OpenpipelineV2SecurityEventsIngestsourcesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Default Bucket
        /// </summary>
        ...
        /// </summary>
        [Input("metadataList")]
        public Input<Inputs.OpenpipelineV2SecurityEventsIngestsourcesMetadataListArgs>? MetadataList { get; set; }
        ...
        /// </summary>
        [Input("processing")]
        public Input<Inputs.OpenpipelineV2SecurityEventsIngestsourcesProcessingArgs>? Processing { get; set; }
        ...
        /// </summary>
        [Input("staticRouting")]
        public Input<Inputs.OpenpipelineV2SecurityEventsIngestsourcesStaticRoutingArgs>? StaticRouting { get; set; }

        public OpenpipelineV2SecurityEventsIngestsourcesArgs()
        {
        }
        public static new OpenpipelineV2SecurityEventsIngestsourcesArgs Empty => new OpenpipelineV2SecurityEventsIngestsourcesArgs();
    }

    public sealed class OpenpipelineV2SecurityEventsIngestsourcesState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Default Bucket
        /// </summary>
        ...
        /// </summary>
        [Input("metadataList")]
        public Input<Inputs.OpenpipelineV2SecurityEventsIngestsourcesMetadataListGetArgs>? MetadataList { get; set; }
        ...
        /// </summary>
        [Input("processing")]
        public Input<Inputs.OpenpipelineV2SecurityEventsIngestsourcesProcessingGetArgs>? Processing { get; set; }
        ...
        /// </summary>
        [Input("staticRouting")]
        public Input<Inputs.OpenpipelineV2SecurityEventsIngestsourcesStaticRoutingGetArgs>? StaticRouting { get; set; }

        public OpenpipelineV2SecurityEventsIngestsourcesState()
        {
        }
        public static new OpenpipelineV2SecurityEventsIngestsourcesState Empty => new OpenpipelineV2SecurityEventsIngestsourcesState();
    }
}
