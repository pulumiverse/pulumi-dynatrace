...
namespace Pulumiverse.Dynatrace.Outputs
{
    ...
    [OutputType]
    public sealed class OpenpipelineMetricsPipelinesPipelineStorage
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.OpenpipelineMetricsPipelinesPipelineStorageProcessor> Processors;

        [OutputConstructor]
        private OpenpipelineMetricsPipelinesPipelineStorage(
            string? catchAllBucketName,

            ImmutableArray<Outputs.OpenpipelineMetricsPipelinesPipelineStorageProcessor> processors)
        {
