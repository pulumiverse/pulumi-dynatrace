...
namespace Pulumiverse.Dynatrace.Outputs
{
    ...
    [OutputType]
    public sealed class OpenpipelineEventsPipelinesPipelineStorage
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.OpenpipelineEventsPipelinesPipelineStorageProcessor> Processors;

        [OutputConstructor]
        private OpenpipelineEventsPipelinesPipelineStorage(
            string? catchAllBucketName,

            ImmutableArray<Outputs.OpenpipelineEventsPipelinesPipelineStorageProcessor> processors)
        {
