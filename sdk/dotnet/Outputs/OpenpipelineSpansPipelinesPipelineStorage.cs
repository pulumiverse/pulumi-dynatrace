...
namespace Pulumiverse.Dynatrace.Outputs
{
    ...
    [OutputType]
    public sealed class OpenpipelineSpansPipelinesPipelineStorage
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.OpenpipelineSpansPipelinesPipelineStorageProcessor> Processors;

        [OutputConstructor]
        private OpenpipelineSpansPipelinesPipelineStorage(
            string? catchAllBucketName,

            ImmutableArray<Outputs.OpenpipelineSpansPipelinesPipelineStorageProcessor> processors)
        {
