...
namespace Pulumiverse.Dynatrace
{
    ...
    /// ```
    /// </summary>
    [DynatraceResourceType("dynatrace:index/openpipelineV2EventsSdlcPipelinegroups:OpenpipelineV2EventsSdlcPipelinegroups")]
    public partial class OpenpipelineV2EventsSdlcPipelinegroups : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Composition
        /// </summary>
        [Output("composition")]
        public Output<Outputs.OpenpipelineV2EventsSdlcPipelinegroupsComposition?> Composition { get; private set; } = null!;
        ...
        /// </summary>
        [Output("memberStages")]
        public Output<Outputs.OpenpipelineV2EventsSdlcPipelinegroupsMemberStages> MemberStages { get; private set; } = null!;
        ...
        public OpenpipelineV2EventsSdlcPipelinegroups(string name, OpenpipelineV2EventsSdlcPipelinegroupsArgs args, CustomResourceOptions? options = null)
            : base("dynatrace:index/openpipelineV2EventsSdlcPipelinegroups:OpenpipelineV2EventsSdlcPipelinegroups", name, args ?? new OpenpipelineV2EventsSdlcPipelinegroupsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenpipelineV2EventsSdlcPipelinegroups(string name, Input<string> id, OpenpipelineV2EventsSdlcPipelinegroupsState? state = null, CustomResourceOptions? options = null)
            : base("dynatrace:index/openpipelineV2EventsSdlcPipelinegroups:OpenpipelineV2EventsSdlcPipelinegroups", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OpenpipelineV2EventsSdlcPipelinegroups Get(string name, Input<string> id, OpenpipelineV2EventsSdlcPipelinegroupsState? state = null, CustomResourceOptions? options = null)
        {
            return new OpenpipelineV2EventsSdlcPipelinegroups(name, id, state, options);
        }
    }

    public sealed class OpenpipelineV2EventsSdlcPipelinegroupsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Composition
        /// </summary>
        [Input("composition")]
        public Input<Inputs.OpenpipelineV2EventsSdlcPipelinegroupsCompositionArgs>? Composition { get; set; }
        ...
        public Input<Inputs.OpenpipelineV2EventsSdlcPipelinegroupsMemberStagesArgs> MemberStages { get; set; } = null!;

        public OpenpipelineV2EventsSdlcPipelinegroupsArgs()
        {
        }
        public static new OpenpipelineV2EventsSdlcPipelinegroupsArgs Empty => new OpenpipelineV2EventsSdlcPipelinegroupsArgs();
    }

    public sealed class OpenpipelineV2EventsSdlcPipelinegroupsState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Composition
        /// </summary>
        [Input("composition")]
        public Input<Inputs.OpenpipelineV2EventsSdlcPipelinegroupsCompositionGetArgs>? Composition { get; set; }
        ...
        /// </summary>
        [Input("memberStages")]
        public Input<Inputs.OpenpipelineV2EventsSdlcPipelinegroupsMemberStagesGetArgs>? MemberStages { get; set; }

        public OpenpipelineV2EventsSdlcPipelinegroupsState()
        {
        }
        public static new OpenpipelineV2EventsSdlcPipelinegroupsState Empty => new OpenpipelineV2EventsSdlcPipelinegroupsState();
    }
}
