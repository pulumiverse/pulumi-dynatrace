...
namespace Pulumiverse.Dynatrace.Inputs
{
    ...
    public sealed class DashboardTileGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("bounds")]
        public Input<Inputs.DashboardTileBoundsGetArgs>? Bounds { get; set; }
        ...
        /// </summary>
        [Input("filter")]
        public Input<Inputs.DashboardTileFilterGetArgs>? Filter { get; set; }

        /// <summary>
        /// the position and size of a tile
        /// </summary>
        [Input("filterConfig")]
        public Input<Inputs.DashboardTileFilterConfigGetArgs>? FilterConfig { get; set; }
        ...
        public Input<Inputs.DashboardTileVisualizationConfigGetArgs>? VisualizationConfig { get; set; }

        public DashboardTileGetArgs()
        {
        }
        public static new DashboardTileGetArgs Empty => new DashboardTileGetArgs();
    }
}
