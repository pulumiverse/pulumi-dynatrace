...
namespace Pulumiverse.Dynatrace.Inputs
{
    ...
    public sealed class OpenpipelineDavisProblemsPipelinesPipelineGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.OpenpipelineDavisProblemsPipelinesPipelineDataExtractionGetArgs>? DataExtraction { get; set; }
        ...
        public Input<Inputs.OpenpipelineDavisProblemsPipelinesPipelineMetricExtractionGetArgs>? MetricExtraction { get; set; }
        ...
        public Input<Inputs.OpenpipelineDavisProblemsPipelinesPipelineSecurityContextGetArgs>? SecurityContext { get; set; }

        /// <summary>
        /// Data extraction stage configuration of the pipeline
        /// </summary>
        [Input("storage")]
        public Input<Inputs.OpenpipelineDavisProblemsPipelinesPipelineStorageGetArgs>? Storage { get; set; }

        public OpenpipelineDavisProblemsPipelinesPipelineGetArgs()
        {
        }
        public static new OpenpipelineDavisProblemsPipelinesPipelineGetArgs Empty => new OpenpipelineDavisProblemsPipelinesPipelineGetArgs();
    }
}
