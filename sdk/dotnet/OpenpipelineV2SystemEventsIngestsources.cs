...
namespace Pulumiverse.Dynatrace
{
    ...
    /// 
    /// - `terraform-provider-dynatrace -export dynatrace.OpenpipelineV2SystemEventsIngestsources` downloads all existing OpenPipeline definitions for system events ingest sources
    /// 
    ...
    /// ```
    /// </summary>
    [DynatraceResourceType("dynatrace:index/openpipelineV2SystemEventsIngestsources:OpenpipelineV2SystemEventsIngestsources")]
    public partial class OpenpipelineV2SystemEventsIngestsources : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Default Bucket
        /// </summary>
        ...
        /// </summary>
        [Output("metadataList")]
        public Output<Outputs.OpenpipelineV2SystemEventsIngestsourcesMetadataList?> MetadataList { get; private set; } = null!;
        ...
        /// </summary>
        [Output("processing")]
        public Output<Outputs.OpenpipelineV2SystemEventsIngestsourcesProcessing?> Processing { get; private set; } = null!;
        ...
        public Output<Outputs.OpenpipelineV2SystemEventsIngestsourcesStaticRouting?> StaticRouting { get; private set; } = null!;
        ...
        public OpenpipelineV2SystemEventsIngestsources(string name, OpenpipelineV2SystemEventsIngestsourcesArgs args, CustomResourceOptions? options = null)
            : base("dynatrace:index/openpipelineV2SystemEventsIngestsources:OpenpipelineV2SystemEventsIngestsources", name, args ?? new OpenpipelineV2SystemEventsIngestsourcesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenpipelineV2SystemEventsIngestsources(string name, Input<string> id, OpenpipelineV2SystemEventsIngestsourcesState? state = null, CustomResourceOptions? options = null)
            : base("dynatrace:index/openpipelineV2SystemEventsIngestsources:OpenpipelineV2SystemEventsIngestsources", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OpenpipelineV2SystemEventsIngestsources Get(string name, Input<string> id, OpenpipelineV2SystemEventsIngestsourcesState? state = null, CustomResourceOptions? options = null)
        {
            return new OpenpipelineV2SystemEventsIngestsources(name, id, state, options);
        }
    }

    public sealed class OpenpipelineV2SystemEventsIngestsourcesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Default Bucket
        /// </summary>
        ...
        /// </summary>
        [Input("metadataList")]
        public Input<Inputs.OpenpipelineV2SystemEventsIngestsourcesMetadataListArgs>? MetadataList { get; set; }
        ...
        /// </summary>
        [Input("processing")]
        public Input<Inputs.OpenpipelineV2SystemEventsIngestsourcesProcessingArgs>? Processing { get; set; }
        ...
        /// </summary>
        [Input("staticRouting")]
        public Input<Inputs.OpenpipelineV2SystemEventsIngestsourcesStaticRoutingArgs>? StaticRouting { get; set; }

        public OpenpipelineV2SystemEventsIngestsourcesArgs()
        {
        }
        public static new OpenpipelineV2SystemEventsIngestsourcesArgs Empty => new OpenpipelineV2SystemEventsIngestsourcesArgs();
    }

    public sealed class OpenpipelineV2SystemEventsIngestsourcesState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Default Bucket
        /// </summary>
        ...
        /// </summary>
        [Input("metadataList")]
        public Input<Inputs.OpenpipelineV2SystemEventsIngestsourcesMetadataListGetArgs>? MetadataList { get; set; }
        ...
        /// </summary>
        [Input("processing")]
        public Input<Inputs.OpenpipelineV2SystemEventsIngestsourcesProcessingGetArgs>? Processing { get; set; }
        ...
        /// </summary>
        [Input("staticRouting")]
        public Input<Inputs.OpenpipelineV2SystemEventsIngestsourcesStaticRoutingGetArgs>? StaticRouting { get; set; }

        public OpenpipelineV2SystemEventsIngestsourcesState()
        {
        }
        public static new OpenpipelineV2SystemEventsIngestsourcesState Empty => new OpenpipelineV2SystemEventsIngestsourcesState();
    }
}
