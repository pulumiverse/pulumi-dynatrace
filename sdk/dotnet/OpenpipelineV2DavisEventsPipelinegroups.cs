...
namespace Pulumiverse.Dynatrace
{
    ...
    /// ```
    /// </summary>
    [DynatraceResourceType("dynatrace:index/openpipelineV2DavisEventsPipelinegroups:OpenpipelineV2DavisEventsPipelinegroups")]
    public partial class OpenpipelineV2DavisEventsPipelinegroups : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Composition
        /// </summary>
        [Output("composition")]
        public Output<Outputs.OpenpipelineV2DavisEventsPipelinegroupsComposition?> Composition { get; private set; } = null!;
        ...
        /// </summary>
        [Output("memberStages")]
        public Output<Outputs.OpenpipelineV2DavisEventsPipelinegroupsMemberStages> MemberStages { get; private set; } = null!;
        ...
        public OpenpipelineV2DavisEventsPipelinegroups(string name, OpenpipelineV2DavisEventsPipelinegroupsArgs args, CustomResourceOptions? options = null)
            : base("dynatrace:index/openpipelineV2DavisEventsPipelinegroups:OpenpipelineV2DavisEventsPipelinegroups", name, args ?? new OpenpipelineV2DavisEventsPipelinegroupsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenpipelineV2DavisEventsPipelinegroups(string name, Input<string> id, OpenpipelineV2DavisEventsPipelinegroupsState? state = null, CustomResourceOptions? options = null)
            : base("dynatrace:index/openpipelineV2DavisEventsPipelinegroups:OpenpipelineV2DavisEventsPipelinegroups", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OpenpipelineV2DavisEventsPipelinegroups Get(string name, Input<string> id, OpenpipelineV2DavisEventsPipelinegroupsState? state = null, CustomResourceOptions? options = null)
        {
            return new OpenpipelineV2DavisEventsPipelinegroups(name, id, state, options);
        }
    }

    public sealed class OpenpipelineV2DavisEventsPipelinegroupsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Composition
        /// </summary>
        [Input("composition")]
        public Input<Inputs.OpenpipelineV2DavisEventsPipelinegroupsCompositionArgs>? Composition { get; set; }
        ...
        public Input<Inputs.OpenpipelineV2DavisEventsPipelinegroupsMemberStagesArgs> MemberStages { get; set; } = null!;

        public OpenpipelineV2DavisEventsPipelinegroupsArgs()
        {
        }
        public static new OpenpipelineV2DavisEventsPipelinegroupsArgs Empty => new OpenpipelineV2DavisEventsPipelinegroupsArgs();
    }

    public sealed class OpenpipelineV2DavisEventsPipelinegroupsState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Composition
        /// </summary>
        [Input("composition")]
        public Input<Inputs.OpenpipelineV2DavisEventsPipelinegroupsCompositionGetArgs>? Composition { get; set; }
        ...
        /// </summary>
        [Input("memberStages")]
        public Input<Inputs.OpenpipelineV2DavisEventsPipelinegroupsMemberStagesGetArgs>? MemberStages { get; set; }

        public OpenpipelineV2DavisEventsPipelinegroupsState()
        {
        }
        public static new OpenpipelineV2DavisEventsPipelinegroupsState Empty => new OpenpipelineV2DavisEventsPipelinegroupsState();
    }
}
