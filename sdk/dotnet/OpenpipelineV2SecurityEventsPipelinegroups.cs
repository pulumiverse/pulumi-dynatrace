...
namespace Pulumiverse.Dynatrace
{
    ...
    /// ```
    /// </summary>
    [DynatraceResourceType("dynatrace:index/openpipelineV2SecurityEventsPipelinegroups:OpenpipelineV2SecurityEventsPipelinegroups")]
    public partial class OpenpipelineV2SecurityEventsPipelinegroups : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Composition
        /// </summary>
        [Output("composition")]
        public Output<Outputs.OpenpipelineV2SecurityEventsPipelinegroupsComposition?> Composition { get; private set; } = null!;
        ...
        /// </summary>
        [Output("memberStages")]
        public Output<Outputs.OpenpipelineV2SecurityEventsPipelinegroupsMemberStages> MemberStages { get; private set; } = null!;
        ...
        public OpenpipelineV2SecurityEventsPipelinegroups(string name, OpenpipelineV2SecurityEventsPipelinegroupsArgs args, CustomResourceOptions? options = null)
            : base("dynatrace:index/openpipelineV2SecurityEventsPipelinegroups:OpenpipelineV2SecurityEventsPipelinegroups", name, args ?? new OpenpipelineV2SecurityEventsPipelinegroupsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenpipelineV2SecurityEventsPipelinegroups(string name, Input<string> id, OpenpipelineV2SecurityEventsPipelinegroupsState? state = null, CustomResourceOptions? options = null)
            : base("dynatrace:index/openpipelineV2SecurityEventsPipelinegroups:OpenpipelineV2SecurityEventsPipelinegroups", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OpenpipelineV2SecurityEventsPipelinegroups Get(string name, Input<string> id, OpenpipelineV2SecurityEventsPipelinegroupsState? state = null, CustomResourceOptions? options = null)
        {
            return new OpenpipelineV2SecurityEventsPipelinegroups(name, id, state, options);
        }
    }

    public sealed class OpenpipelineV2SecurityEventsPipelinegroupsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Composition
        /// </summary>
        [Input("composition")]
        public Input<Inputs.OpenpipelineV2SecurityEventsPipelinegroupsCompositionArgs>? Composition { get; set; }
        ...
        public Input<Inputs.OpenpipelineV2SecurityEventsPipelinegroupsMemberStagesArgs> MemberStages { get; set; } = null!;

        public OpenpipelineV2SecurityEventsPipelinegroupsArgs()
        {
        }
        public static new OpenpipelineV2SecurityEventsPipelinegroupsArgs Empty => new OpenpipelineV2SecurityEventsPipelinegroupsArgs();
    }

    public sealed class OpenpipelineV2SecurityEventsPipelinegroupsState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Composition
        /// </summary>
        [Input("composition")]
        public Input<Inputs.OpenpipelineV2SecurityEventsPipelinegroupsCompositionGetArgs>? Composition { get; set; }
        ...
        /// </summary>
        [Input("memberStages")]
        public Input<Inputs.OpenpipelineV2SecurityEventsPipelinegroupsMemberStagesGetArgs>? MemberStages { get; set; }

        public OpenpipelineV2SecurityEventsPipelinegroupsState()
        {
        }
        public static new OpenpipelineV2SecurityEventsPipelinegroupsState Empty => new OpenpipelineV2SecurityEventsPipelinegroupsState();
    }
}
