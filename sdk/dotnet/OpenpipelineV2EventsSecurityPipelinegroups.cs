...
namespace Pulumiverse.Dynatrace
{
    ...
    /// ```
    /// </summary>
    [DynatraceResourceType("dynatrace:index/openpipelineV2EventsSecurityPipelinegroups:OpenpipelineV2EventsSecurityPipelinegroups")]
    public partial class OpenpipelineV2EventsSecurityPipelinegroups : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Composition
        /// </summary>
        [Output("composition")]
        public Output<Outputs.OpenpipelineV2EventsSecurityPipelinegroupsComposition?> Composition { get; private set; } = null!;
        ...
        /// </summary>
        [Output("memberStages")]
        public Output<Outputs.OpenpipelineV2EventsSecurityPipelinegroupsMemberStages> MemberStages { get; private set; } = null!;
        ...
        public OpenpipelineV2EventsSecurityPipelinegroups(string name, OpenpipelineV2EventsSecurityPipelinegroupsArgs args, CustomResourceOptions? options = null)
            : base("dynatrace:index/openpipelineV2EventsSecurityPipelinegroups:OpenpipelineV2EventsSecurityPipelinegroups", name, args ?? new OpenpipelineV2EventsSecurityPipelinegroupsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenpipelineV2EventsSecurityPipelinegroups(string name, Input<string> id, OpenpipelineV2EventsSecurityPipelinegroupsState? state = null, CustomResourceOptions? options = null)
            : base("dynatrace:index/openpipelineV2EventsSecurityPipelinegroups:OpenpipelineV2EventsSecurityPipelinegroups", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OpenpipelineV2EventsSecurityPipelinegroups Get(string name, Input<string> id, OpenpipelineV2EventsSecurityPipelinegroupsState? state = null, CustomResourceOptions? options = null)
        {
            return new OpenpipelineV2EventsSecurityPipelinegroups(name, id, state, options);
        }
    }

    public sealed class OpenpipelineV2EventsSecurityPipelinegroupsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Composition
        /// </summary>
        [Input("composition")]
        public Input<Inputs.OpenpipelineV2EventsSecurityPipelinegroupsCompositionArgs>? Composition { get; set; }
        ...
        public Input<Inputs.OpenpipelineV2EventsSecurityPipelinegroupsMemberStagesArgs> MemberStages { get; set; } = null!;

        public OpenpipelineV2EventsSecurityPipelinegroupsArgs()
        {
        }
        public static new OpenpipelineV2EventsSecurityPipelinegroupsArgs Empty => new OpenpipelineV2EventsSecurityPipelinegroupsArgs();
    }

    public sealed class OpenpipelineV2EventsSecurityPipelinegroupsState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Composition
        /// </summary>
        [Input("composition")]
        public Input<Inputs.OpenpipelineV2EventsSecurityPipelinegroupsCompositionGetArgs>? Composition { get; set; }
        ...
        /// </summary>
        [Input("memberStages")]
        public Input<Inputs.OpenpipelineV2EventsSecurityPipelinegroupsMemberStagesGetArgs>? MemberStages { get; set; }

        public OpenpipelineV2EventsSecurityPipelinegroupsState()
        {
        }
        public static new OpenpipelineV2EventsSecurityPipelinegroupsState Empty => new OpenpipelineV2EventsSecurityPipelinegroupsState();
    }
}
