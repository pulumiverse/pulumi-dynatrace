...
namespace Pulumiverse.Dynatrace
{
    ...
    /// ```
    /// </summary>
    [DynatraceResourceType("dynatrace:index/openpipelineV2UsersessionsPipelinegroups:OpenpipelineV2UsersessionsPipelinegroups")]
    public partial class OpenpipelineV2UsersessionsPipelinegroups : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Composition
        /// </summary>
        [Output("composition")]
        public Output<Outputs.OpenpipelineV2UsersessionsPipelinegroupsComposition?> Composition { get; private set; } = null!;
        ...
        /// </summary>
        [Output("memberStages")]
        public Output<Outputs.OpenpipelineV2UsersessionsPipelinegroupsMemberStages> MemberStages { get; private set; } = null!;
        ...
        public OpenpipelineV2UsersessionsPipelinegroups(string name, OpenpipelineV2UsersessionsPipelinegroupsArgs args, CustomResourceOptions? options = null)
            : base("dynatrace:index/openpipelineV2UsersessionsPipelinegroups:OpenpipelineV2UsersessionsPipelinegroups", name, args ?? new OpenpipelineV2UsersessionsPipelinegroupsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenpipelineV2UsersessionsPipelinegroups(string name, Input<string> id, OpenpipelineV2UsersessionsPipelinegroupsState? state = null, CustomResourceOptions? options = null)
            : base("dynatrace:index/openpipelineV2UsersessionsPipelinegroups:OpenpipelineV2UsersessionsPipelinegroups", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OpenpipelineV2UsersessionsPipelinegroups Get(string name, Input<string> id, OpenpipelineV2UsersessionsPipelinegroupsState? state = null, CustomResourceOptions? options = null)
        {
            return new OpenpipelineV2UsersessionsPipelinegroups(name, id, state, options);
        }
    }

    public sealed class OpenpipelineV2UsersessionsPipelinegroupsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Composition
        /// </summary>
        [Input("composition")]
        public Input<Inputs.OpenpipelineV2UsersessionsPipelinegroupsCompositionArgs>? Composition { get; set; }
        ...
        public Input<Inputs.OpenpipelineV2UsersessionsPipelinegroupsMemberStagesArgs> MemberStages { get; set; } = null!;

        public OpenpipelineV2UsersessionsPipelinegroupsArgs()
        {
        }
        public static new OpenpipelineV2UsersessionsPipelinegroupsArgs Empty => new OpenpipelineV2UsersessionsPipelinegroupsArgs();
    }

    public sealed class OpenpipelineV2UsersessionsPipelinegroupsState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Composition
        /// </summary>
        [Input("composition")]
        public Input<Inputs.OpenpipelineV2UsersessionsPipelinegroupsCompositionGetArgs>? Composition { get; set; }
        ...
        /// </summary>
        [Input("memberStages")]
        public Input<Inputs.OpenpipelineV2UsersessionsPipelinegroupsMemberStagesGetArgs>? MemberStages { get; set; }

        public OpenpipelineV2UsersessionsPipelinegroupsState()
        {
        }
        public static new OpenpipelineV2UsersessionsPipelinegroupsState Empty => new OpenpipelineV2UsersessionsPipelinegroupsState();
    }
}
