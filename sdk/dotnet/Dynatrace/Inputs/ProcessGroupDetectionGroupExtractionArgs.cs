...
namespace Pulumiverse.PulumiPackage.Dynatrace.Inputs
{
    ...
    public sealed class ProcessGroupDetectionGroupExtractionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Optionally delimit this property between *From* and *To*.
        /// </summary>
        [Input("delimiter", required: true)]
        public Input<Inputs.ProcessGroupDetectionGroupExtractionDelimiterArgs> Delimiter { get; set; } = null!;
        ...
        public ProcessGroupDetectionGroupExtractionArgs()
        {
        }
        public static new ProcessGroupDetectionGroupExtractionArgs Empty => new ProcessGroupDetectionGroupExtractionArgs();
    }
}
