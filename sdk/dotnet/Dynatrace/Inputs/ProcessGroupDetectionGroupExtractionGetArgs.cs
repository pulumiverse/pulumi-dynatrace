...
namespace Lbrlabs.PulumiPackage.Dynatrace.Inputs
{
    ...
    public sealed class ProcessGroupDetectionGroupExtractionGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Optionally delimit this property between *From* and *To*.
        /// </summary>
        [Input("delimiter", required: true)]
        public Input<Inputs.ProcessGroupDetectionGroupExtractionDelimiterGetArgs> Delimiter { get; set; } = null!;
        ...
        /// </summary>
        [Input("standaloneRule")]
        public Input<bool>? StandaloneRule { get; set; }

        public ProcessGroupDetectionGroupExtractionGetArgs()
        {
        }
        public static new ProcessGroupDetectionGroupExtractionGetArgs Empty => new ProcessGroupDetectionGroupExtractionGetArgs();
    }
}
