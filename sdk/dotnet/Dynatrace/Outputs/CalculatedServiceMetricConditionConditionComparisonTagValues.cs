...
namespace Lbrlabs.PulumiPackage.Dynatrace.Outputs
{
    ...
    public sealed class CalculatedServiceMetricConditionConditionComparisonTagValues
    {
        ...
        [OutputConstructor]
        private CalculatedServiceMetricConditionConditionComparisonTagValues(ImmutableArray<Outputs.CalculatedServiceMetricConditionConditionComparisonTagValuesValue> values)
        {
            Values = values;
        }
    }
