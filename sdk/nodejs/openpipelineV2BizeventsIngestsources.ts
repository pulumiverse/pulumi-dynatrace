 ...
 * ```
 */
export class OpenpipelineV2BizeventsIngestsources extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OpenpipelineV2BizeventsIngestsourcesState, opts?: pulumi.CustomResourceOptions): OpenpipelineV2BizeventsIngestsources {
        return new OpenpipelineV2BizeventsIngestsources(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'dynatrace:index/openpipelineV2BizeventsIngestsources:OpenpipelineV2BizeventsIngestsources';

    /**
     * Returns true if the given object is an instance of OpenpipelineV2BizeventsIngestsources.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OpenpipelineV2BizeventsIngestsources {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OpenpipelineV2BizeventsIngestsources.__pulumiType;
    }
     ...
     */
    declare public readonly metadataList: pulumi.Output<outputs.OpenpipelineV2BizeventsIngestsourcesMetadataList | undefined>;
    /**
     * Endpoint segment
     */
     ...
     * Processing stage
     */
    declare public readonly processing: pulumi.Output<outputs.OpenpipelineV2BizeventsIngestsourcesProcessing | undefined>;
    /**
     * Source
     */
     ...
     */
    declare public readonly staticRouting: pulumi.Output<outputs.OpenpipelineV2BizeventsIngestsourcesStaticRouting | undefined>;
     ...
     */
    constructor(name: string, args: OpenpipelineV2BizeventsIngestsourcesArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OpenpipelineV2BizeventsIngestsourcesArgs | OpenpipelineV2BizeventsIngestsourcesState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OpenpipelineV2BizeventsIngestsourcesState | undefined;
            ...
            const args = argsOrState as OpenpipelineV2BizeventsIngestsourcesArgs | undefined;
        ...
        super(OpenpipelineV2BizeventsIngestsources.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface OpenpipelineV2BizeventsIngestsourcesState {
    /**
     * Default Bucket
     */
     ...
     * Ingest source metadata list
     */
    metadataList?: pulumi.Input<inputs.OpenpipelineV2BizeventsIngestsourcesMetadataList | undefined>;
    /**
     * Endpoint segment
     */
     ...
     * Processing stage
     */
    processing?: pulumi.Input<inputs.OpenpipelineV2BizeventsIngestsourcesProcessing | undefined>;
    /**
     * Source
     */
     ...
     * Static routing of endpoint
     */
    staticRouting?: pulumi.Input<inputs.OpenpipelineV2BizeventsIngestsourcesStaticRouting | undefined>;
}

/**
 * The set of arguments for constructing a OpenpipelineV2BizeventsIngestsources resource.
 */
export interface OpenpipelineV2BizeventsIngestsourcesArgs {
    /**
     * Default Bucket
     */
    defaultBucket?: pulumi.Input<string | undefined>;
