 ...
 * ```
 */
export class OpenpipelineSecurityEvents extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OpenpipelineSecurityEventsState, opts?: pulumi.CustomResourceOptions): OpenpipelineSecurityEvents {
        return new OpenpipelineSecurityEvents(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'dynatrace:index/openpipelineSecurityEvents:OpenpipelineSecurityEvents';
     ...
     */
    public static isInstance(obj: any): obj is OpenpipelineSecurityEvents {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OpenpipelineSecurityEvents.__pulumiType;
    }

    /**
     * List of all ingest sources of the configuration
     */
    declare public readonly endpoints: pulumi.Output<outputs.OpenpipelineSecurityEventsEndpoints | undefined>;
    /**
     * List of all pipelines of the configuration
     */
    declare public readonly pipelines: pulumi.Output<outputs.OpenpipelineSecurityEventsPipelines | undefined>;
    /**
     * Dynamic routing definition
     */
    declare public readonly routing: pulumi.Output<outputs.OpenpipelineSecurityEventsRouting | undefined>;
    ...
    constructor(name: string, argsOrState?: OpenpipelineSecurityEventsArgs | OpenpipelineSecurityEventsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OpenpipelineSecurityEventsState | undefined;
            resourceInputs["endpoints"] = state?.endpoints;
            resourceInputs["pipelines"] = state?.pipelines;
            resourceInputs["routing"] = state?.routing;
        } else {
            const args = argsOrState as OpenpipelineSecurityEventsArgs | undefined;
        ...
        super(OpenpipelineSecurityEvents.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface OpenpipelineSecurityEventsState {
     ...
     * List of all ingest sources of the configuration
     */
    endpoints?: pulumi.Input<inputs.OpenpipelineSecurityEventsEndpoints | undefined>;
    /**
     * List of all pipelines of the configuration
     */
    pipelines?: pulumi.Input<inputs.OpenpipelineSecurityEventsPipelines | undefined>;
    /**
     * Dynamic routing definition
     */
    routing?: pulumi.Input<inputs.OpenpipelineSecurityEventsRouting | undefined>;
}
