 ...
 * ```
 */
export class OpenpipelineV2MetricsPipelines extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OpenpipelineV2MetricsPipelinesState, opts?: pulumi.CustomResourceOptions): OpenpipelineV2MetricsPipelines {
        return new OpenpipelineV2MetricsPipelines(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'dynatrace:index/openpipelineV2MetricsPipelines:OpenpipelineV2MetricsPipelines';

    /**
     * Returns true if the given object is an instance of OpenpipelineV2MetricsPipelines.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OpenpipelineV2MetricsPipelines {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OpenpipelineV2MetricsPipelines.__pulumiType;
    }

    /**
     * Cost allocation stage
     */
    declare public readonly costAllocation: pulumi.Output<outputs.OpenpipelineV2MetricsPipelinesCostAllocation | undefined>;
    /**
     * Custom pipeline id
     */
     ...
     */
    declare public readonly dataExtraction: pulumi.Output<outputs.OpenpipelineV2MetricsPipelinesDataExtraction | undefined>;
    /**
     * Davis event extraction stage
     */
    declare public readonly davis: pulumi.Output<outputs.OpenpipelineV2MetricsPipelinesDavis | undefined>;
    /**
     * Display name
     */
     ...
     */
    declare public readonly metadataList: pulumi.Output<outputs.OpenpipelineV2MetricsPipelinesMetadataList | undefined>;
    /**
     * Metrics extraction stage
     */
    declare public readonly metricExtraction: pulumi.Output<outputs.OpenpipelineV2MetricsPipelinesMetricExtraction | undefined>;
    /**
     * Processing stage
     */
    declare public readonly processing: pulumi.Output<outputs.OpenpipelineV2MetricsPipelinesProcessing | undefined>;
    /**
     * Product allocation stage
     */
    declare public readonly productAllocation: pulumi.Output<outputs.OpenpipelineV2MetricsPipelinesProductAllocation | undefined>;
    /**
     ...
     */
    declare public readonly securityContext: pulumi.Output<outputs.OpenpipelineV2MetricsPipelinesSecurityContext | undefined>;
    /**
     * Smartscape edge extraction stage
     */
    declare public readonly smartscapeEdgeExtraction: pulumi.Output<outputs.OpenpipelineV2MetricsPipelinesSmartscapeEdgeExtraction | undefined>;
    /**
     * Smartscape node extraction stage
     */
    declare public readonly smartscapeNodeExtraction: pulumi.Output<outputs.OpenpipelineV2MetricsPipelinesSmartscapeNodeExtraction | undefined>;
    /**
     * Storage stage
     */
    declare public readonly storage: pulumi.Output<outputs.OpenpipelineV2MetricsPipelinesStorage | undefined>;
     ...
     */
    constructor(name: string, args: OpenpipelineV2MetricsPipelinesArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OpenpipelineV2MetricsPipelinesArgs | OpenpipelineV2MetricsPipelinesState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OpenpipelineV2MetricsPipelinesState | undefined;
            ...
            const args = argsOrState as OpenpipelineV2MetricsPipelinesArgs | undefined;
        ...
        super(OpenpipelineV2MetricsPipelines.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface OpenpipelineV2MetricsPipelinesState {
    /**
     * Cost allocation stage
     */
    costAllocation?: pulumi.Input<inputs.OpenpipelineV2MetricsPipelinesCostAllocation | undefined>;
    /**
     * Custom pipeline id
     */
     ...
     * Data extraction stage
     */
    dataExtraction?: pulumi.Input<inputs.OpenpipelineV2MetricsPipelinesDataExtraction | undefined>;
    /**
     * Davis event extraction stage
     */
    davis?: pulumi.Input<inputs.OpenpipelineV2MetricsPipelinesDavis | undefined>;
    /**
     * Display name
     */
     ...
     * Pipeline metadata list
     */
    metadataList?: pulumi.Input<inputs.OpenpipelineV2MetricsPipelinesMetadataList | undefined>;
    /**
     * Metrics extraction stage
     */
    metricExtraction?: pulumi.Input<inputs.OpenpipelineV2MetricsPipelinesMetricExtraction | undefined>;
    /**
     * Processing stage
     */
    processing?: pulumi.Input<inputs.OpenpipelineV2MetricsPipelinesProcessing | undefined>;
    /**
     * Product allocation stage
     */
    productAllocation?: pulumi.Input<inputs.OpenpipelineV2MetricsPipelinesProductAllocation | undefined>;
    /**
     * Routing. Possible values: `notRoutable`, `routable`
     */
     ...
     * Security context stage
     */
    securityContext?: pulumi.Input<inputs.OpenpipelineV2MetricsPipelinesSecurityContext | undefined>;
    /**
     * Smartscape edge extraction stage
     */
    smartscapeEdgeExtraction?: pulumi.Input<inputs.OpenpipelineV2MetricsPipelinesSmartscapeEdgeExtraction | undefined>;
    /**
     * Smartscape node extraction stage
     */
    smartscapeNodeExtraction?: pulumi.Input<inputs.OpenpipelineV2MetricsPipelinesSmartscapeNodeExtraction | undefined>;
    /**
     * Storage stage
     */
    storage?: pulumi.Input<inputs.OpenpipelineV2MetricsPipelinesStorage | undefined>;
}

/**
 * The set of arguments for constructing a OpenpipelineV2MetricsPipelines resource.
 */
export interface OpenpipelineV2MetricsPipelinesArgs {
    /**
     * Cost allocation stage
     */
    costAllocation?: pulumi.Input<inputs.OpenpipelineV2MetricsPipelinesCostAllocation | undefined>;
