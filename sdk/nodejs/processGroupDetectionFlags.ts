 ...
 *
 * - `terraform-provider-dynatrace -export dynatrace.ProcessGroupDetectionFlags` downloads all existing built-in process group detection rules
 *
...
export class ProcessGroupDetectionFlags extends pulumi.CustomResource {
     ...
     */
    declare public readonly addNodeJsScriptName: pulumi.Output<boolean>;
    /**
     * Enabling this flag will detect separate Cassandra process groups based on the configured Cassandra cluster name.
     */
    declare public readonly autoDetectCassandraClusters: pulumi.Output<boolean>;
    /**
     * Enabling this flag will detect Spring Boot process groups based on command line and applications' configuration files.
     */
    declare public readonly autoDetectSpringBoot: pulumi.Output<boolean>;
    /**
     * Enabling this flag will detect separate TIBCO BusinessWorks process groups per engine property file.
     */
    declare public readonly autoDetectTibcoContainerEditionEngines: pulumi.Output<boolean>;
    /**
     * Enabling this flag will detect separate TIBCO BusinessWorks process groups per engine property file.
     */
    declare public readonly autoDetectTibcoEngines: pulumi.Output<boolean>;
    /**
     ...
     */
    declare public readonly autoDetectWebMethodsIntegrationServer: pulumi.Output<boolean>;
    /**
     * Enabling this flag will detect separate WebSphere Liberty process groups based on java command line.
     */
    declare public readonly autoDetectWebSphereLibertyApplication: pulumi.Output<boolean>;
    /**
     ...
     */
    declare public readonly groupIbmmqbyInstanceName: pulumi.Output<boolean>;
    /**
     * Enabling this flag will detect the JBoss server name from the system property jboss.server.name=\n\n, only if -D[Server:\n\n] is not set.
     */
    declare public readonly identifyJbossServerBySystemProperty: pulumi.Output<boolean>;
    /**
     ...
     */
    declare public readonly ignoreUniqueIdentifiers: pulumi.Output<boolean>;
    /**
     ...
     */
    declare public readonly securitySoftwareDetectionEnabled: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    declare public readonly shortLivedProcessesMonitoring: pulumi.Output<boolean>;
    /**
     ...
     */
    declare public readonly splitDb2GroupingByInstances: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    declare public readonly splitOracleDatabasePg: pulumi.Output<boolean>;
    /**
     ...
     */
    declare public readonly splitOracleListenerPg: pulumi.Output<boolean>;
    /**
     ...
     */
    declare public readonly useCatalinaBase: pulumi.Output<boolean>;
    /**
     ...
     */
    declare public readonly useDockerContainerName: pulumi.Output<boolean>;
    ...
    constructor(name: string, argsOrState?: ProcessGroupDetectionFlagsArgs | ProcessGroupDetectionFlagsState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["addNodeJsScriptName"] = state?.addNodeJsScriptName;
            resourceInputs["autoDetectCassandraClusters"] = state?.autoDetectCassandraClusters;
            resourceInputs["autoDetectSpringBoot"] = state?.autoDetectSpringBoot;
            resourceInputs["autoDetectTibcoContainerEditionEngines"] = state?.autoDetectTibcoContainerEditionEngines;
            resourceInputs["autoDetectTibcoEngines"] = state?.autoDetectTibcoEngines;
            resourceInputs["autoDetectWebMethodsIntegrationServer"] = state?.autoDetectWebMethodsIntegrationServer;
            resourceInputs["autoDetectWebSphereLibertyApplication"] = state?.autoDetectWebSphereLibertyApplication;
            resourceInputs["groupIbmmqbyInstanceName"] = state?.groupIbmmqbyInstanceName;
            resourceInputs["identifyJbossServerBySystemProperty"] = state?.identifyJbossServerBySystemProperty;
            resourceInputs["ignoreUniqueIdentifiers"] = state?.ignoreUniqueIdentifiers;
            resourceInputs["scope"] = state?.scope;
            resourceInputs["securitySoftwareDetectionEnabled"] = state?.securitySoftwareDetectionEnabled;
            resourceInputs["shortLivedProcessesMonitoring"] = state?.shortLivedProcessesMonitoring;
            resourceInputs["splitDb2GroupingByInstances"] = state?.splitDb2GroupingByInstances;
            resourceInputs["splitOracleDatabasePg"] = state?.splitOracleDatabasePg;
            resourceInputs["splitOracleListenerPg"] = state?.splitOracleListenerPg;
            resourceInputs["useCatalinaBase"] = state?.useCatalinaBase;
            resourceInputs["useDockerContainerName"] = state?.useDockerContainerName;
        } else {
            const args = argsOrState as ProcessGroupDetectionFlagsArgs | undefined;
            if (args?.addNodeJsScriptName === undefined && !opts.urn) {
                throw new Error("Missing required property 'addNodeJsScriptName'");
            }
            if (args?.autoDetectCassandraClusters === undefined && !opts.urn) {
                throw new Error("Missing required property 'autoDetectCassandraClusters'");
            }
            if (args?.autoDetectSpringBoot === undefined && !opts.urn) {
                throw new Error("Missing required property 'autoDetectSpringBoot'");
            }
            if (args?.autoDetectTibcoContainerEditionEngines === undefined && !opts.urn) {
                throw new Error("Missing required property 'autoDetectTibcoContainerEditionEngines'");
            }
            if (args?.autoDetectTibcoEngines === undefined && !opts.urn) {
                throw new Error("Missing required property 'autoDetectTibcoEngines'");
            }
            if (args?.autoDetectWebMethodsIntegrationServer === undefined && !opts.urn) {
                throw new Error("Missing required property 'autoDetectWebMethodsIntegrationServer'");
            }
            if (args?.autoDetectWebSphereLibertyApplication === undefined && !opts.urn) {
                throw new Error("Missing required property 'autoDetectWebSphereLibertyApplication'");
            }
            if (args?.groupIbmmqbyInstanceName === undefined && !opts.urn) {
                throw new Error("Missing required property 'groupIbmmqbyInstanceName'");
            }
            if (args?.identifyJbossServerBySystemProperty === undefined && !opts.urn) {
                throw new Error("Missing required property 'identifyJbossServerBySystemProperty'");
            }
            if (args?.ignoreUniqueIdentifiers === undefined && !opts.urn) {
                throw new Error("Missing required property 'ignoreUniqueIdentifiers'");
            }
            if (args?.shortLivedProcessesMonitoring === undefined && !opts.urn) {
                throw new Error("Missing required property 'shortLivedProcessesMonitoring'");
            }
            if (args?.splitOracleDatabasePg === undefined && !opts.urn) {
                throw new Error("Missing required property 'splitOracleDatabasePg'");
            }
            if (args?.splitOracleListenerPg === undefined && !opts.urn) {
                throw new Error("Missing required property 'splitOracleListenerPg'");
            }
            if (args?.useCatalinaBase === undefined && !opts.urn) {
                throw new Error("Missing required property 'useCatalinaBase'");
            }
            if (args?.useDockerContainerName === undefined && !opts.urn) {
                throw new Error("Missing required property 'useDockerContainerName'");
            }
            resourceInputs["addNodeJsScriptName"] = args?.addNodeJsScriptName;
            resourceInputs["autoDetectCassandraClusters"] = args?.autoDetectCassandraClusters;
            resourceInputs["autoDetectSpringBoot"] = args?.autoDetectSpringBoot;
            resourceInputs["autoDetectTibcoContainerEditionEngines"] = args?.autoDetectTibcoContainerEditionEngines;
            resourceInputs["autoDetectTibcoEngines"] = args?.autoDetectTibcoEngines;
            resourceInputs["autoDetectWebMethodsIntegrationServer"] = args?.autoDetectWebMethodsIntegrationServer;
            resourceInputs["autoDetectWebSphereLibertyApplication"] = args?.autoDetectWebSphereLibertyApplication;
            resourceInputs["groupIbmmqbyInstanceName"] = args?.groupIbmmqbyInstanceName;
            resourceInputs["identifyJbossServerBySystemProperty"] = args?.identifyJbossServerBySystemProperty;
            resourceInputs["ignoreUniqueIdentifiers"] = args?.ignoreUniqueIdentifiers;
            resourceInputs["scope"] = args?.scope;
            resourceInputs["securitySoftwareDetectionEnabled"] = args?.securitySoftwareDetectionEnabled;
            resourceInputs["shortLivedProcessesMonitoring"] = args?.shortLivedProcessesMonitoring;
            resourceInputs["splitDb2GroupingByInstances"] = args?.splitDb2GroupingByInstances;
            resourceInputs["splitOracleDatabasePg"] = args?.splitOracleDatabasePg;
            resourceInputs["splitOracleListenerPg"] = args?.splitOracleListenerPg;
            resourceInputs["useCatalinaBase"] = args?.useCatalinaBase;
            resourceInputs["useDockerContainerName"] = args?.useDockerContainerName;
        }
