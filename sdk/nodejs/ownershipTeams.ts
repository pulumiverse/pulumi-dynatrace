 ...
 *
 * - `terraform-provider-dynatrace -export dynatrace.OwnershipTeams` downloads all existing ownership team configuration
 *
...
export class OwnershipTeams extends pulumi.CustomResource {
     ...
     */
    declare public readonly additionalInformation: pulumi.Output<outputs.OwnershipTeamsAdditionalInformation | undefined>;
    /**
     * Define options for messaging integration or other means of contacting this team.
     */
    declare public readonly contactDetails: pulumi.Output<outputs.OwnershipTeamsContactDetails | undefined>;
    /**
     * Description
     */
     ...
     */
    declare public readonly links: pulumi.Output<outputs.OwnershipTeamsLinks | undefined>;
    /**
     * Team name
     */
     ...
     */
    declare public readonly responsibilities: pulumi.Output<outputs.OwnershipTeamsResponsibilities>;
    /**
     ...
     */
    declare public readonly supplementaryIdentifiers: pulumi.Output<outputs.OwnershipTeamsSupplementaryIdentifiers | undefined>;
    ...
    constructor(name: string, argsOrState?: OwnershipTeamsArgs | OwnershipTeamsState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["responsibilities"] = state?.responsibilities;
            resourceInputs["supplementaryIdentifiers"] = state?.supplementaryIdentifiers;
        } else {
            const args = argsOrState as OwnershipTeamsArgs | undefined;
            if (args?.identifier === undefined && !opts.urn) {
                throw new Error("Missing required property 'identifier'");
            }
            if (args?.responsibilities === undefined && !opts.urn) {
            ...
            resourceInputs["responsibilities"] = args?.responsibilities;
            resourceInputs["supplementaryIdentifiers"] = args?.supplementaryIdentifiers;
        }
