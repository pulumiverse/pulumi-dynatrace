 ...
 *
 * - `terraform-provider-dynatrace -export dynatrace.ServiceNaming` downloads all existing service naming configuration
 *
...
export interface ServiceNamingState {
     ...
     * A list of matching conditions of the rule.  The rule applies only if **all** conditions are fulfilled
     */
    conditions?: pulumi.Input<pulumi.Input<inputs.ServiceNamingCondition>[] | undefined>;
    /**
     * The rule is enabled (`true`) or disabled (`false`)
     */
