 ...
 * ```
 */
export class OpenpipelineV2UserEventsIngestsources extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OpenpipelineV2UserEventsIngestsourcesState, opts?: pulumi.CustomResourceOptions): OpenpipelineV2UserEventsIngestsources {
        return new OpenpipelineV2UserEventsIngestsources(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'dynatrace:index/openpipelineV2UserEventsIngestsources:OpenpipelineV2UserEventsIngestsources';

    /**
     * Returns true if the given object is an instance of OpenpipelineV2UserEventsIngestsources.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OpenpipelineV2UserEventsIngestsources {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OpenpipelineV2UserEventsIngestsources.__pulumiType;
    }
     ...
     */
    declare public readonly metadataList: pulumi.Output<outputs.OpenpipelineV2UserEventsIngestsourcesMetadataList | undefined>;
    /**
     * Endpoint segment
     */
     ...
     * Processing stage
     */
    declare public readonly processing: pulumi.Output<outputs.OpenpipelineV2UserEventsIngestsourcesProcessing | undefined>;
    /**
     * Source
     */
     ...
     */
    declare public readonly staticRouting: pulumi.Output<outputs.OpenpipelineV2UserEventsIngestsourcesStaticRouting | undefined>;
     ...
     */
    constructor(name: string, args: OpenpipelineV2UserEventsIngestsourcesArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OpenpipelineV2UserEventsIngestsourcesArgs | OpenpipelineV2UserEventsIngestsourcesState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OpenpipelineV2UserEventsIngestsourcesState | undefined;
            ...
            const args = argsOrState as OpenpipelineV2UserEventsIngestsourcesArgs | undefined;
        ...
        super(OpenpipelineV2UserEventsIngestsources.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface OpenpipelineV2UserEventsIngestsourcesState {
    /**
     * Default Bucket
     */
     ...
     * Ingest source metadata list
     */
    metadataList?: pulumi.Input<inputs.OpenpipelineV2UserEventsIngestsourcesMetadataList | undefined>;
    /**
     * Endpoint segment
     */
     ...
     * Processing stage
     */
    processing?: pulumi.Input<inputs.OpenpipelineV2UserEventsIngestsourcesProcessing | undefined>;
    /**
     * Source
     */
     ...
     * Static routing of endpoint
     */
    staticRouting?: pulumi.Input<inputs.OpenpipelineV2UserEventsIngestsourcesStaticRouting | undefined>;
}

/**
 * The set of arguments for constructing a OpenpipelineV2UserEventsIngestsources resource.
 */
export interface OpenpipelineV2UserEventsIngestsourcesArgs {
    /**
     * Default Bucket
     */
    defaultBucket?: pulumi.Input<string | undefined>;
