 ...
 * ```
 */
export class OpenpipelineV2MetricsIngestsources extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OpenpipelineV2MetricsIngestsourcesState, opts?: pulumi.CustomResourceOptions): OpenpipelineV2MetricsIngestsources {
        return new OpenpipelineV2MetricsIngestsources(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'dynatrace:index/openpipelineV2MetricsIngestsources:OpenpipelineV2MetricsIngestsources';

    /**
     * Returns true if the given object is an instance of OpenpipelineV2MetricsIngestsources.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OpenpipelineV2MetricsIngestsources {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OpenpipelineV2MetricsIngestsources.__pulumiType;
    }
     ...
     */
    declare public readonly metadataList: pulumi.Output<outputs.OpenpipelineV2MetricsIngestsourcesMetadataList | undefined>;
    /**
     * Endpoint segment
     */
     ...
     * Processing stage
     */
    declare public readonly processing: pulumi.Output<outputs.OpenpipelineV2MetricsIngestsourcesProcessing | undefined>;
    /**
     * Source
     */
     ...
     */
    declare public readonly staticRouting: pulumi.Output<outputs.OpenpipelineV2MetricsIngestsourcesStaticRouting | undefined>;
     ...
     */
    constructor(name: string, args: OpenpipelineV2MetricsIngestsourcesArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OpenpipelineV2MetricsIngestsourcesArgs | OpenpipelineV2MetricsIngestsourcesState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OpenpipelineV2MetricsIngestsourcesState | undefined;
            ...
            const args = argsOrState as OpenpipelineV2MetricsIngestsourcesArgs | undefined;
        ...
        super(OpenpipelineV2MetricsIngestsources.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface OpenpipelineV2MetricsIngestsourcesState {
    /**
     * Default Bucket
     */
     ...
     * Ingest source metadata list
     */
    metadataList?: pulumi.Input<inputs.OpenpipelineV2MetricsIngestsourcesMetadataList | undefined>;
    /**
     * Endpoint segment
     */
     ...
     * Processing stage
     */
    processing?: pulumi.Input<inputs.OpenpipelineV2MetricsIngestsourcesProcessing | undefined>;
    /**
     * Source
     */
     ...
     * Static routing of endpoint
     */
    staticRouting?: pulumi.Input<inputs.OpenpipelineV2MetricsIngestsourcesStaticRouting | undefined>;
}

/**
 * The set of arguments for constructing a OpenpipelineV2MetricsIngestsources resource.
 */
export interface OpenpipelineV2MetricsIngestsourcesArgs {
    /**
     * Default Bucket
     */
    defaultBucket?: pulumi.Input<string | undefined>;
