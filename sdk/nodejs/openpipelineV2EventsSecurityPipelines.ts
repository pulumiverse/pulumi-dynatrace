 ...
 * ```
 */
export class OpenpipelineV2EventsSecurityPipelines extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OpenpipelineV2EventsSecurityPipelinesState, opts?: pulumi.CustomResourceOptions): OpenpipelineV2EventsSecurityPipelines {
        return new OpenpipelineV2EventsSecurityPipelines(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'dynatrace:index/openpipelineV2EventsSecurityPipelines:OpenpipelineV2EventsSecurityPipelines';

    /**
     * Returns true if the given object is an instance of OpenpipelineV2EventsSecurityPipelines.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OpenpipelineV2EventsSecurityPipelines {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OpenpipelineV2EventsSecurityPipelines.__pulumiType;
    }

    /**
     * Cost allocation stage
     */
    declare public readonly costAllocation: pulumi.Output<outputs.OpenpipelineV2EventsSecurityPipelinesCostAllocation | undefined>;
    /**
     * Custom pipeline id
     */
     ...
     */
    declare public readonly dataExtraction: pulumi.Output<outputs.OpenpipelineV2EventsSecurityPipelinesDataExtraction | undefined>;
    /**
     * Davis event extraction stage
     */
    declare public readonly davis: pulumi.Output<outputs.OpenpipelineV2EventsSecurityPipelinesDavis | undefined>;
    /**
     * Display name
     */
     ...
     */
    declare public readonly metadataList: pulumi.Output<outputs.OpenpipelineV2EventsSecurityPipelinesMetadataList | undefined>;
    /**
     * Metrics extraction stage
     */
    declare public readonly metricExtraction: pulumi.Output<outputs.OpenpipelineV2EventsSecurityPipelinesMetricExtraction | undefined>;
    /**
     * Processing stage
     */
    declare public readonly processing: pulumi.Output<outputs.OpenpipelineV2EventsSecurityPipelinesProcessing | undefined>;
    /**
     * Product allocation stage
     */
    declare public readonly productAllocation: pulumi.Output<outputs.OpenpipelineV2EventsSecurityPipelinesProductAllocation | undefined>;
    /**
     ...
     */
    declare public readonly securityContext: pulumi.Output<outputs.OpenpipelineV2EventsSecurityPipelinesSecurityContext | undefined>;
    /**
     * Smartscape edge extraction stage
     */
    declare public readonly smartscapeEdgeExtraction: pulumi.Output<outputs.OpenpipelineV2EventsSecurityPipelinesSmartscapeEdgeExtraction | undefined>;
    /**
     * Smartscape node extraction stage
     */
    declare public readonly smartscapeNodeExtraction: pulumi.Output<outputs.OpenpipelineV2EventsSecurityPipelinesSmartscapeNodeExtraction | undefined>;
    /**
     * Storage stage
     */
    declare public readonly storage: pulumi.Output<outputs.OpenpipelineV2EventsSecurityPipelinesStorage | undefined>;
     ...
     */
    constructor(name: string, args: OpenpipelineV2EventsSecurityPipelinesArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OpenpipelineV2EventsSecurityPipelinesArgs | OpenpipelineV2EventsSecurityPipelinesState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OpenpipelineV2EventsSecurityPipelinesState | undefined;
            ...
            const args = argsOrState as OpenpipelineV2EventsSecurityPipelinesArgs | undefined;
        ...
        super(OpenpipelineV2EventsSecurityPipelines.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface OpenpipelineV2EventsSecurityPipelinesState {
    /**
     * Cost allocation stage
     */
    costAllocation?: pulumi.Input<inputs.OpenpipelineV2EventsSecurityPipelinesCostAllocation | undefined>;
    /**
     * Custom pipeline id
     */
     ...
     * Data extraction stage
     */
    dataExtraction?: pulumi.Input<inputs.OpenpipelineV2EventsSecurityPipelinesDataExtraction | undefined>;
    /**
     * Davis event extraction stage
     */
    davis?: pulumi.Input<inputs.OpenpipelineV2EventsSecurityPipelinesDavis | undefined>;
    /**
     * Display name
     */
     ...
     * Pipeline metadata list
     */
    metadataList?: pulumi.Input<inputs.OpenpipelineV2EventsSecurityPipelinesMetadataList | undefined>;
    /**
     * Metrics extraction stage
     */
    metricExtraction?: pulumi.Input<inputs.OpenpipelineV2EventsSecurityPipelinesMetricExtraction | undefined>;
    /**
     * Processing stage
     */
    processing?: pulumi.Input<inputs.OpenpipelineV2EventsSecurityPipelinesProcessing | undefined>;
    /**
     * Product allocation stage
     */
    productAllocation?: pulumi.Input<inputs.OpenpipelineV2EventsSecurityPipelinesProductAllocation | undefined>;
    /**
     * Routing. Possible values: `notRoutable`, `routable`
     */
     ...
     * Security context stage
     */
    securityContext?: pulumi.Input<inputs.OpenpipelineV2EventsSecurityPipelinesSecurityContext | undefined>;
    /**
     * Smartscape edge extraction stage
     */
    smartscapeEdgeExtraction?: pulumi.Input<inputs.OpenpipelineV2EventsSecurityPipelinesSmartscapeEdgeExtraction | undefined>;
    /**
     * Smartscape node extraction stage
     */
    smartscapeNodeExtraction?: pulumi.Input<inputs.OpenpipelineV2EventsSecurityPipelinesSmartscapeNodeExtraction | undefined>;
    /**
     * Storage stage
     */
    storage?: pulumi.Input<inputs.OpenpipelineV2EventsSecurityPipelinesStorage | undefined>;
}

/**
 * The set of arguments for constructing a OpenpipelineV2EventsSecurityPipelines resource.
 */
export interface OpenpipelineV2EventsSecurityPipelinesArgs {
    /**
     * Cost allocation stage
     */
    costAllocation?: pulumi.Input<inputs.OpenpipelineV2EventsSecurityPipelinesCostAllocation | undefined>;
