 ...
 *
 * - `terraform-provider-dynatrace -export dynatrace.ProcessVisibility` downloads all existing process instance snapshots configuration
 *
...
export interface ProcessVisibilityState {
     ...
     * The maximum amount of processes that host may report is **100**
     */
    maxProcesses?: pulumi.Input<number | undefined>;
    /**
     * The scope of this setting (HOST, HOST_GROUP). Omit this property if you want to cover the whole environment.
     */
