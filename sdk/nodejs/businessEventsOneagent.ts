 ...
 *
 * - `terraform-provider-dynatrace -export dynatrace.BusinessEventsOneagent` downloads all existing OneAgent business events based on incoming HTTP requests
 *
...
export class BusinessEventsOneagent extends pulumi.CustomResource {
     ...
     * Event meta data
     */
    declare public readonly event: pulumi.Output<outputs.BusinessEventsOneagentEvent>;
    /**
     ...
     */
    declare public readonly triggers: pulumi.Output<outputs.BusinessEventsOneagentTriggers>;
    ...
    constructor(name: string, argsOrState?: BusinessEventsOneagentArgs | BusinessEventsOneagentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(BusinessEventsOneagent.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface BusinessEventsOneagentState {
     ...
     * Event meta data
     */
    event?: pulumi.Input<inputs.BusinessEventsOneagentEvent | undefined>;
    /**
     * Because this resource allows for ordering you may specify the ID of the resource instance that comes before this instance regarding order. If not specified when creating the setting will be added to the end of the list. If not specified during update the order will remain untouched
     */
     ...
     * Define conditions to trigger business events from incoming web requests. Triggers are connected by AND logic per capture rule. If you set multiple trigger rules, all of them need to be fulfilled to capture a business event.
     */
    triggers?: pulumi.Input<inputs.BusinessEventsOneagentTriggers | undefined>;
}
