 ...
 *
 * - `terraform-provider-dynatrace -export dynatrace.SpanEntryPoint` downloads all existing span entry point configuration
 *
...
export class SpanEntryPoint extends pulumi.CustomResource {
     ...
     */
    declare public readonly matches: pulumi.Output<outputs.SpanEntryPointMatches>;
    /**
...
export interface SpanEntryPointState {
     ...
     * Matching strategies for the Span
     */
    matches?: pulumi.Input<inputs.SpanEntryPointMatches | undefined>;
    /**
     * The name of the rule
     */
