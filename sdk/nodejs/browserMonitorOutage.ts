 ...
 *
 * - `terraform-provider-dynatrace -export dynatrace.BrowserMonitorOutage` downloads all existing browser monitor outage handling configuration
 *
...
export class BrowserMonitorOutage extends pulumi.CustomResource {
     ...
     */
    declare public readonly retryOnError: pulumi.Output<boolean>;
    /**
    ...
    constructor(name: string, argsOrState?: BrowserMonitorOutageArgs | BrowserMonitorOutageState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["retryOnError"] = state?.retryOnError;
            ...
            if (args?.retryOnError === undefined && !opts.urn) {
            ...
            resourceInputs["retryOnError"] = args?.retryOnError;
