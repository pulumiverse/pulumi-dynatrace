...
export class ServiceDetectionRules extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServiceDetectionRulesState, opts?: pulumi.CustomResourceOptions): ServiceDetectionRules {
        return new ServiceDetectionRules(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'dynatrace:index/serviceDetectionRules:ServiceDetectionRules';

    /**
     * Returns true if the given object is an instance of ServiceDetectionRules.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ServiceDetectionRules {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ServiceDetectionRules.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ServiceDetectionRulesArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ServiceDetectionRulesArgs | ServiceDetectionRulesState, opts?: pulumi.CustomResourceOptions) {
 ...
 */
export interface ServiceDetectionRulesState {
    /**
     * This setting is enabled (`true`) or disabled (`false`)
     */
     ...
     * Rule
     */
    rule?: pulumi.Input<inputs.ServiceDetectionRulesRule | undefined>;
    /**
     * The scope of this setting (CLOUD*APPLICATION*NAMESPACE, KUBERNETES*CLUSTER, HOST*GROUP). Omit this property if you want to cover the whole environment.
     */
 ...
 */
export interface ServiceDetectionRulesArgs {
    /**
     * This setting is enabled (`true`) or disabled (`false`)
     */
     ...
     * Rule
     */
    rule: pulumi.Input<inputs.ServiceDetectionRulesRule>;
    /**
     * The scope of this setting (CLOUD*APPLICATION*NAMESPACE, KUBERNETES*CLUSTER, HOST*GROUP). Omit this property if you want to cover the whole environment.
     */
    scope?: pulumi.Input<string | undefined>;
