 ...
 * ```
 */
export class OpenpipelineV2EventsSdlcIngestsources extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OpenpipelineV2EventsSdlcIngestsourcesState, opts?: pulumi.CustomResourceOptions): OpenpipelineV2EventsSdlcIngestsources {
        return new OpenpipelineV2EventsSdlcIngestsources(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'dynatrace:index/openpipelineV2EventsSdlcIngestsources:OpenpipelineV2EventsSdlcIngestsources';

    /**
     * Returns true if the given object is an instance of OpenpipelineV2EventsSdlcIngestsources.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OpenpipelineV2EventsSdlcIngestsources {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OpenpipelineV2EventsSdlcIngestsources.__pulumiType;
    }
     ...
     */
    declare public readonly metadataList: pulumi.Output<outputs.OpenpipelineV2EventsSdlcIngestsourcesMetadataList | undefined>;
    /**
     * Endpoint segment
     */
     ...
     * Processing stage
     */
    declare public readonly processing: pulumi.Output<outputs.OpenpipelineV2EventsSdlcIngestsourcesProcessing | undefined>;
    /**
     * Source
     */
     ...
     */
    declare public readonly staticRouting: pulumi.Output<outputs.OpenpipelineV2EventsSdlcIngestsourcesStaticRouting | undefined>;

    /**
     * Create a OpenpipelineV2EventsSdlcIngestsources resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: OpenpipelineV2EventsSdlcIngestsourcesArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OpenpipelineV2EventsSdlcIngestsourcesArgs | OpenpipelineV2EventsSdlcIngestsourcesState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OpenpipelineV2EventsSdlcIngestsourcesState | undefined;
            ...
            const args = argsOrState as OpenpipelineV2EventsSdlcIngestsourcesArgs | undefined;
        ...
        super(OpenpipelineV2EventsSdlcIngestsources.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface OpenpipelineV2EventsSdlcIngestsourcesState {
    /**
     * Default Bucket
     */
     ...
     * Ingest source metadata list
     */
    metadataList?: pulumi.Input<inputs.OpenpipelineV2EventsSdlcIngestsourcesMetadataList | undefined>;
    /**
     * Endpoint segment
     */
     ...
     * Processing stage
     */
    processing?: pulumi.Input<inputs.OpenpipelineV2EventsSdlcIngestsourcesProcessing | undefined>;
    /**
     * Source
     */
     ...
     * Static routing of endpoint
     */
    staticRouting?: pulumi.Input<inputs.OpenpipelineV2EventsSdlcIngestsourcesStaticRouting | undefined>;
}

/**
 * The set of arguments for constructing a OpenpipelineV2EventsSdlcIngestsources resource.
 */
export interface OpenpipelineV2EventsSdlcIngestsourcesArgs {
    /**
     * Default Bucket
     */
    defaultBucket?: pulumi.Input<string | undefined>;
