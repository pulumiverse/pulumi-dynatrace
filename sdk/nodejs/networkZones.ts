 ...
 *
 * - `terraform-provider-dynatrace -export dynatrace.NetworkZones` downloads all existing network zone configuration
 *
...
export class NetworkZones extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: NetworkZonesArgs | NetworkZonesState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NetworkZones.__pulumiType, name, resourceInputs, opts);
    }
}
