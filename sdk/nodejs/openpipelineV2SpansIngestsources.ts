 ...
 * ```
 */
export class OpenpipelineV2SpansIngestsources extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OpenpipelineV2SpansIngestsourcesState, opts?: pulumi.CustomResourceOptions): OpenpipelineV2SpansIngestsources {
        return new OpenpipelineV2SpansIngestsources(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'dynatrace:index/openpipelineV2SpansIngestsources:OpenpipelineV2SpansIngestsources';

    /**
     * Returns true if the given object is an instance of OpenpipelineV2SpansIngestsources.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OpenpipelineV2SpansIngestsources {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OpenpipelineV2SpansIngestsources.__pulumiType;
    }
     ...
     */
    declare public readonly metadataList: pulumi.Output<outputs.OpenpipelineV2SpansIngestsourcesMetadataList | undefined>;
    /**
     * Endpoint segment
     */
     ...
     * Processing stage
     */
    declare public readonly processing: pulumi.Output<outputs.OpenpipelineV2SpansIngestsourcesProcessing | undefined>;
    /**
     * Source
     */
     ...
     */
    declare public readonly staticRouting: pulumi.Output<outputs.OpenpipelineV2SpansIngestsourcesStaticRouting | undefined>;
     ...
     */
    constructor(name: string, args: OpenpipelineV2SpansIngestsourcesArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OpenpipelineV2SpansIngestsourcesArgs | OpenpipelineV2SpansIngestsourcesState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OpenpipelineV2SpansIngestsourcesState | undefined;
            ...
            const args = argsOrState as OpenpipelineV2SpansIngestsourcesArgs | undefined;
        ...
        super(OpenpipelineV2SpansIngestsources.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface OpenpipelineV2SpansIngestsourcesState {
    /**
     * Default Bucket
     */
 ...
 */
export interface OpenpipelineV2SpansIngestsourcesArgs {
    /**
     * Default Bucket
     */
    defaultBucket?: pulumi.Input<string>;
