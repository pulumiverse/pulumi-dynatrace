 ...
 *
 * - `terraform-provider-dynatrace -export dynatrace.SpanEvents` downloads all existing span event configuration
 *
...
export class SpanEvents extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: SpanEventsArgs | SpanEventsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SpanEvents.__pulumiType, name, resourceInputs, opts);
    }
}
