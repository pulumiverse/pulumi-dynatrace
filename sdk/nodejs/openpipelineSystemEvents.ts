...
export class OpenpipelineSystemEvents extends pulumi.CustomResource {
     ...
     */
    public readonly endpoints!: pulumi.Output<outputs.OpenpipelineSystemEventsEndpoints | undefined>;
    /**
     * List of all pipelines of the configuration
     */
    public readonly pipelines!: pulumi.Output<outputs.OpenpipelineSystemEventsPipelines | undefined>;
    /**
     * Dynamic routing definition
     */
    public readonly routing!: pulumi.Output<outputs.OpenpipelineSystemEventsRouting | undefined>;
