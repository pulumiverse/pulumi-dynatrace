...
class K8sNodeAnomalies(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 cpu_requests_saturation: Optional[pulumi.Input[pulumi.InputType['K8sNodeAnomaliesCpuRequestsSaturationArgs']]] = None,
                 memory_requests_saturation: Optional[pulumi.Input[pulumi.InputType['K8sNodeAnomaliesMemoryRequestsSaturationArgs']]] = None,
                 node_problematic_condition: Optional[pulumi.Input[pulumi.InputType['K8sNodeAnomaliesNodeProblematicConditionArgs']]] = None,
                 pods_saturation: Optional[pulumi.Input[pulumi.InputType['K8sNodeAnomaliesPodsSaturationArgs']]] = None,
                 readiness_issues: Optional[pulumi.Input[pulumi.InputType['K8sNodeAnomaliesReadinessIssuesArgs']]] = None,
                 scope: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[pulumi.InputType['K8sNodeAnomaliesCpuRequestsSaturationArgs']] cpu_requests_saturation: no documentation available
        :param pulumi.Input[pulumi.InputType['K8sNodeAnomaliesMemoryRequestsSaturationArgs']] memory_requests_saturation: no documentation available
        :param pulumi.Input[pulumi.InputType['K8sNodeAnomaliesNodeProblematicConditionArgs']] node_problematic_condition: no documentation available
        :param pulumi.Input[pulumi.InputType['K8sNodeAnomaliesPodsSaturationArgs']] pods_saturation: no documentation available
        :param pulumi.Input[pulumi.InputType['K8sNodeAnomaliesReadinessIssuesArgs']] readiness_issues: Alerts if node has not been available for a given amount of time
        :param pulumi.Input[str] scope: The scope of this setting (KUBERNETES_CLUSTER). Omit this property if you want to cover the whole environment.
        """
        ...
    @overload
