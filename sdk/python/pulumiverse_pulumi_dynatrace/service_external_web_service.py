...
class ServiceExternalWebServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ServiceExternalWebServiceIdContributorsArgs'] id_contributors: Contributors to the Service Identifier calculation. URL path is always applied as an Id Contributor. It is possible to exclude Port from contributing by toggling the switch off.
        :param pulumi.Input['ServiceExternalWebServiceConditionsArgs'] conditions: A list of conditions necessary for the rule to take effect. If multiple conditions are specified, they **all** must match a Request for the rule to apply. Conditions evaluate against attributes, but do not modify them.
...
class ServiceExternalWebService(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[pulumi.InputType['ServiceExternalWebServiceConditionsArgs']] conditions: A list of conditions necessary for the rule to take effect. If multiple conditions are specified, they **all** must match a Request for the rule to apply. Conditions evaluate against attributes, but do not modify them.
        :param pulumi.Input[str] description: Description
        :param pulumi.Input[bool] enabled: This setting is enabled (`true`) or disabled (`false`)
        :param pulumi.Input[pulumi.InputType['ServiceExternalWebServiceIdContributorsArgs']] id_contributors: Contributors to the Service Identifier calculation. URL path is always applied as an Id Contributor. It is possible to exclude Port from contributing by toggling the switch off.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] management_zones: Define a management zone filter for this service detection rule.
        :param pulumi.Input[str] name: Rule name
        """
        ...
