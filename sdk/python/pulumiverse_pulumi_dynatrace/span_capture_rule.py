...
class SpanCaptureRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 action: Optional[pulumi.Input[str]] = None,
                 matches: Optional[pulumi.Input[pulumi.InputType['SpanCaptureRuleMatchesArgs']]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] action: Whether to create an entry point or not
        :param pulumi.Input[pulumi.InputType['SpanCaptureRuleMatchesArgs']] matches: Matching strategies for the Span
        :param pulumi.Input[str] name: The name of the rule
        """
        ...
    @overload
