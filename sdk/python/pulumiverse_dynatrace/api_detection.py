...
class ApiDetectionArgs:
    def __init__(__self__, *,
                 api_color: pulumi.Input[builtins.str],
                 api_name: pulumi.Input[builtins.str],
                 third_party_api: pulumi.Input[builtins.bool],
        ...
        :param pulumi.Input[builtins.str] api_color: This color will be used to highlight APIs when viewing code level data, such as distributed traces or method hotspots.
        :param pulumi.Input[builtins.str] api_name: API name
        :param pulumi.Input[builtins.bool] third_party_api: This API defines a third party library
        ...
        :param pulumi.Input[builtins.str] technology: Restrict this rule to a specific technology.
        """
    ...
    def api_color(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @api_color.setter
    def api_color(self, value: pulumi.Input[builtins.str]):
    ...
    def third_party_api(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def third_party_api(self, value: pulumi.Input[builtins.bool]):
...
class _ApiDetectionState:
    def __init__(__self__, *,
                 api_color: Optional[pulumi.Input[builtins.str]] = None,
                 api_name: Optional[pulumi.Input[builtins.str]] = None,
                 conditions: Optional[pulumi.Input['ApiDetectionConditionsArgs']] = None,
                 insert_after: Optional[pulumi.Input[builtins.str]] = None,
                 technology: Optional[pulumi.Input[builtins.str]] = None,
                 third_party_api: Optional[pulumi.Input[builtins.bool]] = None):
        """
    ...
    @property
    @pulumi.getter(name="apiColor")
    def api_color(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        This color will be used to highlight APIs when viewing code level data, such as distributed traces or method hotspots.
        """
        return pulumi.get(self, "api_color")
    ...
    @api_color.setter
    def api_color(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "api_color", value)
    ...
    @property
    @pulumi.getter(name="thirdPartyApi")
    def third_party_api(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        This API defines a third party library
        """
        return pulumi.get(self, "third_party_api")
    ...
    @third_party_api.setter
    def third_party_api(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "third_party_api", value)
...
class ApiDetection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            insert_after: Optional[pulumi.Input[builtins.str]] = None,
            technology: Optional[pulumi.Input[builtins.str]] = None,
            third_party_api: Optional[pulumi.Input[builtins.bool]] = None) -> 'ApiDetection':
        """
    ...
    @property
    @pulumi.getter(name="apiColor")
    def api_color(self) -> pulumi.Output[builtins.str]:
        """
        This color will be used to highlight APIs when viewing code level data, such as distributed traces or method hotspots.
        """
        return pulumi.get(self, "api_color")
    ...
    @property
    @pulumi.getter
    def technology(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Restrict this rule to a specific technology.
        """
        return pulumi.get(self, "technology")
    ...
    @property
    @pulumi.getter(name="thirdPartyApi")
    def third_party_api(self) -> pulumi.Output[builtins.bool]:
        """
        This API defines a third party library
        """
        return pulumi.get(self, "third_party_api")
