...
class ManagedRemoteAccessArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] user_id: User id, cannot be changed once created
        :param pulumi.Input[_builtins.str] state: Access request state. Automatically set as `ACCEPTED` on create, state can be changed in subsequent updates.
        """
    ...
    def requested_days(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    def requested_days(self, value: pulumi.Input[_builtins.int]):
...
class ManagedRemoteAccess(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="requestedDays")
    def requested_days(self) -> pulumi.Output[_builtins.int]:
        """
        For how many days access is requested, cannot be changed once created
        """
        return pulumi.get(self, "requested_days")
