...
class GetManagementZoneResult:
    ...
    def settings20_id(self) -> _builtins.str:
...
def get_management_zone(name: Optional[_builtins.str] = None,
...
def get_management_zone_output(name: Optional[pulumi.Input[_builtins.str]] = None,
