...
class MetricQueryArgs:
    ...
    def metric_selector(self) -> pulumi.Input[_builtins.str]:
        """
        Query
        """
    ...
    def metric_selector(self, value: pulumi.Input[_builtins.str]):
...
class MetricQuery(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="metricSelector")
    def metric_selector(self) -> pulumi.Output[_builtins.str]:
        """
        Query
        """
        return pulumi.get(self, "metric_selector")
