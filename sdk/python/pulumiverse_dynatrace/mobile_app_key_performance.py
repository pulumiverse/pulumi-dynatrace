...
class MobileAppKeyPerformanceArgs:
    def __init__(__self__, *,
                 frustrating_if_reported_or_web_request_error: pulumi.Input[builtins.bool],
        ...
        :param pulumi.Input[builtins.bool] frustrating_if_reported_or_web_request_error: Treat user actions with reported errors or web request errors as erroneous and rate their performance as Frustrating. Turn off this setting if errors should not affect the Apdex rate.
        :param pulumi.Input[builtins.str] scope: The scope of this setting (DEVICE*APPLICATION*METHOD, MOBILE*APPLICATION, CUSTOM*APPLICATION)
    ...
    def frustrating_if_reported_or_web_request_error(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def frustrating_if_reported_or_web_request_error(self, value: pulumi.Input[builtins.bool]):
...
class _MobileAppKeyPerformanceState:
    def __init__(__self__, *,
                 frustrating_if_reported_or_web_request_error: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="frustratingIfReportedOrWebRequestError")
    def frustrating_if_reported_or_web_request_error(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Treat user actions with reported errors or web request errors as erroneous and rate their performance as Frustrating. Turn off this setting if errors should not affect the Apdex rate.
        """
        return pulumi.get(self, "frustrating_if_reported_or_web_request_error")
    ...
    @frustrating_if_reported_or_web_request_error.setter
    def frustrating_if_reported_or_web_request_error(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "frustrating_if_reported_or_web_request_error", value)
...
class MobileAppKeyPerformance(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="frustratingIfReportedOrWebRequestError")
    def frustrating_if_reported_or_web_request_error(self) -> pulumi.Output[builtins.bool]:
        """
        Treat user actions with reported errors or web request errors as erroneous and rate their performance as Frustrating. Turn off this setting if errors should not affect the Apdex rate.
        """
        return pulumi.get(self, "frustrating_if_reported_or_web_request_error")
