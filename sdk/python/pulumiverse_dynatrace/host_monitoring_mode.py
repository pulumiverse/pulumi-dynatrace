...
class HostMonitoringModeArgs:
    def __init__(__self__, *,
                 ...
                 monitoring_mode: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] monitoring_mode: Possible Values: `DISCOVERY`, `FULL_STACK`, `INFRA_ONLY`
        """
    ...
    def monitoring_mode(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def monitoring_mode(self, value: pulumi.Input[builtins.str]):
...
class _HostMonitoringModeState:
    def __init__(__self__, *,
                 ...
                 monitoring_mode: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="monitoringMode")
    def monitoring_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Possible Values: `DISCOVERY`, `FULL_STACK`, `INFRA_ONLY`
        """
        return pulumi.get(self, "monitoring_mode")
    ...
    @monitoring_mode.setter
    def monitoring_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "monitoring_mode", value)


@pulumi.type_token("dynatrace:index/hostMonitoringMode:HostMonitoringMode")
class HostMonitoringMode(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            host_id: Optional[pulumi.Input[builtins.str]] = None,
            monitoring_mode: Optional[pulumi.Input[builtins.str]] = None) -> 'HostMonitoringMode':
        """
    ...
    @property
    @pulumi.getter(name="monitoringMode")
    def monitoring_mode(self) -> pulumi.Output[builtins.str]:
        """
        Possible Values: `DISCOVERY`, `FULL_STACK`, `INFRA_ONLY`
        """
        return pulumi.get(self, "monitoring_mode")
