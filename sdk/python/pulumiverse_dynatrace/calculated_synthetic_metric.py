...
class CalculatedSyntheticMetricArgs:
    def __init__(__self__, *,
                 ...
                 monitor_identifier: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] metric_key: The unique key of the calculated synthetic metric.
        :param pulumi.Input[builtins.str] monitor_identifier: The Dynatrace entity ID of the monitor to which the metric belongs.
        :param pulumi.Input[builtins.str] description: Descriptor of a calculated synthetic metric.
    ...
    def monitor_identifier(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def monitor_identifier(self, value: pulumi.Input[builtins.str]):
...
class _CalculatedSyntheticMetricState:
    def __init__(__self__, *,
                 ...
                 monitor_identifier: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="monitorIdentifier")
    def monitor_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Dynatrace entity ID of the monitor to which the metric belongs.
        """
        return pulumi.get(self, "monitor_identifier")
    ...
    @monitor_identifier.setter
    def monitor_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "monitor_identifier", value)
...
@pulumi.type_token("dynatrace:index/calculatedSyntheticMetric:CalculatedSyntheticMetric")
class CalculatedSyntheticMetric(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            metric_key: Optional[pulumi.Input[builtins.str]] = None,
            monitor_identifier: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'CalculatedSyntheticMetric':
        """
    ...
    @property
    @pulumi.getter(name="monitorIdentifier")
    def monitor_identifier(self) -> pulumi.Output[builtins.str]:
        """
        The Dynatrace entity ID of the monitor to which the metric belongs.
        """
        return pulumi.get(self, "monitor_identifier")
