...
class ManagedNetworkZonesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Name of the network zone cannot be modified once created. Dynatrace stores the field in lowercase, allowed characters: alphanumeric, hyphen, underscore, dot
        :param pulumi.Input[_builtins.int] num_of_configured_activegates: The number of ActiveGates in the network zone.
        :param pulumi.Input[_builtins.int] num_of_configured_oneagents: The number of OneAgents that are configured to use the network zone as primary.
        :param pulumi.Input[_builtins.int] num_of_oneagents_from_other_zones: The number of OneAgents from other network zones that are using ActiveGates in the network zone.
        :param pulumi.Input[_builtins.int] num_of_oneagents_using: The number of OneAgents that are using ActiveGates in the network zone.
        """
...
class ManagedNetworkZones(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            num_of_configured_oneagents: Optional[pulumi.Input[_builtins.int]] = None,
            num_of_oneagents_from_other_zones: Optional[pulumi.Input[_builtins.int]] = None,
            num_of_oneagents_using: Optional[pulumi.Input[_builtins.int]] = None) -> 'ManagedNetworkZones':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="alternativeZones")
    def alternative_zones(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        A list of alternative network zones.
        """
        return pulumi.get(self, "alternative_zones")
    ...
    @_builtins.property
    @pulumi.getter(name="numOfConfiguredActivegates")
    def num_of_configured_activegates(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The number of ActiveGates in the network zone.
        """
        return pulumi.get(self, "num_of_configured_activegates")
    ...
    @_builtins.property
    @pulumi.getter(name="numOfConfiguredOneagents")
    def num_of_configured_oneagents(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The number of OneAgents that are configured to use the network zone as primary.
        """
        return pulumi.get(self, "num_of_configured_oneagents")
    ...
    @_builtins.property
    @pulumi.getter(name="numOfOneagentsFromOtherZones")
    def num_of_oneagents_from_other_zones(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The number of OneAgents from other network zones that are using ActiveGates in the network zone.
        """
        return pulumi.get(self, "num_of_oneagents_from_other_zones")
    ...
    @_builtins.property
    @pulumi.getter(name="numOfOneagentsUsing")
    def num_of_oneagents_using(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The number of OneAgents that are using ActiveGates in the network zone.
        """
        return pulumi.get(self, "num_of_oneagents_using")
