...
class HttpMonitorOutageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] global_outages: (Field has overlap with `HttpMonitor`) Generate a problem and send an alert when the monitor is unavailable at all configured locations.
        :param pulumi.Input[builtins.bool] local_outages: (Field has overlap with `HttpMonitor`) Generate a problem and send an alert when the monitor is unavailable for one or more consecutive runs at any location.
        :param pulumi.Input[builtins.int] global_consecutive_outage_count_threshold: (Field has overlap with `HttpMonitor`) Alert if all locations are unable to access my web application
        :param pulumi.Input[builtins.int] local_consecutive_outage_count_threshold: (Field has overlap with `HttpMonitor`) are unable to access my web application
        :param pulumi.Input[builtins.int] local_location_outage_count_threshold: (Field has overlap with `HttpMonitor`) Alert if at least
        :param pulumi.Input[builtins.str] scope: The scope of this setting (HTTP_CHECK). Omit this property if you want to cover the whole environment.
        """
...
@pulumi.type_token("dynatrace:index/httpMonitorOutage:HttpMonitorOutage")
class HttpMonitorOutage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            local_location_outage_count_threshold: Optional[pulumi.Input[builtins.int]] = None,
            local_outages: Optional[pulumi.Input[builtins.bool]] = None,
            scope: Optional[pulumi.Input[builtins.str]] = None) -> 'HttpMonitorOutage':
        """
