...
class HttpMonitorOutageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] local_location_outage_count_threshold: (Field has overlap with `HttpMonitor`) Alert if at least
        :param pulumi.Input[_builtins.str] scope: The scope of this setting (HTTP_CHECK). Omit this property if you want to cover the whole environment.
        """
...
class HttpMonitorOutage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            local_location_outage_count_threshold: Optional[pulumi.Input[_builtins.int]] = None,
            local_outages: Optional[pulumi.Input[_builtins.bool]] = None,
            scope: Optional[pulumi.Input[_builtins.str]] = None) -> 'HttpMonitorOutage':
        """
