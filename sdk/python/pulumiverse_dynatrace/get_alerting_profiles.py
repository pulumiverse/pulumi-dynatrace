...
class GetAlertingProfilesResult:
    ...
    @property
    @pulumi.getter
    def profiles(self) -> Optional[Mapping[str, builtins.str]]:
...
def get_alerting_profiles(profiles: Optional[Mapping[str, builtins.str]] = None,
...
def get_alerting_profiles_output(profiles: Optional[pulumi.Input[Optional[Mapping[str, builtins.str]]]] = None,
