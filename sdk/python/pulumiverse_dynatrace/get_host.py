...
def get_host(name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] tags: Required tags of the host to find
    """
    __args__ = dict()
    __args__['name'] = name
    __args__['tags'] = tags
...
def get_host_output(name: Optional[pulumi.Input[builtins.str]] = None,
