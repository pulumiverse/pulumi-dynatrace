...
class CustomAppEnablementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] scope: The scope of this setting (CUSTOM_APPLICATION). Omit this property if you want to cover the whole environment.
        """
...
class CustomAppEnablement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            rum: Optional[pulumi.Input[Union['CustomAppEnablementRumArgs', 'CustomAppEnablementRumArgsDict']]] = None,
            scope: Optional[pulumi.Input[builtins.str]] = None) -> 'CustomAppEnablement':
        """
