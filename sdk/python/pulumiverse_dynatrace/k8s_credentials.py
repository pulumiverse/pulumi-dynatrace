...
class K8sCredentialsArgs:
    def __init__(__self__, *,
                 ...
                 davis_events_integration_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 endpoint_url: Optional[pulumi.Input[builtins.str]] = None,
                 event_analysis_and_alerting_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 events_field_selectors: Optional[pulumi.Input[Sequence[pulumi.Input['K8sCredentialsEventsFieldSelectorArgs']]]] = None,
                 events_integration_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 hostname_verification: Optional[pulumi.Input[builtins.bool]] = None,
                 prometheus_exporters: Optional[pulumi.Input[builtins.bool]] = None,
                 unknowns: Optional[pulumi.Input[builtins.str]] = None,
                 workload_integration_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a K8sCredentials resource.
        :param pulumi.Input[builtins.str] label: The name of the Kubernetes credentials configuration.  Allowed characters are letters, numbers, whitespaces, and the following characters: `.+-_`. Leading or trailing whitespace is not allowed.
        :param pulumi.Input[builtins.bool] active: Monitoring is enabled (`true`) or disabled (`false`) for given credentials configuration.  If not set on creation, the `true` value is used.  If the field is omitted during an update, the old value remains unaffected.
        :param pulumi.Input[builtins.str] active_gate_group: Active Gate group to filter active gates for this credentials.
        :param pulumi.Input[builtins.str] auth_token: The service account bearer token for the Kubernetes API server.  Submit your token on creation or update of the configuration. For security reasons, GET requests return this field as `null`.  If the field is omitted during an update, the old value remains unaffected.
        :param pulumi.Input[builtins.bool] certificate_check_enabled: The check of SSL certificates is enabled (`true`) or disabled (`false`) for the Kubernetes cluster.  If not set on creation, the `true` value is used.  If the field is omitted during an update, the old value remains unaffected.
        :param pulumi.Input[builtins.bool] davis_events_integration_enabled: Inclusion of all Davis relevant events is enabled (`true`) or disabled (`false`) for the Kubernetes cluster. If the field is omitted during an update, the old value remains unaffected
        :param pulumi.Input[builtins.str] endpoint_url: The URL of the Kubernetes API server.  It must be unique within a Dynatrace environment.  The URL must valid according to RFC 2396. Leading or trailing whitespaces are not allowed.
        :param pulumi.Input[builtins.bool] event_analysis_and_alerting_enabled: Event analysis and alerting is (`true`) or disabled (`false`) for the Kubernetes cluster. If the field is omitted during an update, the old value remains unaffected.
        ...
        :param pulumi.Input[builtins.bool] events_integration_enabled: Monitoring of events is enabled (`true`) or disabled (`false`) for the Kubernetes cluster. Event monitoring depends on the active state of this configuration to be true.  If not set on creation, the `false` value is used.  If the field is omitted during an update, the old value remains unaffected.
        :param pulumi.Input[builtins.bool] hostname_verification: Verify hostname in certificate against Kubernetes API URL
        :param pulumi.Input[builtins.bool] prometheus_exporters: Prometheus exporters integration is enabled (`true`) or disabled (`false`) for the Kubernetes cluster.If the field is omitted during an update, the old value remains unaffected
        :param pulumi.Input[builtins.str] unknowns: Any attributes that aren't yet supported by this provider
        :param pulumi.Input[builtins.bool] workload_integration_enabled: Workload and cloud application processing is enabled (`true`) or disabled (`false`) for the Kubernetes cluster. If the field is omitted during an update, the old value remains unaffected.
        """
    ...
    def davis_events_integration_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def davis_events_integration_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def event_analysis_and_alerting_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def event_analysis_and_alerting_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def events_integration_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Monitoring of events is enabled (`true`) or disabled (`false`) for the Kubernetes cluster. Event monitoring depends on the active state of this configuration to be true.  If not set on creation, the `false` value is used.  If the field is omitted during an update, the old value remains unaffected.
        """
    ...
    def events_integration_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "events_integration_enabled", value)

    @property
    @pulumi.getter(name="hostnameVerification")
    def hostname_verification(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def hostname_verification(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "hostname_verification", value)

    @property
    @pulumi.getter(name="prometheusExporters")
    def prometheus_exporters(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def prometheus_exporters(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def workload_integration_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def workload_integration_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class K8sCredentials(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            prometheus_exporters: Optional[pulumi.Input[builtins.bool]] = None,
            unknowns: Optional[pulumi.Input[builtins.str]] = None,
            workload_integration_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'K8sCredentials':
        """
    ...
    @property
    @pulumi.getter(name="davisEventsIntegrationEnabled")
    def davis_events_integration_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Inclusion of all Davis relevant events is enabled (`true`) or disabled (`false`) for the Kubernetes cluster. If the field is omitted during an update, the old value remains unaffected
        """
        return pulumi.get(self, "davis_events_integration_enabled")
    ...
    @property
    @pulumi.getter(name="eventAnalysisAndAlertingEnabled")
    def event_analysis_and_alerting_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Event analysis and alerting is (`true`) or disabled (`false`) for the Kubernetes cluster. If the field is omitted during an update, the old value remains unaffected.
        """
        return pulumi.get(self, "event_analysis_and_alerting_enabled")
    ...
    @property
    @pulumi.getter(name="eventsIntegrationEnabled")
    def events_integration_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Monitoring of events is enabled (`true`) or disabled (`false`) for the Kubernetes cluster. Event monitoring depends on the active state of this configuration to be true.  If not set on creation, the `false` value is used.  If the field is omitted during an update, the old value remains unaffected.
        """
        return pulumi.get(self, "events_integration_enabled")
    ...
    @property
    @pulumi.getter(name="hostnameVerification")
    def hostname_verification(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Verify hostname in certificate against Kubernetes API URL
        """
        return pulumi.get(self, "hostname_verification")
    ...
    @property
    @pulumi.getter(name="prometheusExporters")
    def prometheus_exporters(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Prometheus exporters integration is enabled (`true`) or disabled (`false`) for the Kubernetes cluster.If the field is omitted during an update, the old value remains unaffected
        """
        return pulumi.get(self, "prometheus_exporters")
    ...
    @property
    @pulumi.getter(name="workloadIntegrationEnabled")
    def workload_integration_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Workload and cloud application processing is enabled (`true`) or disabled (`false`) for the Kubernetes cluster. If the field is omitted during an update, the old value remains unaffected.
        """
        return pulumi.get(self, "workload_integration_enabled")
