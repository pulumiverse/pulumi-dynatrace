...
class JsonDashboardArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] contents: Contains the JSON Code of the Dashboard
        :param pulumi.Input[builtins.str] link_id: ID of the dashboard, used with the json*dashboard*base resource and variables to create circular dependencies between dashboards for hyperlinks. See the documentation for `JsonDashboardBase` for a concrete example.
        """
...
class JsonDashboard(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            contents: Optional[pulumi.Input[builtins.str]] = None,
            link_id: Optional[pulumi.Input[builtins.str]] = None) -> 'JsonDashboard':
        """
