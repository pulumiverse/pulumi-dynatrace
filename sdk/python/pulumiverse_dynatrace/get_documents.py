...
def get_documents(type: Optional[builtins.str] = None,
    ...
    :param builtins.str type: The type of documents to query for. Leave empty if you want to query for all kinds of documents. Possible values are `dashboard` or `notebook`
    """
    __args__ = dict()
    __args__['type'] = type
...
def get_documents_output(type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
