...
class HttpMonitorArgs:
    def __init__(__self__, *,
                 ...
                 manually_assigned_apps: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 no_script: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.int] frequency: The frequency of the monitor, in minutes.
        ...
        :param pulumi.Input[builtins.bool] enabled: The monitor is enabled (`true`) or disabled (`false`).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] locations: A list of locations from which the monitor is executed. To specify a location, use its entity ID.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] manually_assigned_apps: A set of manually assigned applications.
        :param pulumi.Input[builtins.str] name: The name of the monitor.
        :param pulumi.Input[builtins.bool] no_script: No script block - handle requests via `HttpMonitorScript` resource
    ...
    def manually_assigned_apps(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def manually_assigned_apps(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def no_script(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @no_script.setter
    def no_script(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class HttpMonitor(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="manuallyAssignedApps")
    def manually_assigned_apps(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A set of manually assigned applications.
        """
        return pulumi.get(self, "manually_assigned_apps")
    ...
    @property
    @pulumi.getter(name="noScript")
    def no_script(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        No script block - handle requests via `HttpMonitorScript` resource
        """
        return pulumi.get(self, "no_script")
