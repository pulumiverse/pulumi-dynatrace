...
class WebAppResourceTypesArgs:
    def __init__(__self__, *,
                 primary_resource_type: pulumi.Input[builtins.str],
                 regular_expression: pulumi.Input[builtins.str],
                 insert_after: Optional[pulumi.Input[builtins.str]] = None,
                 secondary_resource_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a WebAppResourceTypes resource.
        :param pulumi.Input[builtins.str] primary_resource_type: Possible Values: `CSS`, `IMAGE`, `OTHER`, `SCRIPT`
        :param pulumi.Input[builtins.str] regular_expression: The regular expression to detect the resource.
        :param pulumi.Input[builtins.str] insert_after: Because this resource allows for ordering you may specify the ID of the resource instance that comes before this instance regarding order. If not specified when creating the setting will be added to the end of the list. If not specified during update the order will remain untouched
        :param pulumi.Input[builtins.str] secondary_resource_type: The secondary type of the resource.
        """
    ...
    def primary_resource_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def primary_resource_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "primary_resource_type", value)

    @property
    @pulumi.getter(name="regularExpression")
    def regular_expression(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def regular_expression(self, value: pulumi.Input[builtins.str]):
    ...
    def secondary_resource_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def secondary_resource_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _WebAppResourceTypesState:
    def __init__(__self__, *,
                 insert_after: Optional[pulumi.Input[builtins.str]] = None,
                 primary_resource_type: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="primaryResourceType")
    def primary_resource_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Possible Values: `CSS`, `IMAGE`, `OTHER`, `SCRIPT`
        """
        return pulumi.get(self, "primary_resource_type")
    ...
    @primary_resource_type.setter
    def primary_resource_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "primary_resource_type", value)
...
class WebAppResourceTypes(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            primary_resource_type: Optional[pulumi.Input[builtins.str]] = None,
            regular_expression: Optional[pulumi.Input[builtins.str]] = None,
            secondary_resource_type: Optional[pulumi.Input[builtins.str]] = None) -> 'WebAppResourceTypes':
        """
    ...
    @property
    @pulumi.getter(name="primaryResourceType")
    def primary_resource_type(self) -> pulumi.Output[builtins.str]:
        """
        Possible Values: `CSS`, `IMAGE`, `OTHER`, `SCRIPT`
        """
        return pulumi.get(self, "primary_resource_type")
    ...
    @property
    @pulumi.getter(name="regularExpression")
    def regular_expression(self) -> pulumi.Output[builtins.str]:
        """
        The regular expression to detect the resource.
        """
        return pulumi.get(self, "regular_expression")
    ...
    @property
    @pulumi.getter(name="secondaryResourceType")
    def secondary_resource_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The secondary type of the resource.
        """
        return pulumi.get(self, "secondary_resource_type")
