...
class DevobsDataMaskingArgs:
    def __init__(__self__, *,
                 ...
                 replacement_type: pulumi.Input[builtins.str],
                 ...
                 replacement_pattern: Optional[pulumi.Input[builtins.str]] = None,
                 rule_regex: Optional[pulumi.Input[builtins.str]] = None,
                 rule_var_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] replacement_type: Possible Values: `SHA256`, `STRING`
        :param pulumi.Input[builtins.str] rule_name: Rule Name
        :param pulumi.Input[builtins.str] rule_type: Possible Values: `REGEX`, `VAR_NAME`
        :param pulumi.Input[builtins.str] insert_after: Because this resource allows for ordering you may specify the ID of the resource instance that comes before this instance regarding order. If not specified when creating the setting will be added to the end of the list. If not specified during update the order will remain untouched
        :param pulumi.Input[builtins.str] replacement_pattern: no documentation available
        :param pulumi.Input[builtins.str] rule_regex: no documentation available
        :param pulumi.Input[builtins.str] rule_var_name: no documentation available
        """
    ...
    def replacement_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def replacement_type(self, value: pulumi.Input[builtins.str]):
    ...
    def replacement_pattern(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def replacement_pattern(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "replacement_pattern", value)

    @property
    @pulumi.getter(name="ruleRegex")
    def rule_regex(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        no documentation available
        """
    ...
    @rule_regex.setter
    def rule_regex(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "rule_regex", value)

    @property
    @pulumi.getter(name="ruleVarName")
    def rule_var_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        no documentation available
        """
    ...
    def rule_var_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DevobsDataMaskingState:
    def __init__(__self__, *,
                 ...
                 insert_after: Optional[pulumi.Input[builtins.str]] = None,
                 replacement_pattern: Optional[pulumi.Input[builtins.str]] = None,
                 replacement_type: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="replacementType")
    def replacement_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Possible Values: `SHA256`, `STRING`
        """
        return pulumi.get(self, "replacement_type")
    ...
    @replacement_type.setter
    def replacement_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "replacement_type", value)
...
class DevobsDataMasking(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rule_regex: Optional[pulumi.Input[builtins.str]] = None,
            rule_type: Optional[pulumi.Input[builtins.str]] = None,
            rule_var_name: Optional[pulumi.Input[builtins.str]] = None) -> 'DevobsDataMasking':
        """
    ...
    @property
    @pulumi.getter(name="replacementPattern")
    def replacement_pattern(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        no documentation available
        """
        return pulumi.get(self, "replacement_pattern")
    ...
    @property
    @pulumi.getter(name="replacementType")
    def replacement_type(self) -> pulumi.Output[builtins.str]:
        """
        Possible Values: `SHA256`, `STRING`
        """
        return pulumi.get(self, "replacement_type")
    ...
    @property
    @pulumi.getter(name="ruleRegex")
    def rule_regex(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        no documentation available
        """
        return pulumi.get(self, "rule_regex")
    ...
    @property
    @pulumi.getter(name="ruleVarName")
    def rule_var_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        no documentation available
        """
        return pulumi.get(self, "rule_var_name")
