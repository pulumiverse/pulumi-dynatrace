...
class GetSyntheticLocationResult:
    ...
    def cloud_platform(self) -> builtins.str:
        """
...
def get_synthetic_location(cloud_platform: Optional[builtins.str] = None,
    ...
    :param builtins.str cloud_platform: The cloud provider where the location is hosted.
    """
    __args__ = dict()
...
def get_synthetic_location_output(cloud_platform: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  entity_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  geo_location_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
