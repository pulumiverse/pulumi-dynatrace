...
def get_failure_detection_parameters(name: Optional[builtins.str] = None,
...
def get_failure_detection_parameters_output(name: Optional[pulumi.Input[builtins.str]] = None,
