...
def get_calculated_service_metric(name: Optional[builtins.str] = None,
...
def get_calculated_service_metric_output(name: Optional[pulumi.Input[builtins.str]] = None,
