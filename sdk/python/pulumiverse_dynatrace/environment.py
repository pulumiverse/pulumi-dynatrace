...
class EnvironmentArgs:
    def __init__(__self__, *,
                 ...
                 trial: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a Environment resource.
        :param pulumi.Input[builtins.str] state: Indicates whether the environment is enabled or disabled. Possible values are `ENABLED` and `DISABLED`. The default value is ENABLED
        :param pulumi.Input['EnvironmentStorageArgs'] storage: Environment level storage usage and limit information
        :param pulumi.Input[builtins.str] name: The display name of the environment
        :param pulumi.Input['EnvironmentQuotasArgs'] quotas: Environment level consumption and quotas information
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: A set of tags that are assigned to this environment. Every tag can have a maximum length of 100 characters
        :param pulumi.Input[builtins.bool] trial: Specifies whether the environment is a trial environment or a non-trial environment. Creating a trial environment is only possible if your license allows that. The default value is false (non-trial)
        """
    ...
    @property
    @pulumi.getter
    def trial(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @trial.setter
    def trial(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Environment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            storage: Optional[pulumi.Input[Union['EnvironmentStorageArgs', 'EnvironmentStorageArgsDict']]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            trial: Optional[pulumi.Input[builtins.bool]] = None) -> 'Environment':
        """
    ...
    @property
    @pulumi.getter
    def trial(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether the environment is a trial environment or a non-trial environment. Creating a trial environment is only possible if your license allows that. The default value is false (non-trial)
        """
        return pulumi.get(self, "trial")
