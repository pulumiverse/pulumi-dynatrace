...
__all__ = ['BrowserMonitorOutageArgs', 'BrowserMonitorOutage']

@pulumi.input_type
class BrowserMonitorOutageArgs:
    def __init__(__self__, *,
                 global_outages: pulumi.Input[builtins.bool],
                 local_outages: pulumi.Input[builtins.bool],
                 retry_on_error: pulumi.Input[builtins.bool],
        ...
        :param pulumi.Input[builtins.bool] global_outages: (Field has overlap with `BrowserMonitor`) Generate a problem and send an alert when the monitor is unavailable at all configured locations.
        :param pulumi.Input[builtins.bool] local_outages: (Field has overlap with `BrowserMonitor`) Generate a problem and send an alert when the monitor is unavailable for one or more consecutive runs at any location.
        :param pulumi.Input[builtins.bool] retry_on_error: (Field has overlap with `BrowserMonitor`) When enabled, which is the default, failing monitor executions are retried immediately one time to avoid false positives and only the second result is used. When disabled, we use the first result right away.
               Requires ActiveGate version 1.207+ for private locations.
        :param pulumi.Input[builtins.int] global_consecutive_outage_count_threshold: (Field has overlap with `BrowserMonitor`) Alert if all locations are unable to access my web application
        :param pulumi.Input[builtins.int] local_consecutive_outage_count_threshold: (Field has overlap with `BrowserMonitor`) are unable to access my web application
        :param pulumi.Input[builtins.int] local_location_outage_count_threshold: (Field has overlap with `BrowserMonitor`) Alert if at least
        :param pulumi.Input[builtins.str] scope: The scope of this setting (SYNTHETIC_TEST). Omit this property if you want to cover the whole environment.
        """
    ...
    def retry_on_error(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def retry_on_error(self, value: pulumi.Input[builtins.bool]):
...
@pulumi.input_type
class _BrowserMonitorOutageState:
    def __init__(__self__, *,
                 global_consecutive_outage_count_threshold: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 retry_on_error: Optional[pulumi.Input[builtins.bool]] = None,
                 scope: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="retryOnError")
    def retry_on_error(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Field has overlap with `BrowserMonitor`) When enabled, which is the default, failing monitor executions are retried immediately one time to avoid false positives and only the second result is used. When disabled, we use the first result right away.
        Requires ActiveGate version 1.207+ for private locations.
        """
    ...
    @retry_on_error.setter
    def retry_on_error(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "retry_on_error", value)
...
class BrowserMonitorOutage(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BrowserMonitorOutageArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BrowserMonitorOutageArgs.__new__(BrowserMonitorOutageArgs)
            ...
            if retry_on_error is None and not opts.urn:
                raise TypeError("Missing required property 'retry_on_error'")
            __props__.__dict__["retry_on_error"] = retry_on_error
            __props__.__dict__["scope"] = scope
        super(BrowserMonitorOutage, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            local_outages: Optional[pulumi.Input[builtins.bool]] = None,
            retry_on_error: Optional[pulumi.Input[builtins.bool]] = None,
            scope: Optional[pulumi.Input[builtins.str]] = None) -> 'BrowserMonitorOutage':
        """
        ...
        __props__ = _BrowserMonitorOutageState.__new__(_BrowserMonitorOutageState)
        ...
        __props__.__dict__["retry_on_error"] = retry_on_error
        __props__.__dict__["scope"] = scope
        return BrowserMonitorOutage(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="retryOnError")
    def retry_on_error(self) -> pulumi.Output[builtins.bool]:
        """
        (Field has overlap with `BrowserMonitor`) When enabled, which is the default, failing monitor executions are retried immediately one time to avoid false positives and only the second result is used. When disabled, we use the first result right away.
        Requires ActiveGate version 1.207+ for private locations.
        """
