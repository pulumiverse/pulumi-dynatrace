...
def get_iam_policy(account: Optional[_builtins.str] = None,
    ...
    :param _builtins.str account: The account that policiy is defined for. Omit if the policy is not defined for an account but for an environment or is global
    :param _builtins.str environment: The environment that policiy is defined for. Omit if the policy is not defined for an environment but for an account or is global
    :param _builtins.str name: The name of the policy
    :param _builtins.str uuid: The UUID of the policy
    """
    __args__ = dict()
