...
class DiskAnomalyRulesArgs:
    def __init__(__self__, *,
                 ...
                 threshold_milliseconds: Optional[pulumi.Input[builtins.float]] = None,
        ...
        :param pulumi.Input[builtins.str] metric: Possible Values: `LOW_DISK_SPACE`, `LOW_INODES`, `READ_TIME_EXCEEDING`, `WRITE_TIME_EXCEEDING`
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tag_filters: Only apply to hosts that have the following tags
        :param pulumi.Input[builtins.float] threshold_milliseconds: Alert if higher than
        :param pulumi.Input[builtins.float] threshold_percent: Alert if lower than
        """
    ...
    def threshold_milliseconds(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def threshold_milliseconds(self, value: Optional[pulumi.Input[builtins.float]]):
...
class DiskAnomalyRules(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tag_filters: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            threshold_milliseconds: Optional[pulumi.Input[builtins.float]] = None,
            threshold_percent: Optional[pulumi.Input[builtins.float]] = None) -> 'DiskAnomalyRules':
        """
    ...
    @property
    @pulumi.getter(name="tagFilters")
    def tag_filters(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Only apply to hosts that have the following tags
        """
        return pulumi.get(self, "tag_filters")
    ...
    @property
    @pulumi.getter(name="thresholdMilliseconds")
    def threshold_milliseconds(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        Alert if higher than
        """
        return pulumi.get(self, "threshold_milliseconds")
