...
class IamGroupArgs:
    def __init__(__self__, *,
                 ...
                 federated_attribute_values: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
    ...
    def federated_attribute_values(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "federated_attribute_values")

    @federated_attribute_values.setter
    def federated_attribute_values(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class IamGroup(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="federatedAttributeValues")
    def federated_attribute_values(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        return pulumi.get(self, "federated_attribute_values")
