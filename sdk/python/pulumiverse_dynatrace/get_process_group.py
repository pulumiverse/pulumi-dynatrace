...
def get_process_group(name: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] tags: Required tags of the process group to find
    """
    __args__ = dict()
    __args__['name'] = name
    __args__['tags'] = tags
...
def get_process_group_output(name: Optional[pulumi.Input[_builtins.str]] = None,
