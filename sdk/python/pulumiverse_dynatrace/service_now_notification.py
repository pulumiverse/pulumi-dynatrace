...
class ServiceNowNotificationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] incidents: Send incidents into ServiceNow ITSM
        :param pulumi.Input[builtins.str] message: The content of the ServiceNow description. You can use the following placeholders:  * `{ImpactedEntity}`: The entity impacted by the problem or *X* impacted entities.  * `{PID}`: The ID of the reported problem.  * `{ProblemDetailsHTML}`: All problem event details, including root cause, as an HTML-formatted string.  * `{ProblemID}`: The display number of the reported problem.  * `{ProblemImpact}`: The [impact level](https://www.dynatrace.com/support/help/shortlink/impact-analysis) of the problem. Possible values are `APPLICATION`, `SERVICE`, and `INFRASTRUCTURE`.  * `{ProblemSeverity}`: The [severity level](https://www.dynatrace.com/support/help/shortlink/event-types) of the problem. Possible values are `AVAILABILITY`, `ERROR`, `PERFORMANCE`, `RESOURCE_CONTENTION`, and `CUSTOM_ALERT`.  * `{ProblemTitle}`: A short description of the problem.  * `{ProblemURL}`: The URL of the problem within Dynatrace.  * `{State}`: The state of the problem. Possible values are `OPEN` and `RESOLVED`.  * `{Tags}`: The list of tags that are defined for all impacted entities, separated by commas
        :param pulumi.Input[builtins.str] profile: The ID of the associated alerting profile
        :param pulumi.Input[builtins.str] username: The username of the ServiceNow account.   Make sure that your user account has the `rest_service`, `web_request_admin`, and `x_dynat_ruxit.Integration` roles
        :param pulumi.Input[builtins.bool] events: Send events into ServiceNow ITOM
        :param pulumi.Input[builtins.bool] format_problem_details_as_text: Use text format for problem details instead of HTML.
        :param pulumi.Input[builtins.str] instance: The ServiceNow instance identifier. It refers to the first part of your own ServiceNow URL. This field is mutually exclusive with the **url** field. You can only use one of them
        ...
        :param pulumi.Input[builtins.str] password: The password to the ServiceNow account
        :param pulumi.Input[builtins.str] url: The URL of the on-premise ServiceNow installation. This field is mutually exclusive with the **instance** field. You can only use one of them
        """
    ...
    @property
    @pulumi.getter
    def incidents(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @incidents.setter
    def incidents(self, value: pulumi.Input[builtins.bool]):
    ...
    def format_problem_details_as_text(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def format_problem_details_as_text(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ServiceNowNotificationState:
    def __init__(__self__, *,
                 ...
                 events: Optional[pulumi.Input[builtins.bool]] = None,
                 format_problem_details_as_text: Optional[pulumi.Input[builtins.bool]] = None,
                 incidents: Optional[pulumi.Input[builtins.bool]] = None,
                 instance: Optional[pulumi.Input[builtins.str]] = None,
                 legacy_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter
    def incidents(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Send incidents into ServiceNow ITSM
        """
        return pulumi.get(self, "incidents")
    ...
    @incidents.setter
    def incidents(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "incidents", value)
...
@pulumi.type_token("dynatrace:index/serviceNowNotification:ServiceNowNotification")
class ServiceNowNotification(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            profile: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'ServiceNowNotification':
        """
    ...
    @property
    @pulumi.getter
    def events(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Send events into ServiceNow ITOM
        """
        return pulumi.get(self, "events")
    ...
    @property
    @pulumi.getter(name="formatProblemDetailsAsText")
    def format_problem_details_as_text(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Use text format for problem details instead of HTML.
        """
        return pulumi.get(self, "format_problem_details_as_text")
    ...
    @property
    @pulumi.getter
    def incidents(self) -> pulumi.Output[builtins.bool]:
        """
        Send incidents into ServiceNow ITSM
        """
        return pulumi.get(self, "incidents")
