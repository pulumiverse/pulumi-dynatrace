...
class CustomUnitsArgs:
    ...
    def plural_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @plural_name.setter
    def plural_name(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "plural_name", value)

    @_builtins.property
    @pulumi.getter
    def symbol(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @symbol.setter
    def symbol(self, value: pulumi.Input[_builtins.str]):
...
class CustomUnits(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="pluralName")
    def plural_name(self) -> pulumi.Output[_builtins.str]:
        """
        Unit plural name represent the plural form of the unit name.
        """
        return pulumi.get(self, "plural_name")
    ...
    @_builtins.property
    @pulumi.getter
    def symbol(self) -> pulumi.Output[_builtins.str]:
        """
        Unit symbol has to be unique.
        """
        return pulumi.get(self, "symbol")
