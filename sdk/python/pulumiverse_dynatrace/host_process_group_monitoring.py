...
class HostProcessGroupMonitoringArgs:
    def __init__(__self__, *,
                 ...
                 monitoring_state: pulumi.Input[_builtins.str],
    ...
    def monitoring_state(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def monitoring_state(self, value: pulumi.Input[_builtins.str]):
...
class HostProcessGroupMonitoring(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="monitoringState")
    def monitoring_state(self) -> pulumi.Output[_builtins.str]:
        """
        Possible Values: `DEFAULT`, `MONITORING_OFF`, `MONITORING_ON`
        """
        return pulumi.get(self, "monitoring_state")
