...
class ContainerRegistryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] container_registry: Typically set without protocol. Leave empty to use default configuration
        """
...
@pulumi.type_token("dynatrace:index/containerRegistry:ContainerRegistry")
class ContainerRegistry(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            container_registry: Optional[pulumi.Input[builtins.str]] = None) -> 'ContainerRegistry':
        """
