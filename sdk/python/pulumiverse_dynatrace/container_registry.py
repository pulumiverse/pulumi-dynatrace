...
class ContainerRegistryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] container_registry: Typically set without protocol. Leave empty to use default configuration
        """
...
class ContainerRegistry(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            container_registry: Optional[pulumi.Input[str]] = None) -> 'ContainerRegistry':
        """
