...
class OneagentSideMaskingArgs:
    def __init__(__self__, *,
                 is_email_masking_enabled: pulumi.Input[_builtins.bool],
    ...
    def is_email_masking_enabled(self, value: pulumi.Input[_builtins.bool]):
    ...
    def is_financial_masking_enabled(self, value: pulumi.Input[_builtins.bool]):
    ...
    def is_numbers_masking_enabled(self, value: pulumi.Input[_builtins.bool]):
        pulumi.set(self, "is_numbers_masking_enabled", value)

    @_builtins.property
    @pulumi.getter(name="isQueryMaskingEnabled")
    def is_query_masking_enabled(self) -> pulumi.Input[_builtins.bool]:
        """
    ...
    def is_query_masking_enabled(self, value: pulumi.Input[_builtins.bool]):
...
class OneagentSideMasking(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="isQueryMaskingEnabled")
    def is_query_masking_enabled(self) -> pulumi.Output[_builtins.bool]:
        """
        Exclude query parameters from URLs and web requests
        """
        return pulumi.get(self, "is_query_masking_enabled")
