...
class ManagedBackupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] datacenter: Datacenter which will create backups
        :param pulumi.Input[_builtins.bool] enabled: Backups are enabled (true) or disabled (false).
        :param pulumi.Input[_builtins.bool] include_lm20_data: Include (true) or exclude (false) Log Monitoring v2 data
        :param pulumi.Input[_builtins.bool] include_rum_data: Include user sessions (true) or GDPR compliance (false)
        :param pulumi.Input[_builtins.bool] include_ts_metric_data: Include time series metric-data (true) or retain configuration data only (false))
        :param pulumi.Input[_builtins.int] max_es_snapshots_to_clean: Max number of Elasticsearch snapshots to clean. Elasticsearch snapshots won't be created anymore if there will be more backups to clean than this value.
        :param pulumi.Input[_builtins.bool] pause_backups: Pauses Elasticsearch and Cassandra backups. In comparison to enable/disable backup, this option does not modify any configuration like Elasticsearch properties.
        :param pulumi.Input[_builtins.str] storage_path: A full path to the backup archive
        """
    ...
    def cassandra_scheduled_time(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    def cassandra_scheduled_time(self, value: pulumi.Input[_builtins.int]):
...
class ManagedBackup(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="bandwidthLimitMbits")
    def bandwidth_limit_mbits(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Cassandra backup bandwidth limit in Mbps
        """
        return pulumi.get(self, "bandwidth_limit_mbits")
    ...
    @_builtins.property
    @pulumi.getter(name="cassandraScheduledTime")
    def cassandra_scheduled_time(self) -> pulumi.Output[_builtins.int]:
        """
        Hour to start Cassandra backups each day.
        """
        return pulumi.get(self, "cassandra_scheduled_time")
    ...
    @_builtins.property
    @pulumi.getter(name="includeLm20Data")
    def include_lm20_data(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Include (true) or exclude (false) Log Monitoring v2 data
        """
        return pulumi.get(self, "include_lm20_data")
    ...
    @_builtins.property
    @pulumi.getter(name="includeRumData")
    def include_rum_data(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Include user sessions (true) or GDPR compliance (false)
        """
        return pulumi.get(self, "include_rum_data")
    ...
    @_builtins.property
    @pulumi.getter(name="includeTsMetricData")
    def include_ts_metric_data(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Include time series metric-data (true) or retain configuration data only (false))
        """
        return pulumi.get(self, "include_ts_metric_data")
    ...
    @_builtins.property
    @pulumi.getter(name="maxEsSnapshotsToClean")
    def max_es_snapshots_to_clean(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Max number of Elasticsearch snapshots to clean. Elasticsearch snapshots won't be created anymore if there will be more backups to clean than this value.
        """
        return pulumi.get(self, "max_es_snapshots_to_clean")
    ...
    @_builtins.property
    @pulumi.getter(name="pauseBackups")
    def pause_backups(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Pauses Elasticsearch and Cassandra backups. In comparison to enable/disable backup, this option does not modify any configuration like Elasticsearch properties.
        """
        return pulumi.get(self, "pause_backups")
    ...
    @_builtins.property
    @pulumi.getter(name="storagePath")
    def storage_path(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A full path to the backup archive
        """
        return pulumi.get(self, "storage_path")
