...
class MobileApplicationArgs:
    def __init__(__self__, *,
                 ...
                 beacon_endpoint_type: pulumi.Input[builtins.str],
                 application_id: Optional[pulumi.Input[builtins.str]] = None,
                 application_type: Optional[pulumi.Input[builtins.str]] = None,
                 beacon_endpoint_url: Optional[pulumi.Input[builtins.str]] = None,
                 icon_type: Optional[pulumi.Input[builtins.str]] = None,
                 key_user_actions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 opt_in_mode: Optional[pulumi.Input[builtins.bool]] = None,
                 properties: Optional[pulumi.Input['MobileApplicationPropertiesArgs']] = None,
                 session_replay: Optional[pulumi.Input[builtins.bool]] = None,
                 session_replay_on_crash: Optional[pulumi.Input[builtins.bool]] = None,
                 user_session_percentage: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] beacon_endpoint_type: The type of the beacon endpoint. Possible values are `CLUSTER_ACTIVE_GATE`, `ENVIRONMENT_ACTIVE_GATE` and `INSTRUMENTED_WEB_SERVER`.
        :param pulumi.Input[builtins.str] application_id: The UUID of the application.
        :param pulumi.Input[builtins.str] application_type: The type of the application. Either `CUSTOM_APPLICATION` or `MOBILE_APPLICATION`.
        :param pulumi.Input[builtins.str] beacon_endpoint_url: The URL of the beacon endpoint. Only applicable when the **beacon_endpoint_type** is set to `ENVIRONMENT_ACTIVE_GATE` or
               `INSTRUMENTED_WEB_SERVER`
        :param pulumi.Input[builtins.str] icon_type: Custom application icon. Mobile apps always use the mobile device icon, so this icon can only be set for custom apps.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] key_user_actions: User Action names to be flagged as Key User Actions
        :param pulumi.Input[builtins.str] name: The name of the application
        :param pulumi.Input[builtins.bool] opt_in_mode: The opt-in mode is enabled (`true`) or disabled (`false`)
        :param pulumi.Input['MobileApplicationPropertiesArgs'] properties: User Action and Session Properties
        :param pulumi.Input[builtins.bool] session_replay: (Field has overlap with `MobileAppEnablement`) The session replay is enabled (`true`) or disabled (`false`).
        :param pulumi.Input[builtins.bool] session_replay_on_crash: The session replay on crash is enabled (`true`) or disabled (`false`). Enabling requires both **sessionReplayEnabled**
               and **optInModeEnabled** values set to `true`.
        :param pulumi.Input[builtins.int] user_session_percentage: (Field has overlap with `MobileAppEnablement` for mobile and `CustomAppEnablement` for custom apps) The percentage of
    ...
    def beacon_endpoint_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def beacon_endpoint_type(self, value: pulumi.Input[builtins.str]):
    ...
    def beacon_endpoint_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def beacon_endpoint_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "beacon_endpoint_url", value)

    @property
    @pulumi.getter(name="iconType")
    def icon_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @icon_type.setter
    def icon_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "icon_type", value)

    @property
    @pulumi.getter(name="keyUserActions")
    def key_user_actions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def key_user_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def opt_in_mode(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @opt_in_mode.setter
    def opt_in_mode(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def session_replay(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def session_replay(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "session_replay", value)

    @property
    @pulumi.getter(name="sessionReplayOnCrash")
    def session_replay_on_crash(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def session_replay_on_crash(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "session_replay_on_crash", value)

    @property
    @pulumi.getter(name="userSessionPercentage")
    def user_session_percentage(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def user_session_percentage(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _MobileApplicationState:
    def __init__(__self__, *,
                 ...
                 application_id: Optional[pulumi.Input[builtins.str]] = None,
                 application_type: Optional[pulumi.Input[builtins.str]] = None,
                 beacon_endpoint_type: Optional[pulumi.Input[builtins.str]] = None,
                 beacon_endpoint_url: Optional[pulumi.Input[builtins.str]] = None,
                 icon_type: Optional[pulumi.Input[builtins.str]] = None,
                 key_user_actions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="beaconEndpointType")
    def beacon_endpoint_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the beacon endpoint. Possible values are `CLUSTER_ACTIVE_GATE`, `ENVIRONMENT_ACTIVE_GATE` and `INSTRUMENTED_WEB_SERVER`.
        """
        return pulumi.get(self, "beacon_endpoint_type")
    ...
    @beacon_endpoint_type.setter
    def beacon_endpoint_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "beacon_endpoint_type", value)
...
class MobileApplication(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            session_replay: Optional[pulumi.Input[builtins.bool]] = None,
            session_replay_on_crash: Optional[pulumi.Input[builtins.bool]] = None,
            user_session_percentage: Optional[pulumi.Input[builtins.int]] = None) -> 'MobileApplication':
        """
    ...
    @property
    @pulumi.getter(name="beaconEndpointType")
    def beacon_endpoint_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the beacon endpoint. Possible values are `CLUSTER_ACTIVE_GATE`, `ENVIRONMENT_ACTIVE_GATE` and `INSTRUMENTED_WEB_SERVER`.
        """
        return pulumi.get(self, "beacon_endpoint_type")
    ...
    @property
    @pulumi.getter(name="beaconEndpointUrl")
    def beacon_endpoint_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The URL of the beacon endpoint. Only applicable when the **beacon_endpoint_type** is set to `ENVIRONMENT_ACTIVE_GATE` or
        `INSTRUMENTED_WEB_SERVER`
        """
    ...
    @property
    @pulumi.getter(name="iconType")
    def icon_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Custom application icon. Mobile apps always use the mobile device icon, so this icon can only be set for custom apps.
        """
        return pulumi.get(self, "icon_type")
    ...
    @property
    @pulumi.getter(name="keyUserActions")
    def key_user_actions(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        User Action names to be flagged as Key User Actions
        """
        return pulumi.get(self, "key_user_actions")
    ...
    @property
    @pulumi.getter(name="optInMode")
    def opt_in_mode(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The opt-in mode is enabled (`true`) or disabled (`false`)
        """
        return pulumi.get(self, "opt_in_mode")
    ...
    @property
    @pulumi.getter(name="sessionReplay")
    def session_replay(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        (Field has overlap with `MobileAppEnablement`) The session replay is enabled (`true`) or disabled (`false`).
        """
        return pulumi.get(self, "session_replay")
    ...
    @property
    @pulumi.getter(name="sessionReplayOnCrash")
    def session_replay_on_crash(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The session replay on crash is enabled (`true`) or disabled (`false`). Enabling requires both **sessionReplayEnabled**
        and **optInModeEnabled** values set to `true`.
        """
    ...
    @property
    @pulumi.getter(name="userSessionPercentage")
    def user_session_percentage(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        (Field has overlap with `MobileAppEnablement` for mobile and `CustomAppEnablement` for custom apps) The percentage of
        user sessions to be analyzed
        """
