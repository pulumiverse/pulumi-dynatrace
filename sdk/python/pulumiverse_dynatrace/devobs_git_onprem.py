...
class DevobsGitOnpremArgs:
    def __init__(__self__, *,
                 ...
                 include_credentials: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a DevobsGitOnprem resource.
        :param pulumi.Input[builtins.str] git_provider: Possible Values: `AzureOnPrem`, `BitbucketOnPrem`, `GithubOnPrem`, `GitlabOnPrem`
        :param pulumi.Input[builtins.str] url: An HTTP/HTTPS URL of your server
        :param pulumi.Input[builtins.bool] include_credentials: If turned on, requests to your Gitlab server will have the `credentials` option set to `include`. Otherwise, it will be set to `omit`.
        """
    ...
    def include_credentials(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def include_credentials(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DevobsGitOnprem(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            git_provider: Optional[pulumi.Input[builtins.str]] = None,
            include_credentials: Optional[pulumi.Input[builtins.bool]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'DevobsGitOnprem':
        """
    ...
    @property
    @pulumi.getter(name="includeCredentials")
    def include_credentials(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If turned on, requests to your Gitlab server will have the `credentials` option set to `include`. Otherwise, it will be set to `omit`.
        """
        return pulumi.get(self, "include_credentials")
