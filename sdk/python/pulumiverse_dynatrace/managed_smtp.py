...
class ManagedSmtpArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] is_password_configured: If true, a password has been configured. Default: `false`.
        :param pulumi.Input[_builtins.int] port: Integer value of port. Default: `25`
        :param pulumi.Input[_builtins.bool] use_smtp_server: If true, we will send e-mails via SMTP server.
        """
    ...
    def sender_email_address(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def sender_email_address(self, value: pulumi.Input[_builtins.str]):
...
class ManagedSmtp(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="allowFallbackViaMissionControl")
    def allow_fallback_via_mission_control(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        If true, we will send e-mails via Mission Control in case of problems with SMTP server.
        """
        return pulumi.get(self, "allow_fallback_via_mission_control")
    ...
    @_builtins.property
    @pulumi.getter(name="connectionSecurity")
    def connection_security(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Connection security, possible values: `NO_ENCRYPTION`, `OPTIONAL_STARTTLS`, `REQUIRE_STARTTLS`, `TLS`. Default: `NO_ENCRYPTION`
        """
        return pulumi.get(self, "connection_security")
    ...
    @_builtins.property
    @pulumi.getter(name="isPasswordConfigured")
    def is_password_configured(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        If true, a password has been configured. Default: `false`.
        """
        return pulumi.get(self, "is_password_configured")
    ...
    @_builtins.property
    @pulumi.getter(name="senderEmailAddress")
    def sender_email_address(self) -> pulumi.Output[_builtins.str]:
        """
        Sender email address
        """
        return pulumi.get(self, "sender_email_address")
    ...
    @_builtins.property
    @pulumi.getter(name="useSmtpServer")
    def use_smtp_server(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        If true, we will send e-mails via SMTP server.
        """
        return pulumi.get(self, "use_smtp_server")
