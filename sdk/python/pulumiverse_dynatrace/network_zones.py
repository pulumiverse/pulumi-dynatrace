...
class NetworkZonesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enabled: Network Zones are enabled (`true`) or disabled (`false`)
        """
...
class NetworkZones(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'NetworkZones':
        """
