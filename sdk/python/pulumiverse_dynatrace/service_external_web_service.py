...
class ServiceExternalWebServiceArgs:
    def __init__(__self__, *,
                 ...
                 conditions: pulumi.Input[Optional['ServiceExternalWebServiceConditionsArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def conditions(self) -> pulumi.Input[Optional['ServiceExternalWebServiceConditionsArgs']]:
        """
    ...
    @conditions.setter
    def conditions(self, value: pulumi.Input[Optional['ServiceExternalWebServiceConditionsArgs']]):
...
class _ServiceExternalWebServiceState:
    def __init__(__self__, *,
                 ...
                 id_contributors: pulumi.Input[Optional['ServiceExternalWebServiceIdContributorsArgs']] = None,
                 insert_after: pulumi.Input[Optional[_builtins.str]] = None,
                 management_zones: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="idContributors")
    def id_contributors(self) -> pulumi.Input[Optional['ServiceExternalWebServiceIdContributorsArgs']]:
        """
        Contributors to the Service Identifier calculation. URL path is always applied as an Id Contributor. You can exclude the port contribution by disabling the switch.
        """
        return pulumi.get(self, "id_contributors")
    ...
    @id_contributors.setter
    def id_contributors(self, value: pulumi.Input[Optional['ServiceExternalWebServiceIdContributorsArgs']]):
        pulumi.set(self, "id_contributors", value)
...
@pulumi.type_token("dynatrace:index/serviceExternalWebService:ServiceExternalWebService")
class ServiceExternalWebService(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 conditions: pulumi.Input[Optional[Union['ServiceExternalWebServiceConditionsArgs', 'ServiceExternalWebServiceConditionsArgsDict']]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 id_contributors: pulumi.Input[Optional[Union['ServiceExternalWebServiceIdContributorsArgs', 'ServiceExternalWebServiceIdContributorsArgsDict']]] = None,
                 insert_after: pulumi.Input[Optional[_builtins.str]] = None,
                 management_zones: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
    ...
    def get(resource_name: str,
            ...
            insert_after: pulumi.Input[Optional[_builtins.str]] = None,
            management_zones: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None) -> 'ServiceExternalWebService':
        """
