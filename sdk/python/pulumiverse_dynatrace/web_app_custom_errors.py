...
class WebAppCustomErrorsArgs:
    ...
    def ignore_custom_errors_in_apdex_calculation(self) -> pulumi.Input[_builtins.bool]:
        """
    ...
    def ignore_custom_errors_in_apdex_calculation(self, value: pulumi.Input[_builtins.bool]):
...
class WebAppCustomErrors(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="ignoreCustomErrorsInApdexCalculation")
    def ignore_custom_errors_in_apdex_calculation(self) -> pulumi.Output[_builtins.bool]:
        """
        (Field has overlap with `ApplicationErrorRules`) This setting overrides Apdex settings for individual rules listed below
        """
        return pulumi.get(self, "ignore_custom_errors_in_apdex_calculation")
