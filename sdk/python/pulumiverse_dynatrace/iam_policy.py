...
class IamPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account: The UUID of the account (`urn:dtaccount:<account-uuid>`) in case the policy should be applied to all environments of this account. The prefix `urn:dtaccount:` MUST be omitted here.
...
class _IamPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] statement_query: The Statement Query of the policy
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: Tags for this policy
        :param pulumi.Input[builtins.str] uuid: The ID of this resource is a concatenation of multiple pieces of information (policy UUID, accountID, environmentID, ...). There are use cases where you JUST need the UUID of the Policy, though
        """
        if account is not None:
            pulumi.set(__self__, "account", account)
        if description is not None:
...
class IamPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            statement_query: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            uuid: Optional[pulumi.Input[builtins.str]] = None) -> 'IamPolicy':
        """
