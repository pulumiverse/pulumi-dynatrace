...
class ProcessVisibilityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] max_processes: The maximum amount of processes that host may report is **100**
    ...
    def max_processes(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    def max_processes(self, value: pulumi.Input[_builtins.int]):
...
class ProcessVisibility(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        - `terraform-provider-dynatrace -export ProcessVisibility` downloads all existing process instance snapshots configuration
    ...
    @_builtins.property
    @pulumi.getter(name="maxProcesses")
    def max_processes(self) -> pulumi.Output[_builtins.int]:
        """
        The maximum amount of processes that host may report is **100**
        """
        return pulumi.get(self, "max_processes")
