...
class ProcessVisibilityArgs:
    def __init__(__self__, *,
                 ...
                 max_processes: pulumi.Input[builtins.int],
        ...
        :param pulumi.Input[builtins.int] max_processes: The maximum amount of processes that host may report is **100**
    ...
    def max_processes(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def max_processes(self, value: pulumi.Input[builtins.int]):
...
class _ProcessVisibilityState:
    def __init__(__self__, *,
                 ...
                 max_processes: Optional[pulumi.Input[builtins.int]] = None,
                 scope: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="maxProcesses")
    def max_processes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum amount of processes that host may report is **100**
        """
        return pulumi.get(self, "max_processes")
    ...
    @max_processes.setter
    def max_processes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_processes", value)
...
class ProcessVisibility(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            enabled: Optional[pulumi.Input[builtins.bool]] = None,
            max_processes: Optional[pulumi.Input[builtins.int]] = None,
            scope: Optional[pulumi.Input[builtins.str]] = None) -> 'ProcessVisibility':
        """
    ...
    @property
    @pulumi.getter(name="maxProcesses")
    def max_processes(self) -> pulumi.Output[builtins.int]:
        """
        The maximum amount of processes that host may report is **100**
        """
        return pulumi.get(self, "max_processes")
