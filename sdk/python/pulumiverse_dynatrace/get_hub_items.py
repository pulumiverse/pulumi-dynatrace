...
class GetHubItemsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def artifacts(self) -> Mapping[str, _builtins.str]:
        """
...
def get_hub_items(type: Optional[_builtins.str] = None,
    ...
    :param _builtins.str type: Represents the type of item. It can be `TECHNOLOGY`, `EXTENSION1` or `EXTENSION2`. If not specified, no restriction regarding type happens
    """
    __args__ = dict()
    __args__['type'] = type
