...
class RequestNamingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['RequestNamingPlaceholdersArgs'] placeholders: The list of custom placeholders to be used in the naming pattern. 
    ...
    def naming_pattern(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def naming_pattern(self, value: pulumi.Input[_builtins.str]):
...
class RequestNaming(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="namingPattern")
    def naming_pattern(self) -> pulumi.Output[_builtins.str]:
        """
        The name to be assigned to matching requests
        """
        return pulumi.get(self, "naming_pattern")
