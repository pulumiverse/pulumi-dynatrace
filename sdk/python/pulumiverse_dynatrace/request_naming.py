...
class RequestNamingArgs:
    def __init__(__self__, *,
                 ...
                 naming_pattern: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] naming_pattern: The name to be assigned to matching requests
        :param pulumi.Input[builtins.bool] enabled: The rule is enabled (`true`) or disabled (`false`)
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] management_zones: Specifies the management zones for which this rule should be applied
    ...
    def naming_pattern(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def naming_pattern(self, value: pulumi.Input[builtins.str]):
...
class _RequestNamingState:
    def __init__(__self__, *,
                 ...
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 management_zones: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 naming_pattern: Optional[pulumi.Input[builtins.str]] = None,
                 placeholders: Optional[pulumi.Input['RequestNamingPlaceholdersArgs']] = None,
                 unknowns: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="namingPattern")
    def naming_pattern(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name to be assigned to matching requests
        """
        return pulumi.get(self, "naming_pattern")
    ...
    @naming_pattern.setter
    def naming_pattern(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "naming_pattern", value)
...
class RequestNaming(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            naming_pattern: Optional[pulumi.Input[builtins.str]] = None,
            placeholders: Optional[pulumi.Input[Union['RequestNamingPlaceholdersArgs', 'RequestNamingPlaceholdersArgsDict']]] = None,
            unknowns: Optional[pulumi.Input[builtins.str]] = None) -> 'RequestNaming':
        """
    ...
    @property
    @pulumi.getter(name="namingPattern")
    def naming_pattern(self) -> pulumi.Output[builtins.str]:
        """
        The name to be assigned to matching requests
        """
        return pulumi.get(self, "naming_pattern")
