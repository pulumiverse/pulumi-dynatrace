...
class AutomationBusinessCalendarArgs:
    def __init__(__self__, *,
                 ...
                 week_days: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
        ...
        :param pulumi.Input[builtins.str] title: The title / name of the Business Calendar
        :param pulumi.Input[builtins.str] description: An optional description for the Business Calendar
        :param pulumi.Input['AutomationBusinessCalendarHolidaysArgs'] holidays: A list of holidays valid in this calendar
        :param pulumi.Input[builtins.str] valid_from: The date from when on this calendar is valid from. Example: `2023-07-04` for July 4th 2023
        :param pulumi.Input[builtins.str] valid_to: The date until when on this calendar is valid to. Example: `2023-07-04` for July 4th 2023
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] week_days: The days to be considered week days in this calendar. `1' =`Monday`,`2`=`Tuesday`,`3`=`Wednesday`,`4`=`Thursday`,`5`=`Friday`,`6`=`Saturday`,`7`=`Sunday`
        :param pulumi.Input[builtins.int] week_start: Specifies the day of the week that's considered to be the first day in the week. `1` for Monday, `7` for Sunday
        """
    ...
    def week_days(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
    ...
    @week_days.setter
    def week_days(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
...
class AutomationBusinessCalendar(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            valid_to: Optional[pulumi.Input[builtins.str]] = None,
            week_days: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
            week_start: Optional[pulumi.Input[builtins.int]] = None) -> 'AutomationBusinessCalendar':
        """
    ...
    @property
    @pulumi.getter(name="weekDays")
    def week_days(self) -> pulumi.Output[Optional[Sequence[builtins.int]]]:
        """
        The days to be considered week days in this calendar. `1' =`Monday`,`2`=`Tuesday`,`3`=`Wednesday`,`4`=`Thursday`,`5`=`Friday`,`6`=`Saturday`,`7`=`Sunday`
        """
        return pulumi.get(self, "week_days")
    ...
    @property
    @pulumi.getter(name="weekStart")
    def week_start(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Specifies the day of the week that's considered to be the first day in the week. `1` for Monday, `7` for Sunday
        """
        return pulumi.get(self, "week_start")
