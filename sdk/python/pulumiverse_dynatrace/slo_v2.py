...
class SloV2Args:
    def __init__(__self__, *,
                 ...
                 evaluation_type: pulumi.Input[builtins.str],
                 evaluation_window: pulumi.Input[builtins.str],
                 filter: pulumi.Input[builtins.str],
                 metric_expression: pulumi.Input[builtins.str],
                 target_success: pulumi.Input[builtins.float],
                 target_warning: pulumi.Input[builtins.float],
        ...
        :param pulumi.Input[builtins.str] evaluation_type: Possible Values: `AGGREGATE`
        :param pulumi.Input[builtins.str] evaluation_window: Define the timeframe during which the SLO is to be evaluated. For the timeframe you can enter expressions like -1h (last hour), -1w (last week) or complex expressions like -2d to now (last two days), -1d/d to now/d (beginning of yesterday to beginning of today).
        :param pulumi.Input[builtins.str] filter: Set a filter parameter (entitySelector) on any GET call to evaluate this SLO against specific services only (for example, type("SERVICE")).  For details, see the [Entity Selector documentation](https://dt-url.net/entityselector).
        :param pulumi.Input[builtins.str] metric_expression: For details, see the [Metrics page](https://www.terraform.io/ui/metrics).
        :param pulumi.Input[builtins.float] target_success: Set the target value of the SLO. A percentage below this value indicates a failure.
        :param pulumi.Input[builtins.float] target_warning: Set the warning value of the SLO. At the warning state the SLO is fulfilled. However, it is getting close to a failure.
        :param pulumi.Input[builtins.str] custom_description: The description of the SLO
        :param pulumi.Input[builtins.str] legacy_id: The ID of this setting when referred to by the Config REST API V1
        :param pulumi.Input[builtins.str] metric_name: Metric name
        :param pulumi.Input[builtins.str] name: SLO name
        """
    ...
    def evaluation_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def evaluation_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "evaluation_type", value)

    @property
    @pulumi.getter(name="evaluationWindow")
    def evaluation_window(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def evaluation_window(self, value: pulumi.Input[builtins.str]):
    ...
    def metric_expression(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def metric_expression(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "metric_expression", value)

    @property
    @pulumi.getter(name="targetSuccess")
    def target_success(self) -> pulumi.Input[builtins.float]:
        """
    ...
    def target_success(self, value: pulumi.Input[builtins.float]):
        pulumi.set(self, "target_success", value)

    @property
    @pulumi.getter(name="targetWarning")
    def target_warning(self) -> pulumi.Input[builtins.float]:
        """
    ...
    def target_warning(self, value: pulumi.Input[builtins.float]):
...
class _SloV2State:
    def __init__(__self__, *,
                 ...
                 evaluation_type: Optional[pulumi.Input[builtins.str]] = None,
                 evaluation_window: Optional[pulumi.Input[builtins.str]] = None,
                 filter: Optional[pulumi.Input[builtins.str]] = None,
                 legacy_id: Optional[pulumi.Input[builtins.str]] = None,
                 metric_expression: Optional[pulumi.Input[builtins.str]] = None,
                 metric_name: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 target_success: Optional[pulumi.Input[builtins.float]] = None,
                 target_warning: Optional[pulumi.Input[builtins.float]] = None):
        """
    ...
    @property
    @pulumi.getter(name="evaluationType")
    def evaluation_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Possible Values: `AGGREGATE`
        """
        return pulumi.get(self, "evaluation_type")
    ...
    @evaluation_type.setter
    def evaluation_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "evaluation_type", value)

    @property
    @pulumi.getter(name="evaluationWindow")
    def evaluation_window(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Define the timeframe during which the SLO is to be evaluated. For the timeframe you can enter expressions like -1h (last hour), -1w (last week) or complex expressions like -2d to now (last two days), -1d/d to now/d (beginning of yesterday to beginning of today).
        """
        return pulumi.get(self, "evaluation_window")
    ...
    @evaluation_window.setter
    def evaluation_window(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "evaluation_window", value)
    ...
    @property
    @pulumi.getter(name="metricExpression")
    def metric_expression(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        For details, see the [Metrics page](https://www.terraform.io/ui/metrics).
        """
        return pulumi.get(self, "metric_expression")
    ...
    @metric_expression.setter
    def metric_expression(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "metric_expression", value)
    ...
    @property
    @pulumi.getter(name="targetSuccess")
    def target_success(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Set the target value of the SLO. A percentage below this value indicates a failure.
        """
        return pulumi.get(self, "target_success")
    ...
    @target_success.setter
    def target_success(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "target_success", value)

    @property
    @pulumi.getter(name="targetWarning")
    def target_warning(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Set the warning value of the SLO. At the warning state the SLO is fulfilled. However, it is getting close to a failure.
        """
        return pulumi.get(self, "target_warning")
    ...
    @target_warning.setter
    def target_warning(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "target_warning", value)
...
class SloV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            target_success: Optional[pulumi.Input[builtins.float]] = None,
            target_warning: Optional[pulumi.Input[builtins.float]] = None) -> 'SloV2':
        """
    ...
    @property
    @pulumi.getter(name="evaluationType")
    def evaluation_type(self) -> pulumi.Output[builtins.str]:
        """
        Possible Values: `AGGREGATE`
        """
        return pulumi.get(self, "evaluation_type")
    ...
    @property
    @pulumi.getter(name="evaluationWindow")
    def evaluation_window(self) -> pulumi.Output[builtins.str]:
        """
        Define the timeframe during which the SLO is to be evaluated. For the timeframe you can enter expressions like -1h (last hour), -1w (last week) or complex expressions like -2d to now (last two days), -1d/d to now/d (beginning of yesterday to beginning of today).
        """
        return pulumi.get(self, "evaluation_window")
    ...
    @property
    @pulumi.getter(name="metricExpression")
    def metric_expression(self) -> pulumi.Output[builtins.str]:
        """
        For details, see the [Metrics page](https://www.terraform.io/ui/metrics).
        """
        return pulumi.get(self, "metric_expression")
    ...
    @property
    @pulumi.getter(name="targetSuccess")
    def target_success(self) -> pulumi.Output[builtins.float]:
        """
        Set the target value of the SLO. A percentage below this value indicates a failure.
        """
        return pulumi.get(self, "target_success")
    ...
    @property
    @pulumi.getter(name="targetWarning")
    def target_warning(self) -> pulumi.Output[builtins.float]:
        """
        Set the warning value of the SLO. At the warning state the SLO is fulfilled. However, it is getting close to a failure.
        """
        return pulumi.get(self, "target_warning")
