...
class OneagentFeaturesArgs:
    def __init__(__self__, *,
                 ...
                 forcible: Optional[pulumi.Input[builtins.bool]] = None,
                 instrumentation: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] key: Feature
        :param pulumi.Input[builtins.bool] forcible: Activate this feature also in OneAgents only fulfilling the minimum Opt-In version
        :param pulumi.Input[builtins.bool] instrumentation: Instrumentation enabled (change needs a process restart)
    ...
    @property
    @pulumi.getter
    def forcible(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @forcible.setter
    def forcible(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "forcible", value)

    @property
    @pulumi.getter
    def instrumentation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def instrumentation(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _OneagentFeaturesState:
    def __init__(__self__, *,
                 _restore_: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter
    def _restore_(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "_restore_")

    @_restore_.setter
    def _restore_(self, value: Optional[pulumi.Input[builtins.str]]):
...
class OneagentFeatures(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instrumentation: Optional[pulumi.Input[builtins.bool]] = None,
            key: Optional[pulumi.Input[builtins.str]] = None,
            scope: Optional[pulumi.Input[builtins.str]] = None) -> 'OneagentFeatures':
        """
    ...
    @property
    @pulumi.getter
    def _restore_(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "_restore_")
    ...
    @property
    @pulumi.getter
    def forcible(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Activate this feature also in OneAgents only fulfilling the minimum Opt-In version
        """
        return pulumi.get(self, "forcible")
    ...
    @property
    @pulumi.getter
    def instrumentation(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Instrumentation enabled (change needs a process restart)
        """
        return pulumi.get(self, "instrumentation")
