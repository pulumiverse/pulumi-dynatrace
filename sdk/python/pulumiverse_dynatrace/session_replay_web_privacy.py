...
class SessionReplayWebPrivacyArgs:
    def __init__(__self__, *,
                 enable_opt_in_mode: pulumi.Input[builtins.bool],
                 masking_presets: pulumi.Input['SessionReplayWebPrivacyMaskingPresetsArgs'],
                 application_id: Optional[pulumi.Input[builtins.str]] = None,
                 url_exclusion_pattern_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a SessionReplayWebPrivacy resource.
        :param pulumi.Input[builtins.bool] enable_opt_in_mode: (Field has overlap with `ApplicationDataPrivacy`) When [Session Replay opt-in mode](https://dt-url.net/sr-opt-in-mode) is turned on, Session Replay is deactivated until explicitly activated via an API call.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] url_exclusion_pattern_lists: (Field has overlap with `ApplicationDataPrivacy`) Exclude webpages or views from Session Replay recording by adding [URL exclusion rules](https://dt-url.net/sr-url-exclusion)
        """
    ...
    def enable_opt_in_mode(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def enable_opt_in_mode(self, value: pulumi.Input[builtins.bool]):
    ...
    def url_exclusion_pattern_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def url_exclusion_pattern_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _SessionReplayWebPrivacyState:
    def __init__(__self__, *,
                 application_id: Optional[pulumi.Input[builtins.str]] = None,
                 enable_opt_in_mode: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="enableOptInMode")
    def enable_opt_in_mode(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Field has overlap with `ApplicationDataPrivacy`) When [Session Replay opt-in mode](https://dt-url.net/sr-opt-in-mode) is turned on, Session Replay is deactivated until explicitly activated via an API call.
        """
        return pulumi.get(self, "enable_opt_in_mode")
    ...
    @enable_opt_in_mode.setter
    def enable_opt_in_mode(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_opt_in_mode", value)
...
class SessionReplayWebPrivacy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            enable_opt_in_mode: Optional[pulumi.Input[builtins.bool]] = None,
            masking_presets: Optional[pulumi.Input[Union['SessionReplayWebPrivacyMaskingPresetsArgs', 'SessionReplayWebPrivacyMaskingPresetsArgsDict']]] = None,
            url_exclusion_pattern_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'SessionReplayWebPrivacy':
        """
    ...
    @property
    @pulumi.getter(name="enableOptInMode")
    def enable_opt_in_mode(self) -> pulumi.Output[builtins.bool]:
        """
        (Field has overlap with `ApplicationDataPrivacy`) When [Session Replay opt-in mode](https://dt-url.net/sr-opt-in-mode) is turned on, Session Replay is deactivated until explicitly activated via an API call.
        """
        return pulumi.get(self, "enable_opt_in_mode")
    ...
    @property
    @pulumi.getter(name="urlExclusionPatternLists")
    def url_exclusion_pattern_lists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        (Field has overlap with `ApplicationDataPrivacy`) Exclude webpages or views from Session Replay recording by adding [URL exclusion rules](https://dt-url.net/sr-url-exclusion)
        """
        return pulumi.get(self, "url_exclusion_pattern_lists")
