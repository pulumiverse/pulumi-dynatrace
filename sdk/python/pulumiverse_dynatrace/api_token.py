...
class ApiTokenArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] last_used_date: Token last used date in ISO 8601 format (yyyy-MM-dd'T'HH:mm:ss.SSS'Z')
        :param pulumi.Input[_builtins.str] last_used_ip_address: Token last used IP address.
        :param pulumi.Input[_builtins.str] modified_date: Token last modified date in ISO 8601 format (yyyy-MM-dd'T'HH:mm:ss.SSS'Z').
        :param pulumi.Input[_builtins.str] name: The name of the token.
        :param pulumi.Input[_builtins.str] owner: The owner of the token
        :param pulumi.Input[_builtins.bool] personal_access_token: The token is a personal access token (true) or an API token (false).
        """
...
class ApiToken(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="lastUsedDate")
    def last_used_date(self) -> pulumi.Output[_builtins.str]:
        """
        Token last used date in ISO 8601 format (yyyy-MM-dd'T'HH:mm:ss.SSS'Z')
        """
        return pulumi.get(self, "last_used_date")
    ...
    @_builtins.property
    @pulumi.getter(name="lastUsedIpAddress")
    def last_used_ip_address(self) -> pulumi.Output[_builtins.str]:
        """
        Token last used IP address.
        """
        return pulumi.get(self, "last_used_ip_address")
    ...
    @_builtins.property
    @pulumi.getter(name="personalAccessToken")
    def personal_access_token(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        The token is a personal access token (true) or an API token (false).
        """
        return pulumi.get(self, "personal_access_token")
