...
class DiskOptionsArgs:
    def __init__(__self__, *,
                 disable_nfs_disk_monitoring: Optional[pulumi.Input[builtins.bool]] = None,
                 exclusions: Optional[pulumi.Input['DiskOptionsExclusionsArgs']] = None,
                 nfs_show_all: Optional[pulumi.Input[builtins.bool]] = None,
                 scope: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a DiskOptions resource.
        :param pulumi.Input[builtins.bool] disable_nfs_disk_monitoring: Deactivate NFS monitoring on all supported systems
        ...
        :param pulumi.Input[builtins.bool] nfs_show_all: When disabled OneAgent will try to deduplicate some of nfs disks. Disabled by default, applies only to Linux hosts.
    ...
    def disable_nfs_disk_monitoring(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def disable_nfs_disk_monitoring(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def nfs_show_all(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @nfs_show_all.setter
    def nfs_show_all(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.type_token("dynatrace:index/diskOptions:DiskOptions")
class DiskOptions(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            exclusions: Optional[pulumi.Input[Union['DiskOptionsExclusionsArgs', 'DiskOptionsExclusionsArgsDict']]] = None,
            nfs_show_all: Optional[pulumi.Input[builtins.bool]] = None,
            scope: Optional[pulumi.Input[builtins.str]] = None) -> 'DiskOptions':
        """
    ...
    @property
    @pulumi.getter(name="disableNfsDiskMonitoring")
    def disable_nfs_disk_monitoring(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Deactivate NFS monitoring on all supported systems
        """
        return pulumi.get(self, "disable_nfs_disk_monitoring")
    ...
    @property
    @pulumi.getter(name="nfsShowAll")
    def nfs_show_all(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When disabled OneAgent will try to deduplicate some of nfs disks. Disabled by default, applies only to Linux hosts.
        Requires OneAgent 1.209 or later
        """
