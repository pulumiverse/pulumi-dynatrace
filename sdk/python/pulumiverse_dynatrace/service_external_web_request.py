...
class ServiceExternalWebRequestArgs:
    def __init__(__self__, *,
                 ...
                 management_zones: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] management_zones: Define a management zone of the process group for which this service detection rule should be created.  Note: in case of external requests/services the PG might not always be known. See [here](https://dt-url.net/9i03b79)
    ...
    def management_zones(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def management_zones(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
@pulumi.type_token("dynatrace:index/serviceExternalWebRequest:ServiceExternalWebRequest")
class ServiceExternalWebRequest(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            insert_after: Optional[pulumi.Input[builtins.str]] = None,
            management_zones: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'ServiceExternalWebRequest':
        """
    ...
    @property
    @pulumi.getter(name="managementZones")
    def management_zones(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Define a management zone of the process group for which this service detection rule should be created.  Note: in case of external requests/services the PG might not always be known. See [here](https://dt-url.net/9i03b79)
        """
        return pulumi.get(self, "management_zones")
