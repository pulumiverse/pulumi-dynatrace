...
def get_credentials(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the credential as shown within the Dynatrace WebUI. If not specified all names will match
    :param builtins.str scope: The scope of the credential. Possible values are `ALL`, `EXTENSION` and `SYNTHETIC`. If not specified all scopes will match.
    :param builtins.str type: The type of the credential. Possible values are `CERTIFICATE`, `PUBLIC_CERTIFICATE`, `TOKEN`, `USERNAME_PASSWORD` and `UNKNOWN`. If not specified all credential types will match
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_credentials_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
