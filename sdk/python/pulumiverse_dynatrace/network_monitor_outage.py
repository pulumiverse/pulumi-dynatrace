...
class NetworkMonitorOutageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] global_outages: Generate a problem and send an alert when the monitor is unavailable at all configured locations.
        :param pulumi.Input[bool] local_outages: Generate a problem and send an alert when the monitor is unavailable for one or more consecutive runs at any location.
        :param pulumi.Input[int] global_consecutive_outage_count_threshold: Alert if all locations are unable to access my target address
        :param pulumi.Input[int] local_consecutive_outage_count_threshold: are unable to access my target address
        :param pulumi.Input[int] local_location_outage_count_threshold: Alert if at least
        :param pulumi.Input[str] scope: The scope of this setting (MULTIPROTOCOL_MONITOR). Omit this property if you want to cover the whole environment.
        """
...
class NetworkMonitorOutage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            local_location_outage_count_threshold: Optional[pulumi.Input[int]] = None,
            local_outages: Optional[pulumi.Input[bool]] = None,
            scope: Optional[pulumi.Input[str]] = None) -> 'NetworkMonitorOutage':
        """
