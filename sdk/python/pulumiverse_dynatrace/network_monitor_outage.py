...
class NetworkMonitorOutageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] local_location_outage_count_threshold: Alert if at least
        :param pulumi.Input[_builtins.str] scope: The scope of this setting (MULTIPROTOCOL_MONITOR). Omit this property if you want to cover the whole environment.
        """
