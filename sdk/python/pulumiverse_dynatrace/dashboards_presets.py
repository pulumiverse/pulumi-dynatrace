...
class DashboardsPresetsArgs:
    def __init__(__self__, *,
                 enable_dashboard_presets: pulumi.Input[builtins.bool],
        ...
        :param pulumi.Input[builtins.bool] enable_dashboard_presets: Dashboard presets are visible to all users by default. For a pristine environment you may disable them entirely or opt to manually limit visibility to selected user groups.
    ...
    def enable_dashboard_presets(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def enable_dashboard_presets(self, value: pulumi.Input[builtins.bool]):
...
class _DashboardsPresetsState:
    def __init__(__self__, *,
                 dashboard_presets_list: Optional[pulumi.Input['DashboardsPresetsDashboardPresetsListArgs']] = None,
                 enable_dashboard_presets: Optional[pulumi.Input[builtins.bool]] = None):
        """
    ...
    @property
    @pulumi.getter(name="enableDashboardPresets")
    def enable_dashboard_presets(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Dashboard presets are visible to all users by default. For a pristine environment you may disable them entirely or opt to manually limit visibility to selected user groups.
        """
        return pulumi.get(self, "enable_dashboard_presets")
    ...
    @enable_dashboard_presets.setter
    def enable_dashboard_presets(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_dashboard_presets", value)
...
class DashboardsPresets(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            dashboard_presets_list: Optional[pulumi.Input[Union['DashboardsPresetsDashboardPresetsListArgs', 'DashboardsPresetsDashboardPresetsListArgsDict']]] = None,
            enable_dashboard_presets: Optional[pulumi.Input[builtins.bool]] = None) -> 'DashboardsPresets':
        """
    ...
    @property
    @pulumi.getter(name="enableDashboardPresets")
    def enable_dashboard_presets(self) -> pulumi.Output[builtins.bool]:
        """
        Dashboard presets are visible to all users by default. For a pristine environment you may disable them entirely or opt to manually limit visibility to selected user groups.
        """
        return pulumi.get(self, "enable_dashboard_presets")
