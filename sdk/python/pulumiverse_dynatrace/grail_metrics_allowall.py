...
class GrailMetricsAllowallArgs:
    def __init__(__self__, *,
                 allow_all: pulumi.Input[builtins.bool]):
        """
        The set of arguments for constructing a GrailMetricsAllowall resource.
        :param pulumi.Input[builtins.bool] allow_all: When enabled every custom metric will be ingested to Grail. Warning: this setting can cause [unexpected billing!](https://docs.dynatrace.com/docs/dynatrace-api/environment-api/metric-v2/best-practices#avoid-high-cardinality-limits)
        """
        pulumi.set(__self__, "allow_all", allow_all)

    @property
    @pulumi.getter(name="allowAll")
    def allow_all(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @allow_all.setter
    def allow_all(self, value: pulumi.Input[builtins.bool]):
...
@pulumi.type_token("dynatrace:index/grailMetricsAllowall:GrailMetricsAllowall")
class GrailMetricsAllowall(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            allow_all: Optional[pulumi.Input[builtins.bool]] = None) -> 'GrailMetricsAllowall':
        """
    ...
    @property
    @pulumi.getter(name="allowAll")
    def allow_all(self) -> pulumi.Output[builtins.bool]:
        """
        When enabled every custom metric will be ingested to Grail. Warning: this setting can cause [unexpected billing!](https://docs.dynatrace.com/docs/dynatrace-api/environment-api/metric-v2/best-practices#avoid-high-cardinality-limits)
        """
        return pulumi.get(self, "allow_all")
