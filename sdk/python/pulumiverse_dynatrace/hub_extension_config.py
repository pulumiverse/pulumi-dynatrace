...
class HubExtensionConfigArgs:
    def __init__(__self__, *,
                 ...
                 host_group: Optional[pulumi.Input[builtins.str]] = None,
                 management_zone: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a HubExtensionConfig resource.
        :param pulumi.Input[builtins.str] value: The JSON encoded value for this monitoring configuration
        :param pulumi.Input[builtins.str] active_gate_group: The name of the Active Gate Group this monitoring configuration will be defined for
        :param pulumi.Input[builtins.str] host: The ID of the host this monitoring configuration will be defined for
        :param pulumi.Input[builtins.str] host_group: The ID of the host group this monitoring configuration will be defined for
        :param pulumi.Input[builtins.str] management_zone: The name of the Management Zone this monitoring configuration will be defined for
        :param pulumi.Input[builtins.str] name: The fully qualified name of the extension, such as `com.dynatrace.extension.jmx-liberty-cp`. You can query for these names using the data source `get_hub_items`
        """
    ...
    def host_group(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @host_group.setter
    def host_group(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "host_group", value)

    @property
    @pulumi.getter(name="managementZone")
    def management_zone(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def management_zone(self, value: Optional[pulumi.Input[builtins.str]]):
...
class HubExtensionConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            management_zone: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'HubExtensionConfig':
        """
    ...
    @property
    @pulumi.getter(name="hostGroup")
    def host_group(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the host group this monitoring configuration will be defined for
        """
        return pulumi.get(self, "host_group")
    ...
    @property
    @pulumi.getter(name="managementZone")
    def management_zone(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the Management Zone this monitoring configuration will be defined for
        """
        return pulumi.get(self, "management_zone")
