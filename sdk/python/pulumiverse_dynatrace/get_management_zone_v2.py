...
class GetManagementZoneV2Result:
    ...
    def settings20_id(self) -> builtins.str:
...
def get_management_zone_v2(name: Optional[builtins.str] = None,
...
def get_management_zone_v2_output(name: Optional[pulumi.Input[builtins.str]] = None,
