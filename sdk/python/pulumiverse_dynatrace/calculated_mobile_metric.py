...
class CalculatedMobileMetricArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] metric_key: The unique key of the calculated mobile/custom app metric.
        :param pulumi.Input[builtins.str] metric_type: The type of the metric. Possible values: [ REPORTED*ERROR*COUNT, USER*ACTION*DURATION, WEB*REQUEST*COUNT, WEB*REQUEST*ERROR_COUNT ]
        :param pulumi.Input[builtins.str] description: Descriptor of a calculated mobile/custom app metric.
