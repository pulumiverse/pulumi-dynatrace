...
__all__ = ['OpenpipelineV2SecurityEventsIngestsourcesArgs', 'OpenpipelineV2SecurityEventsIngestsources']

@pulumi.input_type
class OpenpipelineV2SecurityEventsIngestsourcesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['OpenpipelineV2SecurityEventsIngestsourcesMetadataListArgs'] metadata_list: Ingest source metadata list
        :param pulumi.Input[_builtins.str] path_segment: Endpoint segment
        :param pulumi.Input['OpenpipelineV2SecurityEventsIngestsourcesProcessingArgs'] processing: Processing stage
        ...
        :param pulumi.Input['OpenpipelineV2SecurityEventsIngestsourcesStaticRoutingArgs'] static_routing: Static routing of endpoint
        """
...
@pulumi.type_token("dynatrace:index/openpipelineV2SecurityEventsIngestsources:OpenpipelineV2SecurityEventsIngestsources")
class OpenpipelineV2SecurityEventsIngestsources(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        :param pulumi.Input[_builtins.str] display_name: Endpoint display name
        :param pulumi.Input[_builtins.bool] enabled: This setting is enabled (`true`) or disabled (`false`)
        :param pulumi.Input[Union['OpenpipelineV2SecurityEventsIngestsourcesMetadataListArgs', 'OpenpipelineV2SecurityEventsIngestsourcesMetadataListArgsDict']] metadata_list: Ingest source metadata list
        :param pulumi.Input[_builtins.str] path_segment: Endpoint segment
        :param pulumi.Input[Union['OpenpipelineV2SecurityEventsIngestsourcesProcessingArgs', 'OpenpipelineV2SecurityEventsIngestsourcesProcessingArgsDict']] processing: Processing stage
        :param pulumi.Input[_builtins.str] source: Source
        :param pulumi.Input[_builtins.str] source_type: Source Type. Possible Values: `extension`, `http`
        :param pulumi.Input[Union['OpenpipelineV2SecurityEventsIngestsourcesStaticRoutingArgs', 'OpenpipelineV2SecurityEventsIngestsourcesStaticRoutingArgsDict']] static_routing: Static routing of endpoint
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: OpenpipelineV2SecurityEventsIngestsourcesArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        > This resource requires the API token scopes **Read settings** (`settings.read`) and **Write settings** (`settings.write`)
        ...
        :param str resource_name: The name of the resource.
        :param OpenpipelineV2SecurityEventsIngestsourcesArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OpenpipelineV2SecurityEventsIngestsourcesArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = OpenpipelineV2SecurityEventsIngestsourcesArgs.__new__(OpenpipelineV2SecurityEventsIngestsourcesArgs)
        ...
        super(OpenpipelineV2SecurityEventsIngestsources, __self__).__init__(
    ...
    def get(resource_name: str,
        ...
        __props__ = _OpenpipelineV2SecurityEventsIngestsourcesState.__new__(_OpenpipelineV2SecurityEventsIngestsourcesState)
        ...
        __props__.__dict__["source_type"] = source_type
        __props__.__dict__["static_routing"] = static_routing
        return OpenpipelineV2SecurityEventsIngestsources(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="metadataList")
    def metadata_list(self) -> pulumi.Output[Optional['outputs.OpenpipelineV2SecurityEventsIngestsourcesMetadataList']]:
        """
        Ingest source metadata list
        """
        return pulumi.get(self, "metadata_list")
    ...
    @_builtins.property
    @pulumi.getter
    def processing(self) -> pulumi.Output[Optional['outputs.OpenpipelineV2SecurityEventsIngestsourcesProcessing']]:
        """
        Processing stage
        """
        return pulumi.get(self, "processing")
    ...
    @_builtins.property
    @pulumi.getter(name="staticRouting")
    def static_routing(self) -> pulumi.Output[Optional['outputs.OpenpipelineV2SecurityEventsIngestsourcesStaticRouting']]:
        """
        Static routing of endpoint
        """
        return pulumi.get(self, "static_routing")
