...
def get_iam_policies(accounts: Optional[Sequence[_builtins.str]] = None,
    ...
    * The results won't contain any account specific policies if the attribute `accounts` has been omitted
    ...
    :param Sequence[_builtins.str] accounts: The results will contain policies defined for the given accountID. If one of the entries contains `*` the results will contain policies for all accounts
    :param Sequence[_builtins.str] environments: The results will contain policies defined for the given environments. If one of the entries contains `*` the results will contain policies for all environments
    :param _builtins.bool global_: If `true` the results will contain global policies
    :param Sequence[_builtins.str] groups: The results will only contain policies that are bound to the specified groups. Omit this attribute if you want to retrieve all policies
    """
    __args__ = dict()
