...
def get_iam_policies(accounts: Optional[Sequence[builtins.str]] = None,
    ...
    * The results won't contain any account specific policies if the attribute `accounts` has been omitted
    ...
    :param Sequence[builtins.str] accounts: The results will contain policies defined for the given accountID. If one of the entries contains `*` the results will contain policies for all accounts
    :param Sequence[builtins.str] environments: The results will contain policies defined for the given environments. If one of the entries contains `*` the results will contain policies for all environments
    :param builtins.bool global_: If `true` the results will contain global policies
    :param Sequence[builtins.str] groups: The results will only contain policies that are bound to the specified groups. Omit this attribute if you want to retrieve all policies
    """
    __args__ = dict()
...
def get_iam_policies_output(accounts: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                            environments: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                            global_: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
