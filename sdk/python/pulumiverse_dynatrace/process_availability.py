...
class ProcessAvailabilityArgs:
    def __init__(__self__, *,
                 ...
                 minimum_processes: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] minimum_processes: Specify a minimum number of processes matching the monitoring rule. If it's not satisfied, an alert will open.
        :param pulumi.Input[builtins.str] name: Monitoring rule name
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] operating_systems: Select the operating systems on which the monitoring rule should be applied.
    ...
    def minimum_processes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def minimum_processes(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ProcessAvailability(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            operating_systems: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            rules: Optional[pulumi.Input[Union['ProcessAvailabilityRulesArgs', 'ProcessAvailabilityRulesArgsDict']]] = None,
            scope: Optional[pulumi.Input[builtins.str]] = None) -> 'ProcessAvailability':
        """
    ...
    @property
    @pulumi.getter(name="minimumProcesses")
    def minimum_processes(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Specify a minimum number of processes matching the monitoring rule. If it's not satisfied, an alert will open.
        """
        return pulumi.get(self, "minimum_processes")
    ...
    @property
    @pulumi.getter(name="operatingSystems")
    def operating_systems(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Select the operating systems on which the monitoring rule should be applied.
        """
        return pulumi.get(self, "operating_systems")
