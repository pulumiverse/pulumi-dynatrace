...
class InfraopsAppSettingsArgs:
    def __init__(__self__, *,
                 show_monitoring_candidates: pulumi.Input[builtins.bool],
                 show_standalone_hosts: pulumi.Input[builtins.bool],
                 interface_saturation_threshold: Optional[pulumi.Input[builtins.float]] = None):
        """
        The set of arguments for constructing a InfraopsAppSettings resource.
        :param pulumi.Input[builtins.bool] show_monitoring_candidates: When set to true, the app will display monitoring candidates in the Hosts table
        :param pulumi.Input[builtins.bool] show_standalone_hosts: When set to true, the app will display app only hosts in the Hosts table
        :param pulumi.Input[builtins.float] interface_saturation_threshold: (Required v305+) The threshold at which a network device interface is deemed to be saturated.
        """
    ...
    def show_monitoring_candidates(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def show_monitoring_candidates(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "show_monitoring_candidates", value)

    @property
    @pulumi.getter(name="showStandaloneHosts")
    def show_standalone_hosts(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def show_standalone_hosts(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "show_standalone_hosts", value)

    @property
    @pulumi.getter(name="interfaceSaturationThreshold")
    def interface_saturation_threshold(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def interface_saturation_threshold(self, value: Optional[pulumi.Input[builtins.float]]):
...
class _InfraopsAppSettingsState:
    def __init__(__self__, *,
                 interface_saturation_threshold: Optional[pulumi.Input[builtins.float]] = None,
                 show_monitoring_candidates: Optional[pulumi.Input[builtins.bool]] = None,
                 show_standalone_hosts: Optional[pulumi.Input[builtins.bool]] = None):
        """
    ...
    @property
    @pulumi.getter(name="showMonitoringCandidates")
    def show_monitoring_candidates(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When set to true, the app will display monitoring candidates in the Hosts table
        """
        return pulumi.get(self, "show_monitoring_candidates")
    ...
    @show_monitoring_candidates.setter
    def show_monitoring_candidates(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "show_monitoring_candidates", value)

    @property
    @pulumi.getter(name="showStandaloneHosts")
    def show_standalone_hosts(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When set to true, the app will display app only hosts in the Hosts table
        """
        return pulumi.get(self, "show_standalone_hosts")
    ...
    @show_standalone_hosts.setter
    def show_standalone_hosts(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "show_standalone_hosts", value)
...
class InfraopsAppSettings(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            interface_saturation_threshold: Optional[pulumi.Input[builtins.float]] = None,
            show_monitoring_candidates: Optional[pulumi.Input[builtins.bool]] = None,
            show_standalone_hosts: Optional[pulumi.Input[builtins.bool]] = None) -> 'InfraopsAppSettings':
        """
    ...
    @property
    @pulumi.getter(name="interfaceSaturationThreshold")
    def interface_saturation_threshold(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        (Required v305+) The threshold at which a network device interface is deemed to be saturated.
        """
        return pulumi.get(self, "interface_saturation_threshold")
    ...
    @property
    @pulumi.getter(name="showMonitoringCandidates")
    def show_monitoring_candidates(self) -> pulumi.Output[builtins.bool]:
        """
        When set to true, the app will display monitoring candidates in the Hosts table
        """
        return pulumi.get(self, "show_monitoring_candidates")
    ...
    @property
    @pulumi.getter(name="showStandaloneHosts")
    def show_standalone_hosts(self) -> pulumi.Output[builtins.bool]:
        """
        When set to true, the app will display app only hosts in the Hosts table
        """
        return pulumi.get(self, "show_standalone_hosts")
