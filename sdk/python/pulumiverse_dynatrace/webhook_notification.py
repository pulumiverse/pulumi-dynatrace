...
class WebhookNotificationArgs:
    def __init__(__self__, *,
                 ...
                 notify_closed_problems: Optional[pulumi.Input[builtins.bool]] = None,
                 notify_event_merges: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 url_contains_secret: Optional[pulumi.Input[builtins.bool]] = None,
                 use_oauth2: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] insecure: Accept any, including self-signed and invalid, SSL certificate (`true`) or only trusted (`false`) certificates
        ...
        :param pulumi.Input[builtins.bool] notify_closed_problems: Send email if problem is closed
        :param pulumi.Input[builtins.bool] notify_event_merges: Call webhook if new events merge into existing problems
        ...
        :param pulumi.Input[builtins.str] secret_url: The secret URL of the webhook endpoint.
        :param pulumi.Input[builtins.str] url: The URL of the WebHook endpoint
        :param pulumi.Input[builtins.bool] url_contains_secret: Secret webhook URL
        :param pulumi.Input[builtins.bool] use_oauth2: Use OAuth 2.0 for authentication
        """
    ...
    def notify_closed_problems(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def notify_closed_problems(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "notify_closed_problems", value)

    @property
    @pulumi.getter(name="notifyEventMerges")
    def notify_event_merges(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def notify_event_merges(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def url_contains_secret(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Secret webhook URL
        """
    ...
    def url_contains_secret(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "url_contains_secret", value)

    @property
    @pulumi.getter(name="useOauth2")
    def use_oauth2(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @use_oauth2.setter
    def use_oauth2(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class WebhookNotification(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            url: Optional[pulumi.Input[builtins.str]] = None,
            url_contains_secret: Optional[pulumi.Input[builtins.bool]] = None,
            use_oauth2: Optional[pulumi.Input[builtins.bool]] = None) -> 'WebhookNotification':
        """
    ...
    @property
    @pulumi.getter(name="notifyClosedProblems")
    def notify_closed_problems(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Send email if problem is closed
        """
        return pulumi.get(self, "notify_closed_problems")
    ...
    @property
    @pulumi.getter(name="notifyEventMerges")
    def notify_event_merges(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Call webhook if new events merge into existing problems
        """
        return pulumi.get(self, "notify_event_merges")
    ...
    @property
    @pulumi.getter(name="secretUrl")
    def secret_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The secret URL of the webhook endpoint.
        """
        return pulumi.get(self, "secret_url")
    ...
    @property
    @pulumi.getter(name="urlContainsSecret")
    def url_contains_secret(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Secret webhook URL
        """
        return pulumi.get(self, "url_contains_secret")
    ...
    @property
    @pulumi.getter(name="useOauth2")
    def use_oauth2(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Use OAuth 2.0 for authentication
        """
        return pulumi.get(self, "use_oauth2")
