...
class EventDrivenAnsibleConnectionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] url: URL of the Event-Driven Ansible source plugin webhook. For example, https://eda.yourdomain.com:5010
        :param pulumi.Input[builtins.str] name: A unique and clearly identifiable connection name.
        :param pulumi.Input[builtins.str] token: API access token for the Event-Driven Ansible Controller. Please note that this token is not refreshed and can expire.
        """
...
class EventDrivenAnsibleConnections(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            token: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'EventDrivenAnsibleConnections':
        """
