...
class IpAddressMaskingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] scope: The scope of this setting (MOBILE*APPLICATION, CUSTOM*APPLICATION, APPLICATION). Omit this property if you want to cover the whole environment.
        :param pulumi.Input[builtins.str] type: Possible Values: `all`, `public`
        """
...
class IpAddressMasking(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            enabled: Optional[pulumi.Input[builtins.bool]] = None,
            scope: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'IpAddressMasking':
        """
