...
class LogGrailArgs:
    ...
    def parallel_ingest_period(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def parallel_ingest_period(self, value: pulumi.Input[_builtins.str]):
...
class LogGrail(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="parallelIngestPeriod")
    def parallel_ingest_period(self) -> pulumi.Output[_builtins.str]:
        """
        Possible Values: `NONE`, `SEVEN_DAYS`, `THIRTY_FIVE_DAYS`
        """
        return pulumi.get(self, "parallel_ingest_period")
