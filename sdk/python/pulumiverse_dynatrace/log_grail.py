...
class LogGrailArgs:
    def __init__(__self__, *,
                 ...
                 parallel_ingest_period: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a LogGrail resource.
        :param pulumi.Input[builtins.bool] activated: Activate logs powered by Grail.
        :param pulumi.Input[builtins.str] parallel_ingest_period: Possible Values: `NONE`, `SEVEN_DAYS`, `THIRTY_FIVE_DAYS`
        """
    ...
    def parallel_ingest_period(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def parallel_ingest_period(self, value: pulumi.Input[builtins.str]):
...
class _LogGrailState:
    def __init__(__self__, *,
                 ...
                 parallel_ingest_period: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="parallelIngestPeriod")
    def parallel_ingest_period(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Possible Values: `NONE`, `SEVEN_DAYS`, `THIRTY_FIVE_DAYS`
        """
        return pulumi.get(self, "parallel_ingest_period")
    ...
    @parallel_ingest_period.setter
    def parallel_ingest_period(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "parallel_ingest_period", value)
...
class LogGrail(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            activated: Optional[pulumi.Input[builtins.bool]] = None,
            parallel_ingest_period: Optional[pulumi.Input[builtins.str]] = None) -> 'LogGrail':
        """
    ...
    @property
    @pulumi.getter(name="parallelIngestPeriod")
    def parallel_ingest_period(self) -> pulumi.Output[builtins.str]:
        """
        Possible Values: `NONE`, `SEVEN_DAYS`, `THIRTY_FIVE_DAYS`
        """
        return pulumi.get(self, "parallel_ingest_period")
