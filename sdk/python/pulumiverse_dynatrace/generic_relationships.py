...
class GenericRelationshipsArgs:
    def __init__(__self__, *,
                 created_by: pulumi.Input[builtins.str],
                 enabled: pulumi.Input[builtins.bool],
                 from_type: pulumi.Input[builtins.str],
                 sources: pulumi.Input['GenericRelationshipsSourcesArgs'],
                 to_type: pulumi.Input[builtins.str],
                 type_of_relation: pulumi.Input[builtins.str],
                 from_role: Optional[pulumi.Input[builtins.str]] = None,
                 to_role: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a GenericRelationships resource.
        :param pulumi.Input[builtins.str] created_by: The user or extension that created this relationship.
        :param pulumi.Input[builtins.bool] enabled: This setting is enabled (`true`) or disabled (`false`)
        :param pulumi.Input[builtins.str] from_type: Define an entity type as the source of the relationship.
        ...
        :param pulumi.Input[builtins.str] to_type: Define an entity type as the destination of the relationship. You can choose the same type as the source type. In this case you also may assign different roles for source and destination for having directed relationships.
        :param pulumi.Input[builtins.str] type_of_relation: Possible Values: `CALLS`, `CHILD_OF`, `INSTANCE_OF`, `PART_OF`, `RUNS_ON`, `SAME_AS`
        :param pulumi.Input[builtins.str] from_role: Specify a role for the source entity. If both source and destination type are the same, referring different roles will allow identification of a relationships direction. If role is left blank, any role of the source type is considered for the relationship.
        :param pulumi.Input[builtins.str] to_role: Specify a role for the destination entity. If both source and destination type are the same, referring different roles will allow identification of a relationships direction. If role is left blank, any role of the destination type is considered for the relationship.
        """
    ...
    def created_by(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @created_by.setter
    def created_by(self, value: pulumi.Input[builtins.str]):
    ...
    def from_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @from_type.setter
    def from_type(self, value: pulumi.Input[builtins.str]):
    ...
    def to_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @to_type.setter
    def to_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "to_type", value)

    @property
    @pulumi.getter(name="typeOfRelation")
    def type_of_relation(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def type_of_relation(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "type_of_relation", value)

    @property
    @pulumi.getter(name="fromRole")
    def from_role(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @from_role.setter
    def from_role(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "from_role", value)

    @property
    @pulumi.getter(name="toRole")
    def to_role(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @to_role.setter
    def to_role(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _GenericRelationshipsState:
    def __init__(__self__, *,
                 ...
                 from_role: Optional[pulumi.Input[builtins.str]] = None,
                 from_type: Optional[pulumi.Input[builtins.str]] = None,
                 sources: Optional[pulumi.Input['GenericRelationshipsSourcesArgs']] = None,
                 to_role: Optional[pulumi.Input[builtins.str]] = None,
                 to_type: Optional[pulumi.Input[builtins.str]] = None,
                 type_of_relation: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="fromType")
    def from_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Define an entity type as the source of the relationship.
        """
        return pulumi.get(self, "from_type")
    ...
    @from_type.setter
    def from_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "from_type", value)
    ...
    @property
    @pulumi.getter(name="toType")
    def to_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Define an entity type as the destination of the relationship. You can choose the same type as the source type. In this case you also may assign different roles for source and destination for having directed relationships.
        """
        return pulumi.get(self, "to_type")
    ...
    @to_type.setter
    def to_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "to_type", value)

    @property
    @pulumi.getter(name="typeOfRelation")
    def type_of_relation(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Possible Values: `CALLS`, `CHILD_OF`, `INSTANCE_OF`, `PART_OF`, `RUNS_ON`, `SAME_AS`
        """
        return pulumi.get(self, "type_of_relation")
    ...
    @type_of_relation.setter
    def type_of_relation(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "type_of_relation", value)
...
class GenericRelationships(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            to_role: Optional[pulumi.Input[builtins.str]] = None,
            to_type: Optional[pulumi.Input[builtins.str]] = None,
            type_of_relation: Optional[pulumi.Input[builtins.str]] = None) -> 'GenericRelationships':
        """
    ...
    @property
    @pulumi.getter(name="fromRole")
    def from_role(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specify a role for the source entity. If both source and destination type are the same, referring different roles will allow identification of a relationships direction. If role is left blank, any role of the source type is considered for the relationship.
        """
        return pulumi.get(self, "from_role")
    ...
    @property
    @pulumi.getter(name="fromType")
    def from_type(self) -> pulumi.Output[builtins.str]:
        """
        Define an entity type as the source of the relationship.
        """
        return pulumi.get(self, "from_type")
    ...
    @property
    @pulumi.getter(name="toRole")
    def to_role(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specify a role for the destination entity. If both source and destination type are the same, referring different roles will allow identification of a relationships direction. If role is left blank, any role of the destination type is considered for the relationship.
        """
        return pulumi.get(self, "to_role")
    ...
    @property
    @pulumi.getter(name="toType")
    def to_type(self) -> pulumi.Output[builtins.str]:
        """
        Define an entity type as the destination of the relationship. You can choose the same type as the source type. In this case you also may assign different roles for source and destination for having directed relationships.
        """
        return pulumi.get(self, "to_type")
    ...
    @property
    @pulumi.getter(name="typeOfRelation")
    def type_of_relation(self) -> pulumi.Output[builtins.str]:
        """
        Possible Values: `CALLS`, `CHILD_OF`, `INSTANCE_OF`, `PART_OF`, `RUNS_ON`, `SAME_AS`
        """
        return pulumi.get(self, "type_of_relation")
