...
__all__ = ['SecurityContextArgs', 'SecurityContext']
...
class SecurityContext(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SecurityContextArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SecurityContextArgs.__new__(SecurityContextArgs)

            if enabled is None and not opts.urn:
                raise TypeError("Missing required property 'enabled'")
            __props__.__dict__["enabled"] = enabled
        super(SecurityContext, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            enabled: Optional[pulumi.Input[_builtins.bool]] = None) -> 'SecurityContext':
        """
        ...
        __props__ = _SecurityContextState.__new__(_SecurityContextState)

        __props__.__dict__["enabled"] = enabled
        return SecurityContext(resource_name, opts=opts, __props__=__props__)
