...
class CustomDeviceArgs:
    def __init__(__self__, *,
                 ...
                 custom_device_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 listen_ports: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
                 properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 props: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None,
                 ui_based: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a CustomDevice resource.
        :param pulumi.Input[builtins.str] display_name: The name of the custom device, displayed in the UI.
        :param pulumi.Input[builtins.str] config_url: The URL of a configuration web page for the custom device, such as a login page for a firewall or router.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_names: The list of DNS names related to the custom device.
        :param pulumi.Input[builtins.str] favicon_url: The icon to be displayed for your custom component within Smartscape. Provide the full URL of the icon file.
        :param pulumi.Input[builtins.str] group: User defined group of entity. Changing the group requires a new custom device to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_addresses: The list of IP addresses that belong to the custom device.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] listen_ports: The list of ports the custom devices listens to.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: The list of key-value pair properties that will be shown beneath the infographics of your custom device.
        :param pulumi.Input[builtins.str] props: The list of key-value pair properties that will be shown beneath the infographics of your custom device.
        :param pulumi.Input[builtins.str] type: The technology type definition of the custom device.
        :param pulumi.Input[builtins.bool] ui_based: If `true` the custom device will be handled as if it was created via UI. It will be refreshed automatically and won't age out. This attribute is taken into consideration when creating the custom device. Changing it afterwards won't have an effect.
        """
    ...
    def custom_device_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "custom_device_id")

    @custom_device_id.setter
    def custom_device_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def listen_ports(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
    ...
    @listen_ports.setter
    def listen_ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
    ...
    @property
    @pulumi.getter
    def props(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The list of key-value pair properties that will be shown beneath the infographics of your custom device.
        """
    ...
    @props.setter
    def props(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ui_based(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @ui_based.setter
    def ui_based(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _CustomDeviceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: The name of the custom device, displayed in the UI.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_names: The list of DNS names related to the custom device.
        :param pulumi.Input[builtins.str] entity_id: The Dynatrace EntityID of this resource. If you need to refer to this custom device within other resources you want to use this ID
        :param pulumi.Input[builtins.str] favicon_url: The icon to be displayed for your custom component within Smartscape. Provide the full URL of the icon file.
        :param pulumi.Input[builtins.str] group: User defined group of entity. Changing the group requires a new custom device to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_addresses: The list of IP addresses that belong to the custom device.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] listen_ports: The list of ports the custom devices listens to.
...
class CustomDevice(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            props: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            ui_based: Optional[pulumi.Input[builtins.bool]] = None) -> 'CustomDevice':
        """
    ...
    @property
    @pulumi.getter(name="configUrl")
    def config_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The URL of a configuration web page for the custom device, such as a login page for a firewall or router.
        """
        return pulumi.get(self, "config_url")
    ...
    @property
    @pulumi.getter(name="customDeviceId")
    def custom_device_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "custom_device_id")
    ...
    @property
    @pulumi.getter(name="faviconUrl")
    def favicon_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The icon to be displayed for your custom component within Smartscape. Provide the full URL of the icon file.
        """
        return pulumi.get(self, "favicon_url")
    ...
    @property
    @pulumi.getter(name="listenPorts")
    def listen_ports(self) -> pulumi.Output[Optional[Sequence[builtins.int]]]:
        """
        The list of ports the custom devices listens to.
        """
        return pulumi.get(self, "listen_ports")
    ...
    @property
    @pulumi.getter
    def props(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The list of key-value pair properties that will be shown beneath the infographics of your custom device.
        """
        return pulumi.get(self, "props")
    ...
    @property
    @pulumi.getter(name="uiBased")
    def ui_based(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If `true` the custom device will be handled as if it was created via UI. It will be refreshed automatically and won't age out. This attribute is taken into consideration when creating the custom device. Changing it afterwards won't have an effect.
        """
        return pulumi.get(self, "ui_based")
