...
class CustomDeviceArgs:
    def __init__(__self__, *,
                 ...
                 custom_device_id: Optional[pulumi.Input[_builtins.str]] = None,
                 ...
                 listen_ports: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]] = None,
                 properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 props: Optional[pulumi.Input[_builtins.str]] = None,
                 type: Optional[pulumi.Input[_builtins.str]] = None,
                 ui_based: Optional[pulumi.Input[_builtins.bool]] = None):
        """
        The set of arguments for constructing a CustomDevice resource.

        :param pulumi.Input[_builtins.str] display_name: The name of the custom device, displayed in the UI.
        ...
        :param pulumi.Input[_builtins.str] custom_device_id: The unique name of the custom device. This Id can either be provided in the resource or generated by Terraform when the resource is created. If you use the ID of an existing device, the respective parameters will be updated
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] dns_names: The list of DNS names related to the custom device.
        :param pulumi.Input[_builtins.str] favicon_url: The icon to be displayed for your custom component within Smartscape. Provide the full URL of the icon file.
        :param pulumi.Input[_builtins.str] group: User defined group of entity. Changing the group requires a new custom device to be created.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ip_addresses: The list of IP addresses that belong to the custom device.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] listen_ports: The list of ports the custom devices listens to.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] properties: The list of key-value pair properties that will be shown beneath the infographics of your custom device.
        :param pulumi.Input[_builtins.str] props: The list of key-value pair properties that will be shown beneath the infographics of your custom device.
        :param pulumi.Input[_builtins.str] type: The technology type definition of the custom device.
        :param pulumi.Input[_builtins.bool] ui_based: If `true` the custom device will be handled as if it was created via UI. It will be refreshed automatically and won't age out. This attribute is taken into consideration when creating the custom device. Changing it afterwards won't have an effect.
        """
    ...
    def custom_device_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def custom_device_id(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def listen_ports(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]]:
        """
    ...
    @listen_ports.setter
    def listen_ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def props(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The list of key-value pair properties that will be shown beneath the infographics of your custom device.
        """
    ...
    @props.setter
    def props(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def ui_based(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    @ui_based.setter
    def ui_based(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class _CustomDeviceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] display_name: The name of the custom device, displayed in the UI.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] dns_names: The list of DNS names related to the custom device.
        :param pulumi.Input[_builtins.str] entity_id: The Dynatrace EntityID of this resource. If you need to refer to this custom device within other resources you want to use this ID
        :param pulumi.Input[_builtins.str] favicon_url: The icon to be displayed for your custom component within Smartscape. Provide the full URL of the icon file.
        :param pulumi.Input[_builtins.str] group: User defined group of entity. Changing the group requires a new custom device to be created.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ip_addresses: The list of IP addresses that belong to the custom device.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] listen_ports: The list of ports the custom devices listens to.
...
class CustomDevice(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            props: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            ui_based: Optional[pulumi.Input[_builtins.bool]] = None) -> 'CustomDevice':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="configUrl")
    def config_url(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The URL of a configuration web page for the custom device, such as a login page for a firewall or router.
        """
        return pulumi.get(self, "config_url")
    ...
    @_builtins.property
    @pulumi.getter(name="customDeviceId")
    def custom_device_id(self) -> pulumi.Output[_builtins.str]:
        """
        The unique name of the custom device. This Id can either be provided in the resource or generated by Terraform when the resource is created. If you use the ID of an existing device, the respective parameters will be updated
        """
        return pulumi.get(self, "custom_device_id")
    ...
    @_builtins.property
    @pulumi.getter(name="faviconUrl")
    def favicon_url(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The icon to be displayed for your custom component within Smartscape. Provide the full URL of the icon file.
        """
        return pulumi.get(self, "favicon_url")
    ...
    @_builtins.property
    @pulumi.getter(name="listenPorts")
    def listen_ports(self) -> pulumi.Output[Optional[Sequence[_builtins.int]]]:
        """
        The list of ports the custom devices listens to.
        """
        return pulumi.get(self, "listen_ports")
    ...
    @_builtins.property
    @pulumi.getter
    def props(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The list of key-value pair properties that will be shown beneath the infographics of your custom device.
        """
        return pulumi.get(self, "props")
    ...
    @_builtins.property
    @pulumi.getter(name="uiBased")
    def ui_based(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        If `true` the custom device will be handled as if it was created via UI. It will be refreshed automatically and won't age out. This attribute is taken into consideration when creating the custom device. Changing it afterwards won't have an effect.
        """
        return pulumi.get(self, "ui_based")
