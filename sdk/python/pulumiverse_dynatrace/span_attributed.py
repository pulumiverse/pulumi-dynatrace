...
class SpanAttributedArgs:
    def __init__(__self__, *,
                 ...
                 masking: pulumi.Input[builtins.str],
                 persistent: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a SpanAttributed resource.
        :param pulumi.Input[builtins.str] key: Key of the span attribute to store
        :param pulumi.Input[builtins.str] masking: Possible Values: `MASK_ENTIRE_VALUE`, `MASK_ONLY_CONFIDENTIAL_DATA`, `NOT_MASKED`
        """
    ...
    @property
    @pulumi.getter
    def masking(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @masking.setter
    def masking(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "masking", value)

    @property
    @pulumi.getter
    def persistent(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "persistent")

    @persistent.setter
    def persistent(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _SpanAttributedState:
    def __init__(__self__, *,
                 ...
                 masking: Optional[pulumi.Input[builtins.str]] = None,
                 persistent: Optional[pulumi.Input[builtins.bool]] = None):
        """
    ...
    @property
    @pulumi.getter
    def masking(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Possible Values: `MASK_ENTIRE_VALUE`, `MASK_ONLY_CONFIDENTIAL_DATA`, `NOT_MASKED`
        """
        return pulumi.get(self, "masking")
    ...
    @masking.setter
    def masking(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "masking", value)
...
class SpanAttributed(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            key: Optional[pulumi.Input[builtins.str]] = None,
            masking: Optional[pulumi.Input[builtins.str]] = None,
            persistent: Optional[pulumi.Input[builtins.bool]] = None) -> 'SpanAttributed':
        """
    ...
    @property
    @pulumi.getter
    def masking(self) -> pulumi.Output[builtins.str]:
        """
        Possible Values: `MASK_ENTIRE_VALUE`, `MASK_ONLY_CONFIDENTIAL_DATA`, `NOT_MASKED`
        """
        return pulumi.get(self, "masking")
    ...
    @property
    @pulumi.getter
    def persistent(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "persistent")
