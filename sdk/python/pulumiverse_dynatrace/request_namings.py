...
__all__ = ['RequestNamingsArgs', 'RequestNamings']
...
class RequestNamingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ids: The IDs of the request namings in the order they should be taken into consideration
        """
        if ids is not None:
...
@pulumi.type_token("dynatrace:index/requestNamings:RequestNamings")
class RequestNamings(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RequestNamingsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'RequestNamings':
        """
        ...
        __props__ = _RequestNamingsState.__new__(_RequestNamingsState)

        __props__.__dict__["ids"] = ids
        return RequestNamings(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The IDs of the request namings in the order they should be taken into consideration
        """
        return pulumi.get(self, "ids")
