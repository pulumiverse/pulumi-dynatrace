...
class ManagedPublicEndpointsArgs:
    def __init__(__self__, *,
                 additional_web_ui_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 beacon_forwarder_address: Optional[pulumi.Input[builtins.str]] = None,
                 cdn_address: Optional[pulumi.Input[builtins.str]] = None,
                 web_ui_address: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ManagedPublicEndpoints resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] additional_web_ui_addresses: Additional web UI addresses
        :param pulumi.Input[builtins.str] beacon_forwarder_address: Beacon forwarder address
        :param pulumi.Input[builtins.str] cdn_address: CDN address
        :param pulumi.Input[builtins.str] web_ui_address: Web UI address
        """
    ...
    def additional_web_ui_addresses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def additional_web_ui_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "additional_web_ui_addresses", value)

    @property
    @pulumi.getter(name="beaconForwarderAddress")
    def beacon_forwarder_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def beacon_forwarder_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "beacon_forwarder_address", value)

    @property
    @pulumi.getter(name="cdnAddress")
    def cdn_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        CDN address
        """
    ...
    @cdn_address.setter
    def cdn_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cdn_address", value)

    @property
    @pulumi.getter(name="webUiAddress")
    def web_ui_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Web UI address
        """
    ...
    def web_ui_address(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ManagedPublicEndpoints(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            beacon_forwarder_address: Optional[pulumi.Input[builtins.str]] = None,
            cdn_address: Optional[pulumi.Input[builtins.str]] = None,
            web_ui_address: Optional[pulumi.Input[builtins.str]] = None) -> 'ManagedPublicEndpoints':
        """
    ...
    @property
    @pulumi.getter(name="additionalWebUiAddresses")
    def additional_web_ui_addresses(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Additional web UI addresses
        """
        return pulumi.get(self, "additional_web_ui_addresses")
    ...
    @property
    @pulumi.getter(name="beaconForwarderAddress")
    def beacon_forwarder_address(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Beacon forwarder address
        """
        return pulumi.get(self, "beacon_forwarder_address")
    ...
    @property
    @pulumi.getter(name="cdnAddress")
    def cdn_address(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        CDN address
        """
        return pulumi.get(self, "cdn_address")
    ...
    @property
    @pulumi.getter(name="webUiAddress")
    def web_ui_address(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Web UI address
        """
        return pulumi.get(self, "web_ui_address")
