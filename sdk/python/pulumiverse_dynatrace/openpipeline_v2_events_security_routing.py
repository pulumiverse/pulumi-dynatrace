...
__all__ = ['OpenpipelineV2EventsSecurityRoutingArgs', 'OpenpipelineV2EventsSecurityRouting']

@pulumi.input_type
class OpenpipelineV2EventsSecurityRoutingArgs:
    def __init__(__self__, *,
                 routing_entries: pulumi.Input[Optional['OpenpipelineV2EventsSecurityRoutingRoutingEntriesArgs']] = None):
        """
    ...
    def routing_entries(self) -> pulumi.Input[Optional['OpenpipelineV2EventsSecurityRoutingRoutingEntriesArgs']]:
        """
    ...
    def routing_entries(self, value: pulumi.Input[Optional['OpenpipelineV2EventsSecurityRoutingRoutingEntriesArgs']]):
        pulumi.set(self, "routing_entries", value)


@pulumi.input_type
class _OpenpipelineV2EventsSecurityRoutingState:
    def __init__(__self__, *,
                 routing_entries: pulumi.Input[Optional['OpenpipelineV2EventsSecurityRoutingRoutingEntriesArgs']] = None):
        """
...
@pulumi.type_token("dynatrace:index/openpipelineV2EventsSecurityRouting:OpenpipelineV2EventsSecurityRouting")
class OpenpipelineV2EventsSecurityRouting(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OpenpipelineV2EventsSecurityRoutingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = OpenpipelineV2EventsSecurityRoutingArgs.__new__(OpenpipelineV2EventsSecurityRoutingArgs)

            __props__.__dict__["routing_entries"] = routing_entries
        super(OpenpipelineV2EventsSecurityRouting, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            routing_entries: pulumi.Input[Optional[Union['OpenpipelineV2EventsSecurityRoutingRoutingEntriesArgs', 'OpenpipelineV2EventsSecurityRoutingRoutingEntriesArgsDict']]] = None) -> 'OpenpipelineV2EventsSecurityRouting':
        """
        ...
        __props__ = _OpenpipelineV2EventsSecurityRoutingState.__new__(_OpenpipelineV2EventsSecurityRoutingState)

        __props__.__dict__["routing_entries"] = routing_entries
        return OpenpipelineV2EventsSecurityRouting(resource_name, opts=opts, __props__=__props__)

    @_builtins.property
    @pulumi.getter(name="routingEntries")
    def routing_entries(self) -> pulumi.Output[Optional['outputs.OpenpipelineV2EventsSecurityRoutingRoutingEntries']]:
        """
        Routing for pipelines
        """
        return pulumi.get(self, "routing_entries")
