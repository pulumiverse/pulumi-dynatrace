...
class K8sMonitoringArgs:
    def __init__(__self__, *,
                 cloud_application_pipeline_enabled: pulumi.Input[builtins.bool],
                 event_processing_active: pulumi.Input[builtins.bool],
                 open_metrics_builtin_enabled: pulumi.Input[builtins.bool],
                 open_metrics_pipeline_enabled: pulumi.Input[builtins.bool],
        ...
        :param pulumi.Input[builtins.bool] event_processing_active: All events are monitored unless event filters are specified. All ingested events are subject to licensing by default.
        :param pulumi.Input[builtins.bool] open_metrics_builtin_enabled: Workload and node resource metrics are based on a subset of cAdvisor metrics. Depending on your Kubernetes cluster size,
        ...
        :param pulumi.Input[builtins.str] scope: The scope of this setting (KUBERNETES_CLUSTER). Omit this property if you want to cover the whole environment.
        """
    ...
    def cloud_application_pipeline_enabled(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def cloud_application_pipeline_enabled(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "cloud_application_pipeline_enabled", value)

    @property
    @pulumi.getter(name="eventProcessingActive")
    def event_processing_active(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def event_processing_active(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "event_processing_active", value)

    @property
    @pulumi.getter(name="openMetricsBuiltinEnabled")
    def open_metrics_builtin_enabled(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def open_metrics_builtin_enabled(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "open_metrics_builtin_enabled", value)

    @property
    @pulumi.getter(name="openMetricsPipelineEnabled")
    def open_metrics_pipeline_enabled(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def open_metrics_pipeline_enabled(self, value: pulumi.Input[builtins.bool]):
...
@pulumi.type_token("dynatrace:index/k8sMonitoring:K8sMonitoring")
class K8sMonitoring(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            open_metrics_pipeline_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            pvc_monitoring_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            scope: Optional[pulumi.Input[builtins.str]] = None) -> 'K8sMonitoring':
        """
    ...
    @property
    @pulumi.getter(name="cloudApplicationPipelineEnabled")
    def cloud_application_pipeline_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Monitor Kubernetes namespaces, services, workloads, and pods
        """
        return pulumi.get(self, "cloud_application_pipeline_enabled")
    ...
    @property
    @pulumi.getter(name="eventProcessingActive")
    def event_processing_active(self) -> pulumi.Output[builtins.bool]:
        """
        All events are monitored unless event filters are specified. All ingested events are subject to licensing by default.
        """
        return pulumi.get(self, "event_processing_active")
    ...
    @property
    @pulumi.getter(name="openMetricsBuiltinEnabled")
    def open_metrics_builtin_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Workload and node resource metrics are based on a subset of cAdvisor metrics. Depending on your Kubernetes cluster size,
        this may increase the CPU/memory resource consumption of your ActiveGate.
        """
    ...
    @property
    @pulumi.getter(name="openMetricsPipelineEnabled")
    def open_metrics_pipeline_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        For annotation guidance, see the [documentation](https://dt-url.net/g42i0ppw).
        """
        return pulumi.get(self, "open_metrics_pipeline_enabled")
