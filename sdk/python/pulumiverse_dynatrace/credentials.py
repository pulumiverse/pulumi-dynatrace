...
class CredentialsArgs:
    def __init__(__self__, *,
                 allow_contextless_requests: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 owner_access_only: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] allow_contextless_requests: Allow ad-hoc functions to access the credential details (requires the APP_ENGINE scope).
        :param pulumi.Input['CredentialsAllowedEntitiesArgs'] allowed_entities: The set of entities allowed to use the credential.
        :param pulumi.Input[builtins.str] certificate: The certificate in the string format.
        ...
        :param pulumi.Input[builtins.str] description: A short description of the credentials set
        :param pulumi.Input['CredentialsExternalArgs'] external: External Vault Configuration
        :param pulumi.Input[builtins.str] format: The certificate format. Possible values are `PEM`, `PKCS12` and `UNKNOWN`.
        :param pulumi.Input[builtins.str] name: The name of the credentials set
        :param pulumi.Input[builtins.bool] owner_access_only: The credentials set is available to every user (`false`) or to owner only (`true`)
        :param pulumi.Input[builtins.bool] public: For certificate authentication specifies whether it's public certificate auth (`true`) or not (`false`).
        :param pulumi.Input[builtins.str] scope: The scope of the credentials set. Possible values are `ALL`, `APP_ENGINE`, `EXTENSION` and `SYNTHETIC`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scopes: The set of scopes of the credentials set. Possible values are `APP_ENGINE` and `SYNTHETIC`
        :param pulumi.Input[builtins.str] token: Token in the string format. Specifying a token implies `Token Authentication`.
        :param pulumi.Input[builtins.str] username: The username of the credentials set.
        """
    ...
    def allow_contextless_requests(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_contextless_requests(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def owner_access_only(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def owner_access_only(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Credentials(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            scopes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            token: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'Credentials':
        """
    ...
    @property
    @pulumi.getter(name="allowContextlessRequests")
    def allow_contextless_requests(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Allow ad-hoc functions to access the credential details (requires the APP_ENGINE scope).
        """
        return pulumi.get(self, "allow_contextless_requests")
    ...
    @property
    @pulumi.getter(name="ownerAccessOnly")
    def owner_access_only(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The credentials set is available to every user (`false`) or to owner only (`true`)
        """
        return pulumi.get(self, "owner_access_only")
