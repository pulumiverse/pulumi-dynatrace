...
def get_process(name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] tags: Required tags of the process to find
    """
    __args__ = dict()
    __args__['name'] = name
    __args__['tags'] = tags
...
def get_process_output(name: Optional[pulumi.Input[builtins.str]] = None,
