...
class OpsGenieNotificationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] domain: The region domain of the OpsGenie
        ...
        :param pulumi.Input[builtins.str] api_key: The API key to access OpsGenie
...
class OpsGenieNotification(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            message: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            profile: Optional[pulumi.Input[builtins.str]] = None) -> 'OpsGenieNotification':
        """
