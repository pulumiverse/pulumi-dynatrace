...
class PgAnomalies(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 availability: Optional[pulumi.Input[pulumi.InputType['PgAnomaliesAvailabilityArgs']]] = None,
                 pg_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[pulumi.InputType['PgAnomaliesAvailabilityArgs']] availability: Configuration of the availability monitoring for the process group.
        :param pulumi.Input[str] pg_id: The ID of the process group
        """
        ...
    @overload
