...
class PgAnomaliesArgs:
    def __init__(__self__, *,
                 pg_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] pg_id: The ID of the process group
    ...
    def pg_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @pg_id.setter
    def pg_id(self, value: pulumi.Input[builtins.str]):
...
class _PgAnomaliesState:
    def __init__(__self__, *,
                 availability: Optional[pulumi.Input['PgAnomaliesAvailabilityArgs']] = None,
                 pg_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="pgId")
    def pg_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the process group
        """
        return pulumi.get(self, "pg_id")
    ...
    @pg_id.setter
    def pg_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "pg_id", value)
...
class PgAnomalies(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            availability: Optional[pulumi.Input[Union['PgAnomaliesAvailabilityArgs', 'PgAnomaliesAvailabilityArgsDict']]] = None,
            pg_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PgAnomalies':
        """
    ...
    @property
    @pulumi.getter(name="pgId")
    def pg_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the process group
        """
        return pulumi.get(self, "pg_id")
