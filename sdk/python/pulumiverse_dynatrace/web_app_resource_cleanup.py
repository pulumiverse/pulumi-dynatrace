...
class WebAppResourceCleanupArgs:
    ...
    def regular_expression(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def regular_expression(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "regular_expression", value)

    @_builtins.property
    @pulumi.getter(name="replaceWith")
    def replace_with(self) -> pulumi.Input[_builtins.str]:
        """
        For example: `$1$2\\*$3`
        """
    ...
    @replace_with.setter
    def replace_with(self, value: pulumi.Input[_builtins.str]):
...
class WebAppResourceCleanup(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="regularExpression")
    def regular_expression(self) -> pulumi.Output[_builtins.str]:
        """
        For example: `(.*)(journeyId=)-?\\d+(.*)`
        """
        return pulumi.get(self, "regular_expression")
    ...
    @_builtins.property
    @pulumi.getter(name="replaceWith")
    def replace_with(self) -> pulumi.Output[_builtins.str]:
        """
        For example: `$1$2\\*$3`
        """
        return pulumi.get(self, "replace_with")
