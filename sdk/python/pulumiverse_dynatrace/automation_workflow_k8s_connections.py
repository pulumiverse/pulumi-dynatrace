...
class AutomationWorkflowK8sConnectionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] namespace: The namespace where EdgeConnect is deployed
        :param pulumi.Input[builtins.str] token: Token
        :param pulumi.Input[builtins.str] uid: A pseudo-ID for the cluster, set to the UID of the kube-system namespace
        :param pulumi.Input[builtins.str] insert_after: Because this resource allows for ordering you may specify the ID of the resource instance that comes before this instance regarding order. If not specified when creating the setting will be added to the end of the list. If not specified during update the order will remain untouched
        :param pulumi.Input[builtins.str] name: The name of the EdgeConnect deployment
        """
...
class AutomationWorkflowK8sConnections(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            namespace: Optional[pulumi.Input[builtins.str]] = None,
            token: Optional[pulumi.Input[builtins.str]] = None,
            uid: Optional[pulumi.Input[builtins.str]] = None) -> 'AutomationWorkflowK8sConnections':
        """
