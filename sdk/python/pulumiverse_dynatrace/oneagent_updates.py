...
class OneagentUpdatesArgs:
    def __init__(__self__, *,
                 update_mode: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] update_mode: Possible Values: `AUTOMATIC`, `AUTOMATIC_DURING_MW`, `MANUAL`
        :param pulumi.Input['OneagentUpdatesMaintenanceWindowsArgs'] maintenance_windows: Maintenance windows
        :param pulumi.Input[builtins.str] revision: Revision
        ...
        :param pulumi.Input[builtins.str] target_version: Target version
        """
    ...
    def update_mode(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @update_mode.setter
    def update_mode(self, value: pulumi.Input[builtins.str]):
...
class _OneagentUpdatesState:
    def __init__(__self__, *,
                 ...
                 scope: Optional[pulumi.Input[builtins.str]] = None,
                 target_version: Optional[pulumi.Input[builtins.str]] = None,
                 update_mode: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="updateMode")
    def update_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Possible Values: `AUTOMATIC`, `AUTOMATIC_DURING_MW`, `MANUAL`
        """
        return pulumi.get(self, "update_mode")
    ...
    @update_mode.setter
    def update_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "update_mode", value)
...
class OneagentUpdates(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            scope: Optional[pulumi.Input[builtins.str]] = None,
            target_version: Optional[pulumi.Input[builtins.str]] = None,
            update_mode: Optional[pulumi.Input[builtins.str]] = None) -> 'OneagentUpdates':
        """
    ...
    @property
    @pulumi.getter
    def revision(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Revision
        """
        return pulumi.get(self, "revision")
    ...
    @property
    @pulumi.getter(name="updateMode")
    def update_mode(self) -> pulumi.Output[builtins.str]:
        """
        Possible Values: `AUTOMATIC`, `AUTOMATIC_DURING_MW`, `MANUAL`
        """
        return pulumi.get(self, "update_mode")
