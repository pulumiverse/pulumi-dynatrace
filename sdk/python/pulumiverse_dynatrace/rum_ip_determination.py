...
class RumIpDeterminationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] header_name: Client IP header name
...
class RumIpDetermination(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            header_name: Optional[pulumi.Input[builtins.str]] = None,
            insert_after: Optional[pulumi.Input[builtins.str]] = None) -> 'RumIpDetermination':
        """
    ...
    @property
    @pulumi.getter(name="headerName")
    def header_name(self) -> pulumi.Output[builtins.str]:
        """
        Client IP header name
        """
        return pulumi.get(self, "header_name")
