...
class RumAdvancedCorrelationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] matcher: Possible Values: `CONTAINS`, `ENDS_WITH`, `EQUALS`, `STARTS_WITH`
        :param pulumi.Input[builtins.str] pattern: Pattern
        """
...
class RumAdvancedCorrelation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            matcher: Optional[pulumi.Input[builtins.str]] = None,
            pattern: Optional[pulumi.Input[builtins.str]] = None) -> 'RumAdvancedCorrelation':
        """
