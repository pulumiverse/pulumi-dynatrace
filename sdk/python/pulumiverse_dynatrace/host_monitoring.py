...
class HostMonitoringArgs:
    def __init__(__self__, *,
                 ...
                 auto_injection: Optional[pulumi.Input[builtins.bool]] = None,
                 full_stack: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] auto_injection: An auto-injection disabled with [oneagentctl](https://dt-url.net/oneagentctl) takes precedence over this setting and cannot be changed from the Dynatrace web UI.
        :param pulumi.Input[builtins.bool] full_stack: Dynatrace uses full-stack monitoring by default, to monitor every aspect of your environment, including all processes, services, and applications detected on your hosts.
        """
    ...
    def auto_injection(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_injection(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def full_stack(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @full_stack.setter
    def full_stack(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class HostMonitoring(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            enabled: Optional[pulumi.Input[builtins.bool]] = None,
            full_stack: Optional[pulumi.Input[builtins.bool]] = None,
            host_id: Optional[pulumi.Input[builtins.str]] = None) -> 'HostMonitoring':
        """
    ...
    @pulumi.getter(name="autoInjection")
    @_utilities.deprecated("""This field has been moved to a new schema, please utilize the resource `HostMonitoringAdvanced` to configure this field.""")
    def auto_injection(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        An auto-injection disabled with [oneagentctl](https://dt-url.net/oneagentctl) takes precedence over this setting and cannot be changed from the Dynatrace web UI.
        """
        return pulumi.get(self, "auto_injection")
    ...
    @pulumi.getter(name="fullStack")
    @_utilities.deprecated("""This attribute is not supported anymore by the Dynatrace API""")
    def full_stack(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Dynatrace uses full-stack monitoring by default, to monitor every aspect of your environment, including all processes, services, and applications detected on your hosts.
        """
        return pulumi.get(self, "full_stack")
