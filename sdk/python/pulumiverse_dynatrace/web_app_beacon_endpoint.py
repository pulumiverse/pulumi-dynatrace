...
class WebAppBeaconEndpointArgs:
    def __init__(__self__, *,
                 ...
                 use_cors: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a WebAppBeaconEndpoint resource.
        :param pulumi.Input[builtins.str] application_id: The scope of this setting
        :param pulumi.Input[builtins.str] type: Possible Values: `ACTIVEGATE`, `DEFAULT_CONFIG`, `ONEAGENT`
        :param pulumi.Input[builtins.str] url: You can specify either path segments or an absolute URL.
        :param pulumi.Input[builtins.bool] use_cors: Learn more about [sending beacon data via CORS](https://dt-url.net/r7038sa)
        """
    ...
    def use_cors(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @use_cors.setter
    def use_cors(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class WebAppBeaconEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            use_cors: Optional[pulumi.Input[builtins.bool]] = None) -> 'WebAppBeaconEndpoint':
        """
    ...
    @property
    @pulumi.getter(name="useCors")
    def use_cors(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Learn more about [sending beacon data via CORS](https://dt-url.net/r7038sa)
        """
        return pulumi.get(self, "use_cors")
