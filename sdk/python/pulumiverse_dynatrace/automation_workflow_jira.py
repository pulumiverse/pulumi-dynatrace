...
class AutomationWorkflowJira(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        - `terraform-provider-dynatrace -export AutomationWorkflowJira` downloads existing Jira for Workflows configuration
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[_builtins.str]] = None,
            url: Optional[pulumi.Input[_builtins.str]] = None,
            user: Optional[pulumi.Input[_builtins.str]] = None) -> 'AutomationWorkflowJira':
        """
