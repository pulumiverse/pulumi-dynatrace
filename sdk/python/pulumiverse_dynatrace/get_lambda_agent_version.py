...
class GetLambdaAgentVersionResult:
    ...
    @_builtins.property
    @pulumi.getter
    def collector(self) -> _builtins.str:
        """
    ...
    def java_with_collector(self) -> _builtins.str:
        """
    ...
    def nodejs_with_collector(self) -> _builtins.str:
        """
    ...
    def python_with_collector(self) -> _builtins.str:
        """
...
def get_lambda_agent_version(collector: Optional[_builtins.str] = None,
                             java: Optional[_builtins.str] = None,
                             java_with_collector: Optional[_builtins.str] = None,
                             nodejs: Optional[_builtins.str] = None,
                             nodejs_with_collector: Optional[_builtins.str] = None,
                             python: Optional[_builtins.str] = None,
                             python_with_collector: Optional[_builtins.str] = None,
    ...
    :param _builtins.str collector: Latest version name of standalone log collector
    :param _builtins.str java: Latest version name of Java code module
    :param _builtins.str java_with_collector: Latest version name of Java code module with log collector
    :param _builtins.str nodejs: Latest version name of NodeJS code module
    :param _builtins.str nodejs_with_collector: Latest version name of NodeJS code module with log collector
    :param _builtins.str python: Latest version name of Python code module
    :param _builtins.str python_with_collector: Latest version name of Python code module with log collector
    """
    __args__ = dict()
