...
class BusinessEventsCapturingVariantsArgs:
    ...
    def content_type_matcher(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def content_type_matcher(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "content_type_matcher", value)

    @_builtins.property
    @pulumi.getter(name="contentTypeValue")
    def content_type_value(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def content_type_value(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "content_type_value", value)

    @_builtins.property
    @pulumi.getter
    def parser(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @parser.setter
    def parser(self, value: pulumi.Input[_builtins.str]):
...
class BusinessEventsCapturingVariants(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="contentTypeMatcher")
    def content_type_matcher(self) -> pulumi.Output[_builtins.str]:
        """
        Possible Values: `CONTAINS`, `ENDS_WITH`, `EQUALS`, `STARTS_WITH`
        """
        return pulumi.get(self, "content_type_matcher")
    ...
    @_builtins.property
    @pulumi.getter(name="contentTypeValue")
    def content_type_value(self) -> pulumi.Output[_builtins.str]:
        """
        Content-type match value
        """
        return pulumi.get(self, "content_type_value")
