...
class ApplicationDetectionRuleV2Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] application_id: Select an existing application or create a new one.
        :param pulumi.Input[builtins.str] matcher: Possible Values: `DOMAIN_CONTAINS`, `DOMAIN_ENDS_WITH`, `DOMAIN_EQUALS`, `DOMAIN_MATCHES`, `DOMAIN_STARTS_WITH`, `URL_CONTAINS`, `URL_ENDS_WITH`, `URL_EQUALS`, `URL_STARTS_WITH`
        :param pulumi.Input[builtins.str] pattern: Pattern
        :param pulumi.Input[builtins.str] description: (v1.274) Add a description for your rule
...
class ApplicationDetectionRuleV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            insert_after: Optional[pulumi.Input[builtins.str]] = None,
            matcher: Optional[pulumi.Input[builtins.str]] = None,
            pattern: Optional[pulumi.Input[builtins.str]] = None) -> 'ApplicationDetectionRuleV2':
        """
