...
class SloNormalizationArgs:
    def __init__(__self__, *,
                 normalize: pulumi.Input[builtins.bool]):
        """
        The set of arguments for constructing a SloNormalization resource.
        :param pulumi.Input[builtins.bool] normalize: When set to true, the error budget left will be shown in percent of the total error budget. For more details see [SLO normalization help](https://dt-url.net/slo-normalize-error-budget).
        """
        pulumi.set(__self__, "normalize", normalize)

    @property
    @pulumi.getter
    def normalize(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @normalize.setter
    def normalize(self, value: pulumi.Input[builtins.bool]):
...
class _SloNormalizationState:
    def __init__(__self__, *,
                 normalize: Optional[pulumi.Input[builtins.bool]] = None):
        """
    ...
    @property
    @pulumi.getter
    def normalize(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When set to true, the error budget left will be shown in percent of the total error budget. For more details see [SLO normalization help](https://dt-url.net/slo-normalize-error-budget).
        """
        return pulumi.get(self, "normalize")
    ...
    @normalize.setter
    def normalize(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "normalize", value)
...
class SloNormalization(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            normalize: Optional[pulumi.Input[builtins.bool]] = None) -> 'SloNormalization':
        """
    ...
    @property
    @pulumi.getter
    def normalize(self) -> pulumi.Output[builtins.bool]:
        """
        When set to true, the error budget left will be shown in percent of the total error budget. For more details see [SLO normalization help](https://dt-url.net/slo-normalize-error-budget).
        """
        return pulumi.get(self, "normalize")
