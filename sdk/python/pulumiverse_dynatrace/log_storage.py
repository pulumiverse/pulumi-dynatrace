...
class LogStorageArgs:
    def __init__(__self__, *,
                 ...
                 send_to_storage: pulumi.Input[builtins.bool],
        ...
        :param pulumi.Input[builtins.bool] send_to_storage: If `true` matching logs will be included in storage. If `false` matching logs will be excluded from storage.
    ...
    def send_to_storage(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def send_to_storage(self, value: pulumi.Input[builtins.bool]):
...
class _LogStorageState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 scope: Optional[pulumi.Input[builtins.str]] = None,
                 send_to_storage: Optional[pulumi.Input[builtins.bool]] = None):
        """
    ...
    @property
    @pulumi.getter(name="sendToStorage")
    def send_to_storage(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If `true` matching logs will be included in storage. If `false` matching logs will be excluded from storage.
        """
        return pulumi.get(self, "send_to_storage")
    ...
    @send_to_storage.setter
    def send_to_storage(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "send_to_storage", value)
...
class LogStorage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            scope: Optional[pulumi.Input[builtins.str]] = None,
            send_to_storage: Optional[pulumi.Input[builtins.bool]] = None) -> 'LogStorage':
        """
    ...
    @property
    @pulumi.getter(name="sendToStorage")
    def send_to_storage(self) -> pulumi.Output[builtins.bool]:
        """
        If `true` matching logs will be included in storage. If `false` matching logs will be excluded from storage.
        """
        return pulumi.get(self, "send_to_storage")
