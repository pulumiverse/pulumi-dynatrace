...
class _SpanCaptureRuleState:
    def __init__(__self__, *,
                 ...
                 insert_after: pulumi.Input[Optional[_builtins.str]] = None,
                 matches: pulumi.Input[Optional['SpanCaptureRuleMatchesArgs']] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def matches(self) -> pulumi.Input[Optional['SpanCaptureRuleMatchesArgs']]:
        """
        Matching strategies for the Span
        """
        return pulumi.get(self, "matches")
    ...
    @matches.setter
    def matches(self, value: pulumi.Input[Optional['SpanCaptureRuleMatchesArgs']]):
        pulumi.set(self, "matches", value)
...
class SpanCaptureRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        - `terraform-provider-dynatrace -export SpanCaptureRule` downloads all existing span capture rule configuration
