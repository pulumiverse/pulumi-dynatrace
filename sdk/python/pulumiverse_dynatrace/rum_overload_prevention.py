...
class RumOverloadPreventionArgs:
    def __init__(__self__, *,
                 overload_prevention_limit: pulumi.Input[builtins.int]):
        """
        The set of arguments for constructing a RumOverloadPrevention resource.
        :param pulumi.Input[builtins.int] overload_prevention_limit: Once this limit is reached, Dynatrace [throttles the number of captured user sessions](https://dt-url.net/fm3v0p7g).
        """
        pulumi.set(__self__, "overload_prevention_limit", overload_prevention_limit)

    @property
    @pulumi.getter(name="overloadPreventionLimit")
    def overload_prevention_limit(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def overload_prevention_limit(self, value: pulumi.Input[builtins.int]):
...
class _RumOverloadPreventionState:
    def __init__(__self__, *,
                 overload_prevention_limit: Optional[pulumi.Input[builtins.int]] = None):
        """
    ...
    @property
    @pulumi.getter(name="overloadPreventionLimit")
    def overload_prevention_limit(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Once this limit is reached, Dynatrace [throttles the number of captured user sessions](https://dt-url.net/fm3v0p7g).
        """
        return pulumi.get(self, "overload_prevention_limit")
    ...
    @overload_prevention_limit.setter
    def overload_prevention_limit(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "overload_prevention_limit", value)
...
class RumOverloadPrevention(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            overload_prevention_limit: Optional[pulumi.Input[builtins.int]] = None) -> 'RumOverloadPrevention':
        """
    ...
    @property
    @pulumi.getter(name="overloadPreventionLimit")
    def overload_prevention_limit(self) -> pulumi.Output[builtins.int]:
        """
        Once this limit is reached, Dynatrace [throttles the number of captured user sessions](https://dt-url.net/fm3v0p7g).
        """
        return pulumi.get(self, "overload_prevention_limit")
