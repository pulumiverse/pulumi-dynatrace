...
class ManagementZoneArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description of the management zone
        ...
        :param pulumi.Input[builtins.str] name: The name of the management zone
...
@pulumi.type_token("dynatrace:index/managementZone:ManagementZone")
class ManagementZone(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ManagementZoneRuleArgs', 'ManagementZoneRuleArgsDict']]]]] = None,
            unknowns: Optional[pulumi.Input[builtins.str]] = None) -> 'ManagementZone':
        """
