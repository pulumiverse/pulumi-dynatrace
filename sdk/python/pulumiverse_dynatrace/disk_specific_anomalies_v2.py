...
class DiskSpecificAnomaliesV2Args:
    ...
    def override_disk_low_space_detection(self) -> pulumi.Input[_builtins.bool]:
        """
    ...
    def override_disk_low_space_detection(self, value: pulumi.Input[_builtins.bool]):
        pulumi.set(self, "override_disk_low_space_detection", value)

    @_builtins.property
    @pulumi.getter(name="overrideLowInodesDetection")
    def override_low_inodes_detection(self) -> pulumi.Input[_builtins.bool]:
        """
    ...
    def override_low_inodes_detection(self, value: pulumi.Input[_builtins.bool]):
        pulumi.set(self, "override_low_inodes_detection", value)

    @_builtins.property
    @pulumi.getter(name="overrideSlowWritesAndReadsDetection")
    def override_slow_writes_and_reads_detection(self) -> pulumi.Input[_builtins.bool]:
        """
    ...
    def override_slow_writes_and_reads_detection(self, value: pulumi.Input[_builtins.bool]):
...
class DiskSpecificAnomaliesV2(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="overrideDiskLowSpaceDetection")
    def override_disk_low_space_detection(self) -> pulumi.Output[_builtins.bool]:
        """
        Override low disk space detection settings
        """
        return pulumi.get(self, "override_disk_low_space_detection")
    ...
    @_builtins.property
    @pulumi.getter(name="overrideLowInodesDetection")
    def override_low_inodes_detection(self) -> pulumi.Output[_builtins.bool]:
        """
        Override low inodes detection settings
        """
        return pulumi.get(self, "override_low_inodes_detection")
    ...
    @_builtins.property
    @pulumi.getter(name="overrideSlowWritesAndReadsDetection")
    def override_slow_writes_and_reads_detection(self) -> pulumi.Output[_builtins.bool]:
        """
        Override slow writes and reads detection settings
        """
        return pulumi.get(self, "override_slow_writes_and_reads_detection")
