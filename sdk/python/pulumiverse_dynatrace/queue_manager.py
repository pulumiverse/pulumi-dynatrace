...
class QueueManagerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] clusters: Name of the cluster(s) this queue manager is part of
        :param pulumi.Input[builtins.str] name: The name of the queue manager
...
class QueueManager(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def clusters(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Name of the cluster(s) this queue manager is part of
        """
        return pulumi.get(self, "clusters")
