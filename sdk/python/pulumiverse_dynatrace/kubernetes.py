...
class KubernetesArgs:
    def __init__(__self__, *,
                 cluster_id_enabled: pulumi.Input[builtins.bool],
                 enabled: pulumi.Input[builtins.bool],
                 label: pulumi.Input[builtins.str],
                 active_gate_group: Optional[pulumi.Input[builtins.str]] = None,
                 auth_token: Optional[pulumi.Input[builtins.str]] = None,
                 certificate_check_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 cloud_application_pipeline_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 event_processing_active: Optional[pulumi.Input[builtins.bool]] = None,
                 filter_events: Optional[pulumi.Input[builtins.bool]] = None,
                 hostname_verification_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 include_all_fdi_events: Optional[pulumi.Input[builtins.bool]] = None,
                 open_metrics_builtin_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 open_metrics_pipeline_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 pvc_monitoring_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 scope: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Kubernetes resource.
        :param pulumi.Input[builtins.bool] cluster_id_enabled: For more information on local Kubernetes API monitoring, see the [documentation](https://dt-url.net/6q62uep).
        :param pulumi.Input[builtins.bool] enabled: This setting is enabled (`true`) or disabled (`false`)
        :param pulumi.Input[builtins.str] label: Renaming the cluster breaks configurations that are based on its name (e.g., management zones, and alerting).
        :param pulumi.Input[builtins.str] active_gate_group: ActiveGate Group
        :param pulumi.Input[builtins.str] auth_token: Create a bearer token for [Kubernetes](https://dt-url.net/og43szq) or [OpenShift](https://dt-url.net/7l43xtp).
        :param pulumi.Input[builtins.bool] certificate_check_enabled: Require valid certificates for communication with API server (recommended)
        :param pulumi.Input[builtins.bool] cloud_application_pipeline_enabled: Monitor Kubernetes namespaces, services, workloads, and pods
        :param pulumi.Input[builtins.str] cluster_id: Unique ID of the cluster, the containerized ActiveGate is deployed to. Defaults to the UUID of the kube-system namespace. The cluster ID of containerized ActiveGates is shown on the Deployment status screen.
        :param pulumi.Input[builtins.str] endpoint_url: Get the API URL for [Kubernetes](https://dt-url.net/kz23snj) or [OpenShift](https://dt-url.net/d623xgw).
        ...
        :param pulumi.Input[builtins.bool] event_processing_active: All events are monitored by default unless event filters are specified.
        :param pulumi.Input[builtins.bool] filter_events: Include only events specified by Events Field Selectors
        :param pulumi.Input[builtins.bool] hostname_verification_enabled: Verify hostname in certificate against Kubernetes API URL
        :param pulumi.Input[builtins.bool] include_all_fdi_events: For a list of included events, see the [documentation](https://dt-url.net/l61d02no).
        :param pulumi.Input[builtins.bool] open_metrics_builtin_enabled: The workload resource metrics are based on a subset of cAdvisor metrics. Depending on your Kubernetes cluster size, this
               may increase the CPU/memory resource consumption of your ActiveGate.
        :param pulumi.Input[builtins.bool] open_metrics_pipeline_enabled: For annotation guidance, see the [documentation](https://dt-url.net/g42i0ppw).
        :param pulumi.Input[builtins.bool] pvc_monitoring_enabled: To enable dashboards and alerts, add the Kubernetes persistent volume claims extension to your environment.
        :param pulumi.Input[builtins.str] scope: The scope of this setting (KUBERNETES_CLUSTER)
        """
    ...
    def cluster_id_enabled(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def cluster_id_enabled(self, value: pulumi.Input[builtins.bool]):
    ...
    def active_gate_group(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ActiveGate Group
        """
    ...
    def active_gate_group(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def certificate_check_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def certificate_check_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def cloud_application_pipeline_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def cloud_application_pipeline_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @_utilities.deprecated("""This field has been moved to a new schema, please utilize the resource `K8sMonitoring` to configure this field.""")
    def event_processing_active(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def event_processing_active(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "event_processing_active", value)

    @property
    @pulumi.getter(name="filterEvents")
    @_utilities.deprecated("""This field has been moved to a new schema, please utilize the resource `K8sMonitoring` to configure this field.""")
    def filter_events(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def filter_events(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "filter_events", value)

    @property
    @pulumi.getter(name="hostnameVerificationEnabled")
    def hostname_verification_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def hostname_verification_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "hostname_verification_enabled", value)

    @property
    @pulumi.getter(name="includeAllFdiEvents")
    @_utilities.deprecated("""This field has been moved to a new schema, please utilize the resource `K8sMonitoring` to configure this field.""")
    def include_all_fdi_events(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def include_all_fdi_events(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "include_all_fdi_events", value)

    @property
    @pulumi.getter(name="openMetricsBuiltinEnabled")
    @_utilities.deprecated("""This field has been moved to a new schema, please utilize the resource `K8sMonitoring` to configure this field.""")
    def open_metrics_builtin_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def open_metrics_builtin_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "open_metrics_builtin_enabled", value)

    @property
    @pulumi.getter(name="openMetricsPipelineEnabled")
    @_utilities.deprecated("""This field has been moved to a new schema, please utilize the resource `K8sMonitoring` to configure this field.""")
    def open_metrics_pipeline_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def open_metrics_pipeline_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "open_metrics_pipeline_enabled", value)

    @property
    @pulumi.getter(name="pvcMonitoringEnabled")
    @_utilities.deprecated("""This field has been moved to a new schema, please utilize the resource `K8sMonitoring` to configure this field.""")
    def pvc_monitoring_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def pvc_monitoring_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _KubernetesState:
    def __init__(__self__, *,
                 ...
                 cloud_application_pipeline_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 cluster_id: Optional[pulumi.Input[builtins.str]] = None,
                 cluster_id_enabled: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="clusterIdEnabled")
    def cluster_id_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        For more information on local Kubernetes API monitoring, see the [documentation](https://dt-url.net/6q62uep).
        """
        return pulumi.get(self, "cluster_id_enabled")
    ...
    @cluster_id_enabled.setter
    def cluster_id_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "cluster_id_enabled", value)
...
class Kubernetes(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            open_metrics_pipeline_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            pvc_monitoring_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            scope: Optional[pulumi.Input[builtins.str]] = None) -> 'Kubernetes':
        """
    ...
    @property
    @pulumi.getter(name="activeGateGroup")
    def active_gate_group(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ActiveGate Group
        """
        return pulumi.get(self, "active_gate_group")
    ...
    @property
    @pulumi.getter(name="certificateCheckEnabled")
    def certificate_check_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Require valid certificates for communication with API server (recommended)
        """
        return pulumi.get(self, "certificate_check_enabled")
    ...
    @pulumi.getter(name="cloudApplicationPipelineEnabled")
    @_utilities.deprecated("""This field has been moved to a new schema, please utilize the resource `K8sMonitoring` to configure this field.""")
    def cloud_application_pipeline_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Monitor Kubernetes namespaces, services, workloads, and pods
        """
        return pulumi.get(self, "cloud_application_pipeline_enabled")
    ...
    @property
    @pulumi.getter(name="clusterIdEnabled")
    def cluster_id_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        For more information on local Kubernetes API monitoring, see the [documentation](https://dt-url.net/6q62uep).
        """
        return pulumi.get(self, "cluster_id_enabled")
    ...
    @pulumi.getter(name="eventProcessingActive")
    @_utilities.deprecated("""This field has been moved to a new schema, please utilize the resource `K8sMonitoring` to configure this field.""")
    def event_processing_active(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        All events are monitored by default unless event filters are specified.
        """
        return pulumi.get(self, "event_processing_active")
    ...
    @pulumi.getter(name="filterEvents")
    @_utilities.deprecated("""This field has been moved to a new schema, please utilize the resource `K8sMonitoring` to configure this field.""")
    def filter_events(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Include only events specified by Events Field Selectors
        """
        return pulumi.get(self, "filter_events")
    ...
    @property
    @pulumi.getter(name="hostnameVerificationEnabled")
    def hostname_verification_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Verify hostname in certificate against Kubernetes API URL
        """
        return pulumi.get(self, "hostname_verification_enabled")
    ...
    @pulumi.getter(name="includeAllFdiEvents")
    @_utilities.deprecated("""This field has been moved to a new schema, please utilize the resource `K8sMonitoring` to configure this field.""")
    def include_all_fdi_events(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        For a list of included events, see the [documentation](https://dt-url.net/l61d02no).
        """
        return pulumi.get(self, "include_all_fdi_events")
    ...
    @pulumi.getter(name="openMetricsBuiltinEnabled")
    @_utilities.deprecated("""This field has been moved to a new schema, please utilize the resource `K8sMonitoring` to configure this field.""")
    def open_metrics_builtin_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The workload resource metrics are based on a subset of cAdvisor metrics. Depending on your Kubernetes cluster size, this
        may increase the CPU/memory resource consumption of your ActiveGate.
        """
    ...
    @pulumi.getter(name="openMetricsPipelineEnabled")
    @_utilities.deprecated("""This field has been moved to a new schema, please utilize the resource `K8sMonitoring` to configure this field.""")
    def open_metrics_pipeline_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        For annotation guidance, see the [documentation](https://dt-url.net/g42i0ppw).
        """
        return pulumi.get(self, "open_metrics_pipeline_enabled")
    ...
    @pulumi.getter(name="pvcMonitoringEnabled")
    @_utilities.deprecated("""This field has been moved to a new schema, please utilize the resource `K8sMonitoring` to configure this field.""")
    def pvc_monitoring_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        To enable dashboards and alerts, add the Kubernetes persistent volume claims extension to your environment.
        """
        return pulumi.get(self, "pvc_monitoring_enabled")
