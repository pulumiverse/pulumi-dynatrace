...
class ConnectivityAlertsArgs:
    def __init__(__self__, *,
                 connectivity_alerts: pulumi.Input[builtins.bool],
                 process_group_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a ConnectivityAlerts resource.
        :param pulumi.Input[builtins.bool] connectivity_alerts: TCP connectivity problems
        :param pulumi.Input[builtins.str] process_group_id: The scope of this settings
        """
    ...
    def connectivity_alerts(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def connectivity_alerts(self, value: pulumi.Input[builtins.bool]):
...
class _ConnectivityAlertsState:
    def __init__(__self__, *,
                 connectivity_alerts: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="connectivityAlerts")
    def connectivity_alerts(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        TCP connectivity problems
        """
        return pulumi.get(self, "connectivity_alerts")
    ...
    @connectivity_alerts.setter
    def connectivity_alerts(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "connectivity_alerts", value)
...
class ConnectivityAlerts(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            connectivity_alerts: Optional[pulumi.Input[builtins.bool]] = None,
            process_group_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ConnectivityAlerts':
        """
    ...
    @property
    @pulumi.getter(name="connectivityAlerts")
    def connectivity_alerts(self) -> pulumi.Output[builtins.bool]:
        """
        TCP connectivity problems
        """
        return pulumi.get(self, "connectivity_alerts")
