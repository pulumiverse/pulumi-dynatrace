...
class GenericTypesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_by: The user or extension that created this type.
        :param pulumi.Input[builtins.str] display_name: The human readable type name for this entity type.
        ...
        :param pulumi.Input[builtins.str] name: The entity type name. This type name must be unique and must not be changed after creation.
        """
