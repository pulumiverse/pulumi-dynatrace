...
__all__ = ['OpenpipelineSpansArgs', 'OpenpipelineSpans']
...
@pulumi.type_token("dynatrace:index/openpipelineSpans:OpenpipelineSpans")
class OpenpipelineSpans(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OpenpipelineSpansArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = OpenpipelineSpansArgs.__new__(OpenpipelineSpansArgs)

            __props__.__dict__["endpoints"] = endpoints
            __props__.__dict__["pipelines"] = pipelines
            __props__.__dict__["routing"] = routing
        super(OpenpipelineSpans, __self__).__init__(
    ...
    def get(resource_name: str,
        ...
        __props__ = _OpenpipelineSpansState.__new__(_OpenpipelineSpansState)

        __props__.__dict__["endpoints"] = endpoints
        __props__.__dict__["pipelines"] = pipelines
        __props__.__dict__["routing"] = routing
        return OpenpipelineSpans(resource_name, opts=opts, __props__=__props__)

    @_builtins.property
    @pulumi.getter
    def endpoints(self) -> pulumi.Output[Optional['outputs.OpenpipelineSpansEndpoints']]:
        """
        List of all ingest sources of the configuration
        """
        return pulumi.get(self, "endpoints")
    ...
    @_builtins.property
    @pulumi.getter
    def pipelines(self) -> pulumi.Output[Optional['outputs.OpenpipelineSpansPipelines']]:
        """
        List of all pipelines of the configuration
        """
        return pulumi.get(self, "pipelines")
    ...
    @_builtins.property
    @pulumi.getter
    def routing(self) -> pulumi.Output[Optional['outputs.OpenpipelineSpansRouting']]:
        """
        Dynamic routing definition
        """
        return pulumi.get(self, "routing")
