...
class HttpMonitorScriptInitArgs:
    def __init__(__self__, *,
                 http_id: pulumi.Input[_builtins.str],
    ...
    def http_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @http_id.setter
    def http_id(self, value: pulumi.Input[_builtins.str]):
...
class HttpMonitorScript(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="httpId")
    def http_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of the HTTP monitor
        """
        return pulumi.get(self, "http_id")
