...
__all__ = ['MutedRequestsArgs', 'MutedRequests']

@pulumi.input_type
class MutedRequestsArgs:
    def __init__(__self__, *,
                 service_id: pulumi.Input[builtins.str],
                 muted_request_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] muted_request_names: Muted request names
        """
        pulumi.set(__self__, "service_id", service_id)
        if muted_request_names is not None:
            pulumi.set(__self__, "muted_request_names", muted_request_names)
    ...
    def muted_request_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Muted request names
        """
    ...
    def muted_request_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
@pulumi.type_token("dynatrace:index/mutedRequests:MutedRequests")
class MutedRequests(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MutedRequestsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MutedRequestsArgs.__new__(MutedRequestsArgs)

            __props__.__dict__["muted_request_names"] = muted_request_names
            if service_id is None and not opts.urn:
                raise TypeError("Missing required property 'service_id'")
            __props__.__dict__["service_id"] = service_id
        super(MutedRequests, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            muted_request_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            service_id: Optional[pulumi.Input[builtins.str]] = None) -> 'MutedRequests':
        """
        ...
        __props__ = _MutedRequestsState.__new__(_MutedRequestsState)

        __props__.__dict__["muted_request_names"] = muted_request_names
        __props__.__dict__["service_id"] = service_id
        return MutedRequests(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="mutedRequestNames")
    def muted_request_names(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Muted request names
        """
        return pulumi.get(self, "muted_request_names")
