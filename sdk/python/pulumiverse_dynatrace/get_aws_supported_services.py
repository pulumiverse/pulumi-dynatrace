...
class GetAwsSupportedServicesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def services(self) -> Mapping[str, _builtins.bool]:
        """
...
def get_aws_supported_services(excepts: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] excepts: Services with the given names won't be included in the results
    """
    __args__ = dict()
...
def get_aws_supported_services_output(excepts: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
