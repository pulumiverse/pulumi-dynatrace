...
def get_aws_supported_services(excepts: Optional[Sequence[builtins.str]] = None,
...
def get_aws_supported_services_output(excepts: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
