...
class AwsCredentialsArgs:
    def __init__(__self__, *,
                 ...
                 partition_type: pulumi.Input[builtins.str],
                 tagged_only: pulumi.Input[builtins.bool],
                 credentials_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 label: Optional[pulumi.Input[builtins.str]] = None,
                 remove_defaults: Optional[pulumi.Input[builtins.bool]] = None,
                 running_on_dynatrace_infrastructure: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] partition_type: The type of the AWS partition
        :param pulumi.Input[builtins.bool] tagged_only: Monitor only resources which have specified AWS tags (`true`) or all resources (`false`)
        :param pulumi.Input[builtins.bool] credentials_enabled: Enable monitoring of specified AWS credentials
        :param pulumi.Input[builtins.str] label: The name of the credentials
        :param pulumi.Input[builtins.bool] remove_defaults: Instructs the provider to remove the supporting services Dynatrace applies by default to newly created AWS Credentials. Supporting Services applied by via `AwsService` subsequently won't get touched.
        ...
        :param pulumi.Input[builtins.bool] running_on_dynatrace_infrastructure: Run credentials on Dynatrace infrastructure
    ...
    def partition_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def partition_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "partition_type", value)

    @property
    @pulumi.getter(name="taggedOnly")
    def tagged_only(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @tagged_only.setter
    def tagged_only(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "tagged_only", value)

    @property
    @pulumi.getter(name="credentialsEnabled")
    def credentials_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def credentials_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def running_on_dynatrace_infrastructure(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def running_on_dynatrace_infrastructure(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _AwsCredentialsState:
    def __init__(__self__, *,
                 ...
                 credentials_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 label: Optional[pulumi.Input[builtins.str]] = None,
                 partition_type: Optional[pulumi.Input[builtins.str]] = None,
                 remove_defaults: Optional[pulumi.Input[builtins.bool]] = None,
                 running_on_dynatrace_infrastructure: Optional[pulumi.Input[builtins.bool]] = None,
                 supporting_services_managed_in_dynatrace: Optional[pulumi.Input[builtins.bool]] = None,
                 supporting_services_to_monitors: Optional[pulumi.Input[Sequence[pulumi.Input['AwsCredentialsSupportingServicesToMonitorArgs']]]] = None,
                 tagged_only: Optional[pulumi.Input[builtins.bool]] = None,
                 tags_to_monitors: Optional[pulumi.Input[Sequence[pulumi.Input['AwsCredentialsTagsToMonitorArgs']]]] = None,
                 unknowns: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="partitionType")
    def partition_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the AWS partition
        """
        return pulumi.get(self, "partition_type")
    ...
    @partition_type.setter
    def partition_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "partition_type", value)
    ...
    @property
    @pulumi.getter(name="taggedOnly")
    def tagged_only(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Monitor only resources which have specified AWS tags (`true`) or all resources (`false`)
        """
        return pulumi.get(self, "tagged_only")
    ...
    @tagged_only.setter
    def tagged_only(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "tagged_only", value)
...
class AwsCredentials(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tagged_only: Optional[pulumi.Input[builtins.bool]] = None,
            tags_to_monitors: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AwsCredentialsTagsToMonitorArgs', 'AwsCredentialsTagsToMonitorArgsDict']]]]] = None,
            unknowns: Optional[pulumi.Input[builtins.str]] = None) -> 'AwsCredentials':
        """
    ...
    @property
    @pulumi.getter(name="credentialsEnabled")
    def credentials_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable monitoring of specified AWS credentials
        """
        return pulumi.get(self, "credentials_enabled")
    ...
    @property
    @pulumi.getter(name="partitionType")
    def partition_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the AWS partition
        """
        return pulumi.get(self, "partition_type")
    ...
    @property
    @pulumi.getter(name="runningOnDynatraceInfrastructure")
    def running_on_dynatrace_infrastructure(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Run credentials on Dynatrace infrastructure
        """
        return pulumi.get(self, "running_on_dynatrace_infrastructure")
    ...
    @property
    @pulumi.getter(name="taggedOnly")
    def tagged_only(self) -> pulumi.Output[builtins.bool]:
        """
        Monitor only resources which have specified AWS tags (`true`) or all resources (`false`)
        """
        return pulumi.get(self, "tagged_only")
