...
class ServiceNamingOrder(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        - `terraform-provider-dynatrace -export ServiceNamingOrder` downloads an ordered list of service naming rule IDs
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            naming_rule_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'ServiceNamingOrder':
        """
