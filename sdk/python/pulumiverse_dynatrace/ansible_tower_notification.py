...
class AnsibleTowerNotificationArgs:
    def __init__(__self__, *,
                 custom_message: pulumi.Input[_builtins.str],
    ...
    def custom_message(self, value: pulumi.Input[_builtins.str]):
    ...
    def job_template_url(self, value: pulumi.Input[_builtins.str]):
