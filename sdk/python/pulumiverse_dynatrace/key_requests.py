...
class KeyRequestsArgs:
    def __init__(__self__, *,
                 ...
                 key_request_ids: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] service: ID of Dynatrace Service, eg. SERVICE-123ABC45678EFGH
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] key_request_ids: The ids of the key requests
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] names: The names of the key requests
        """
    ...
    def key_request_ids(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def key_request_ids(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class KeyRequests(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            key_request_ids: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            service: Optional[pulumi.Input[builtins.str]] = None) -> 'KeyRequests':
        """
    ...
    @property
    @pulumi.getter(name="keyRequestIds")
    def key_request_ids(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        The ids of the key requests
        """
        return pulumi.get(self, "key_request_ids")
