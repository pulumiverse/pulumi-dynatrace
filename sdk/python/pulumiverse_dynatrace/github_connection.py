...
class GithubConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: Possible Values: `pat`
        :param pulumi.Input[_builtins.str] name: The name of the GitHub connection
...
class GithubConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        - `terraform-provider-dynatrace -export GithubConnection` downloads all existing GitHub connections
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            token: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None) -> 'GithubConnection':
        """
