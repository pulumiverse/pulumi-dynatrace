...
class ActivegateUpdatesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] auto_update: Automatic updates at earliest convenience
        :param pulumi.Input[builtins.str] scope: The scope of this setting (ENVIRONMENT*ACTIVE*GATE). Omit this property if you want to cover the whole environment.
        """
...
class ActivegateUpdates(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            auto_update: Optional[pulumi.Input[builtins.bool]] = None,
            scope: Optional[pulumi.Input[builtins.str]] = None) -> 'ActivegateUpdates':
        """
