...
class ActivegateUpdatesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] auto_update: Automatic updates at earliest convenience
        :param pulumi.Input[str] scope: The scope of this setting (ENVIRONMENT*ACTIVE*GATE). Omit this property if you want to cover the whole environment.
        """
...
class ActivegateUpdates(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            auto_update: Optional[pulumi.Input[bool]] = None,
            scope: Optional[pulumi.Input[str]] = None) -> 'ActivegateUpdates':
        """
