...
class JsonDashboardBaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] contents: This attribute exists for backwards compatibility. You do not have to define it.
        """
...
class JsonDashboardBase(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            contents: Optional[pulumi.Input[builtins.str]] = None) -> 'JsonDashboardBase':
        """
    ...
    @property
    @pulumi.getter
    def contents(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This attribute exists for backwards compatibility. You do not have to define it.
        """
        return pulumi.get(self, "contents")
