...
class MaintenanceWindowArgs:
    def __init__(__self__, *,
                 suppression: pulumi.Input[builtins.str],
                 ...
                 suppress_synth_mon_exec: Optional[pulumi.Input[builtins.bool]] = None,
                 unknowns: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a MaintenanceWindow resource.
        :param pulumi.Input[builtins.str] suppression: The type of suppression of alerting and problem detection during the maintenance
        :param pulumi.Input[builtins.str] type: The type of the maintenance: planned or unplanned
        :param pulumi.Input[builtins.str] description: A short description of the maintenance purpose
        :param pulumi.Input[builtins.bool] enabled: The Maintenance Window is enabled or disabled
        :param pulumi.Input[builtins.str] name: The name of the maintenance window, displayed in the UI
        ...
        :param pulumi.Input[builtins.bool] suppress_synth_mon_exec: Suppress execution of synthetic monitors during the maintenance
    ...
    @property
    @pulumi.getter
    def suppression(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @suppression.setter
    def suppression(self, value: pulumi.Input[builtins.str]):
    ...
    def suppress_synth_mon_exec(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def suppress_synth_mon_exec(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _MaintenanceWindowState:
    def __init__(__self__, *,
                 ...
                 scope: Optional[pulumi.Input['MaintenanceWindowScopeArgs']] = None,
                 suppress_synth_mon_exec: Optional[pulumi.Input[builtins.bool]] = None,
                 suppression: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter
    def suppression(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of suppression of alerting and problem detection during the maintenance
        """
        return pulumi.get(self, "suppression")
    ...
    @suppression.setter
    def suppression(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "suppression", value)
...
class MaintenanceWindow(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            suppression: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            unknowns: Optional[pulumi.Input[builtins.str]] = None) -> 'MaintenanceWindow':
        """
    ...
    @property
    @pulumi.getter(name="suppressSynthMonExec")
    def suppress_synth_mon_exec(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Suppress execution of synthetic monitors during the maintenance
        """
        return pulumi.get(self, "suppress_synth_mon_exec")
    ...
    @property
    @pulumi.getter
    def suppression(self) -> pulumi.Output[builtins.str]:
        """
        The type of suppression of alerting and problem detection during the maintenance
        """
        return pulumi.get(self, "suppression")
