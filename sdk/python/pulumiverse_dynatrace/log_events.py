...
class LogEventsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] query: Log query
        :param pulumi.Input[builtins.str] summary: The textual summary of the log event entry
        """
...
@pulumi.type_token("dynatrace:index/logEvents:LogEvents")
class LogEvents(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            event_template: Optional[pulumi.Input[Union['LogEventsEventTemplateArgs', 'LogEventsEventTemplateArgsDict']]] = None,
            query: Optional[pulumi.Input[builtins.str]] = None,
            summary: Optional[pulumi.Input[builtins.str]] = None) -> 'LogEvents':
        """
