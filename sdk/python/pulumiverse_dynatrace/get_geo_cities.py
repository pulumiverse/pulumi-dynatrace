...
def get_geo_cities(country_code: Optional[_builtins.str] = None,
                   region_code: Optional[_builtins.str] = None,
    ...
    :param _builtins.str country_code: The ISO code of the required country
    :param _builtins.str region_code: The code of the required region
    """
    __args__ = dict()
