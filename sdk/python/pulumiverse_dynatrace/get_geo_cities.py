...
def get_geo_cities(country_code: Optional[builtins.str] = None,
                   region_code: Optional[builtins.str] = None,
    ...
    :param builtins.str region_code: The code of the required region
    """
    __args__ = dict()
...
def get_geo_cities_output(country_code: Optional[pulumi.Input[builtins.str]] = None,
