...
class NetworkMonitorArgs:
    def __init__(__self__, *,
                 ...
                 frequency_min: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] locations: The locations to which the monitor is assigned
        :param pulumi.Input[Sequence[pulumi.Input['NetworkMonitorStepArgs']]] steps: The steps of the monitor
        :param pulumi.Input[builtins.str] type: Type of the monitor, possible values: `MULTI_PROTOCOL`
        :param pulumi.Input[builtins.str] description: Description of the monitor
        :param pulumi.Input[builtins.bool] enabled: If true, the monitor is enabled
        :param pulumi.Input[builtins.int] frequency_min: Frequency of the monitor, in minutes
        :param pulumi.Input[builtins.str] name: Name of the monitor
    ...
    def frequency_min(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def frequency_min(self, value: Optional[pulumi.Input[builtins.int]]):
...
class NetworkMonitor(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            steps: Optional[pulumi.Input[Sequence[pulumi.Input[Union['NetworkMonitorStepArgs', 'NetworkMonitorStepArgsDict']]]]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[Union['NetworkMonitorTagArgs', 'NetworkMonitorTagArgsDict']]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkMonitor':
        """
    ...
    @property
    @pulumi.getter(name="frequencyMin")
    def frequency_min(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Frequency of the monitor, in minutes
        """
        return pulumi.get(self, "frequency_min")
