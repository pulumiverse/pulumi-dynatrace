...
class GetApiTokenResult:
    ...
    def personal_access_token(self) -> builtins.bool:
        """
...
def get_api_token(name: Optional[builtins.str] = None,
...
def get_api_token_output(name: Optional[pulumi.Input[builtins.str]] = None,
