...
class RumHostHeadersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] header_name: HTTP header format
...
class RumHostHeaders(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        - `terraform-provider-dynatrace -export RumHostHeaders` downloads all existing host name HTTP request header configuration
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            header_name: Optional[pulumi.Input[_builtins.str]] = None,
            insert_after: Optional[pulumi.Input[_builtins.str]] = None) -> 'RumHostHeaders':
        """
