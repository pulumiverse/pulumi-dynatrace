...
__all__ = ['DiskAnalyticsArgs', 'DiskAnalytics']

@pulumi.input_type
class DiskAnalyticsArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[builtins.bool],
                 scope: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a DiskAnalytics resource.
        :param pulumi.Input[builtins.bool] enabled: The Disk Analytics feature requires an extension to be added to your environment. The Disk Analytics extension consumes custom metrics and [Davis data units](https://www.dynatrace.com/support/help/shortlink/metric-cost-calculation).
        :param pulumi.Input[builtins.str] scope: The scope of this setting (HOST, HOST_GROUP)
        """
...
class DiskAnalytics(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DiskAnalyticsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DiskAnalyticsArgs.__new__(DiskAnalyticsArgs)
        ...
        super(DiskAnalytics, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            enabled: Optional[pulumi.Input[builtins.bool]] = None,
            scope: Optional[pulumi.Input[builtins.str]] = None) -> 'DiskAnalytics':
        """
        ...
        __props__ = _DiskAnalyticsState.__new__(_DiskAnalyticsState)

        __props__.__dict__["enabled"] = enabled
        __props__.__dict__["scope"] = scope
        return DiskAnalytics(resource_name, opts=opts, __props__=__props__)
