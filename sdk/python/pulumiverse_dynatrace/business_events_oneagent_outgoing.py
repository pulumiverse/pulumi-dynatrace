...
@pulumi.type_token("dynatrace:index/businessEventsOneagentOutgoing:BusinessEventsOneagentOutgoing")
class BusinessEventsOneagentOutgoing(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.bool] enabled: This setting is enabled (`true`) or disabled (`false`)
        :param pulumi.Input[Union['BusinessEventsOneagentOutgoingEventArgs', 'BusinessEventsOneagentOutgoingEventArgsDict']] event: Event meta data
        :param pulumi.Input[_builtins.str] insert_after: Because this resource allows for ordering you may specify the ID of the resource instance that comes before this instance regarding order. If not specified when creating the setting will be added to the end of the list. If not specified during update the order will remain untouched
        :param pulumi.Input[_builtins.str] rule_name: Rule name
        :param pulumi.Input[_builtins.str] scope: The scope of this setting (HOST, HOST_GROUP). Omit this property if you want to cover the whole environment.
