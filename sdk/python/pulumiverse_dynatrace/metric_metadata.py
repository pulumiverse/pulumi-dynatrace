...
class MetricMetadataArgs:
    def __init__(__self__, *,
                 ...
                 source_entity_type: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 unit_display_format: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a MetricMetadata resource.
        :param pulumi.Input[builtins.str] metric_id: The scope of this setting (metric)
        :param pulumi.Input[builtins.str] unit: Unit
        ...
        :param pulumi.Input[builtins.str] source_entity_type: Specifies which entity dimension should be used as the primary dimension. The property can only be configured for metrics ingested with the Metrics API.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: Tags
        :param pulumi.Input[builtins.str] unit_display_format: The raw value is stored in bits or bytes. The user interface can display it in these numeral systems:
        """
    ...
    def source_entity_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_entity_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def unit_display_format(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def unit_display_format(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("dynatrace:index/metricMetadata:MetricMetadata")
class MetricMetadata(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            unit: Optional[pulumi.Input[builtins.str]] = None,
            unit_display_format: Optional[pulumi.Input[builtins.str]] = None) -> 'MetricMetadata':
        """
    ...
    @property
    @pulumi.getter(name="sourceEntityType")
    def source_entity_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies which entity dimension should be used as the primary dimension. The property can only be configured for metrics ingested with the Metrics API.
        """
        return pulumi.get(self, "source_entity_type")
    ...
    @property
    @pulumi.getter(name="unitDisplayFormat")
    def unit_display_format(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The raw value is stored in bits or bytes. The user interface can display it in these numeral systems:
        """
        return pulumi.get(self, "unit_display_format")
