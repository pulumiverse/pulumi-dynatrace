...
class DashboardSharingArgs:
    def __init__(__self__, *,
                 ...
                 preset: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] dashboard_id: The Dynatrace entity ID of the dashboard
        :param pulumi.Input[builtins.bool] enabled: The dashboard is shared (`true`) or private (`false`). Make sure that this value is aligned with the attribute `shared` of the resources `Dashboard` and `JsonDashboard`. Otherwise you will encounter non-empty plans.
        :param pulumi.Input['DashboardSharingPermissionsArgs'] permissions: Access permissions of the dashboard
        :param pulumi.Input[builtins.bool] preset: If `true` the dashboard will be marked as preset. Setting this attribute to `true` will automatically enforce a specific set of permissions - Dashboards flagged as Preset are shared by default. Make sure that this value is aligned with the attribute `preset` of the resources `Dashboard` and `JsonDashboard`. Otherwise you will encounter non-empty plans.
    ...
    @property
    @pulumi.getter
    def preset(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @preset.setter
    def preset(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _DashboardSharingState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] dashboard_id: The Dynatrace entity ID of the dashboard
        :param pulumi.Input[builtins.bool] enabled: The dashboard is shared (`true`) or private (`false`). Make sure that this value is aligned with the attribute `shared` of the resources `Dashboard` and `JsonDashboard`. Otherwise you will encounter non-empty plans.
        :param pulumi.Input[builtins.bool] muted: Reserved for internal use by the provider
        :param pulumi.Input['DashboardSharingPermissionsArgs'] permissions: Access permissions of the dashboard
        :param pulumi.Input[builtins.bool] preset: If `true` the dashboard will be marked as preset. Setting this attribute to `true` will automatically enforce a specific set of permissions - Dashboards flagged as Preset are shared by default. Make sure that this value is aligned with the attribute `preset` of the resources `Dashboard` and `JsonDashboard`. Otherwise you will encounter non-empty plans.
        :param pulumi.Input['DashboardSharingPublicArgs'] public: Configuration of the [anonymous access](https://dt-url.net/ov03sf1) to the dashboard
        """
...
@pulumi.type_token("dynatrace:index/dashboardSharing:DashboardSharing")
class DashboardSharing(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def muted(self) -> pulumi.Output[builtins.bool]:
        """
        Reserved for internal use by the provider
        """
        return pulumi.get(self, "muted")
    ...
    @property
    @pulumi.getter
    def preset(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If `true` the dashboard will be marked as preset. Setting this attribute to `true` will automatically enforce a specific set of permissions - Dashboards flagged as Preset are shared by default. Make sure that this value is aligned with the attribute `preset` of the resources `Dashboard` and `JsonDashboard`. Otherwise you will encounter non-empty plans.
        """
        return pulumi.get(self, "preset")
