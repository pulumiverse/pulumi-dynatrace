...
def get_dql_output(default_sampling_ratio: pulumi.Input[Optional[Optional[_builtins.float]]] = None,
                   default_scan_limit_gbytes: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                   default_timeframe_end: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                   default_timeframe_start: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                   fetch_timeout_seconds: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                   locale: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                   max_result_bytes: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                   max_result_records: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
