...
class ProcessgroupNamingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enabled: The rule is enabled (`true`) or disabled (`false`)
        :param pulumi.Input[builtins.str] format: The name to be assigned to matching entities. You can use the following placeholders here: *
...
@pulumi.type_token("dynatrace:index/processgroupNaming:ProcessgroupNaming")
class ProcessgroupNaming(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 conditions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ProcessgroupNamingConditionArgs', 'ProcessgroupNamingConditionArgsDict']]]]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 format: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 unknowns: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['ProcessgroupNamingConditionArgs', 'ProcessgroupNamingConditionArgsDict']]]] conditions: A list of matching conditions of the rule. The rule applies only if **all** conditions are fulfilled
        :param pulumi.Input[builtins.bool] enabled: The rule is enabled (`true`) or disabled (`false`)
        :param pulumi.Input[builtins.str] format: The name to be assigned to matching entities. You can use the following placeholders here: *
               `{AwsAutoScalingGroup:Name}` * `{AwsAvailabilityZone:Name}` * `{AwsElasticLoadBalancer:Name}` *
               `{AwsRelationalDatabaseService:DBName}` * `{AwsRelationalDatabaseService:Endpoint}` *
    ...
    def get(resource_name: str,
            ...
            format: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            unknowns: Optional[pulumi.Input[builtins.str]] = None) -> 'ProcessgroupNaming':
        """
