...
class ProcessgroupNaming(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        - `terraform-provider-dynatrace -export ProcessgroupNaming` downloads all existing process group naming configuration
    ...
    def get(resource_name: str,
            ...
            format: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            unknowns: Optional[pulumi.Input[_builtins.str]] = None) -> 'ProcessgroupNaming':
        """
