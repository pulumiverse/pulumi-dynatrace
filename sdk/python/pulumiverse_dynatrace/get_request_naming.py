...
__all__ = [
    'GetRequestNamingResult',
    'AwaitableGetRequestNamingResult',
    'get_request_naming',
    'get_request_naming_output',
]

@pulumi.output_type
class GetRequestNamingResult:
    """
...
class AwaitableGetRequestNamingResult(GetRequestNamingResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRequestNamingResult(
            id=self.id,
            name=self.name)


def get_request_naming(name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('dynatrace:index/getRequestNaming:getRequestNaming', __args__, opts=opts, typ=GetRequestNamingResult).value

    return AwaitableGetRequestNamingResult(
        id=pulumi.get(__ret__, 'id'),
        name=pulumi.get(__ret__, 'name'))
def get_request_naming_output(name: Optional[pulumi.Input[builtins.str]] = None,
