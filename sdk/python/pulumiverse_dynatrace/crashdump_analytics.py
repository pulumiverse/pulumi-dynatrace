...
class CrashdumpAnalyticsArgs:
    def __init__(__self__, *,
                 enable_crash_dump_analytics: pulumi.Input[builtins.bool],
                 host_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a CrashdumpAnalytics resource.
        :param pulumi.Input[builtins.bool] enable_crash_dump_analytics: Disable the feature to stop receiving information about crash details and potential problems. We recommend keeping the feature enabled.
        :param pulumi.Input[builtins.str] host_id: The scope of this setting (HOST HOST_GROUP environment)
        """
    ...
    def enable_crash_dump_analytics(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def enable_crash_dump_analytics(self, value: pulumi.Input[builtins.bool]):
...
class _CrashdumpAnalyticsState:
    def __init__(__self__, *,
                 enable_crash_dump_analytics: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="enableCrashDumpAnalytics")
    def enable_crash_dump_analytics(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Disable the feature to stop receiving information about crash details and potential problems. We recommend keeping the feature enabled.
        """
        return pulumi.get(self, "enable_crash_dump_analytics")
    ...
    @enable_crash_dump_analytics.setter
    def enable_crash_dump_analytics(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_crash_dump_analytics", value)
...
class CrashdumpAnalytics(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            enable_crash_dump_analytics: Optional[pulumi.Input[builtins.bool]] = None,
            host_id: Optional[pulumi.Input[builtins.str]] = None) -> 'CrashdumpAnalytics':
        """
    ...
    @property
    @pulumi.getter(name="enableCrashDumpAnalytics")
    def enable_crash_dump_analytics(self) -> pulumi.Output[builtins.bool]:
        """
        Disable the feature to stop receiving information about crash details and potential problems. We recommend keeping the feature enabled.
        """
        return pulumi.get(self, "enable_crash_dump_analytics")
