...
class DiskAnomaliesArgs:
    def __init__(__self__, *,
                 ...
                 samples: pulumi.Input[builtins.int],
                 threshold: pulumi.Input[builtins.float],
                 violating_samples: pulumi.Input[builtins.int],
        ...
        :param pulumi.Input[builtins.bool] enabled: Disk event rule enabled/disabled
        :param pulumi.Input[builtins.str] metric: The metric to monitor. Possible values are: `LOW_DISK_SPACE`, `LOW_INODES`, `READ_TIME_EXCEEDING` and `WRITE_TIME_EXCEEDING`
        :param pulumi.Input[builtins.int] samples: The number of samples to evaluate
        :param pulumi.Input[builtins.float] threshold: The threshold to trigger disk event.   * A percentage for `LowDiskSpace` or `LowInodes` metrics.   * In milliseconds for `ReadTimeExceeding` or `WriteTimeExceeding` metrics
        :param pulumi.Input[builtins.int] violating_samples: The number of samples that must violate the threshold to trigger an event. Must not exceed the number of evaluated samples
        ...
        :param pulumi.Input[builtins.str] host_group_id: Narrows the rule usage down to disks that run on hosts that themselves run on the specified host group
        :param pulumi.Input[builtins.str] name: The name of the disk event rule
    ...
    @property
    @pulumi.getter
    def samples(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @samples.setter
    def samples(self, value: pulumi.Input[builtins.int]):
    ...
    def violating_samples(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def violating_samples(self, value: pulumi.Input[builtins.int]):
...
class _DiskAnomaliesState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 samples: Optional[pulumi.Input[builtins.int]] = None,
                 tags: Optional[pulumi.Input['DiskAnomaliesTagsArgs']] = None,
                 threshold: Optional[pulumi.Input[builtins.float]] = None,
                 violating_samples: Optional[pulumi.Input[builtins.int]] = None):
        """
    ...
    @property
    @pulumi.getter
    def samples(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of samples to evaluate
        """
        return pulumi.get(self, "samples")
    ...
    @samples.setter
    def samples(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "samples", value)
    ...
    @property
    @pulumi.getter(name="violatingSamples")
    def violating_samples(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of samples that must violate the threshold to trigger an event. Must not exceed the number of evaluated samples
        """
        return pulumi.get(self, "violating_samples")
    ...
    @violating_samples.setter
    def violating_samples(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "violating_samples", value)
...
class DiskAnomalies(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Union['DiskAnomaliesTagsArgs', 'DiskAnomaliesTagsArgsDict']]] = None,
            threshold: Optional[pulumi.Input[builtins.float]] = None,
            violating_samples: Optional[pulumi.Input[builtins.int]] = None) -> 'DiskAnomalies':
        """
    ...
    @property
    @pulumi.getter
    def samples(self) -> pulumi.Output[builtins.int]:
        """
        The number of samples to evaluate
        """
        return pulumi.get(self, "samples")
    ...
    @property
    @pulumi.getter(name="violatingSamples")
    def violating_samples(self) -> pulumi.Output[builtins.int]:
        """
        The number of samples that must violate the threshold to trigger an event. Must not exceed the number of evaluated samples
        """
        return pulumi.get(self, "violating_samples")
