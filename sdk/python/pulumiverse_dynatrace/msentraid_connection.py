...
class MsentraidConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] directory_id: Directory (tenant) ID of Microsoft Entra Identity Developer
        :param pulumi.Input[_builtins.str] description: Description
        :param pulumi.Input[_builtins.str] name: The name of the Microsoft Entra Identity Developer connection
        """
...
class MsentraidConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[_builtins.str]] = None,
            directory_id: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None) -> 'MsentraidConnection':
        """
