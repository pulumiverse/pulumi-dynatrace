...
class CalculatedServiceMetricArgs:
    def __init__(__self__, *,
                 ...
                 ignore_muted_requests: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 unit_display_name: Optional[pulumi.Input[builtins.str]] = None,
                 unknowns: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a CalculatedServiceMetric resource.
        :param pulumi.Input[builtins.str] metric_key: The key of the calculated service metric
        :param pulumi.Input[builtins.str] unit: The unit of the metric. Possible values are `BIT`, `BIT_PER_HOUR`, `BIT_PER_MINUTE`, `BIT_PER_SECOND`, `BYTE`,
        ...
        :param pulumi.Input[builtins.str] description: The displayed description of the metric
        ...
        :param pulumi.Input[builtins.str] entity_id: Restricts the metric usage to the specified service. This field is mutually exclusive with the `management_zones` field
        :param pulumi.Input[builtins.bool] ignore_muted_requests: Metric should (true) or not (false) ignore muted requests.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] management_zones: Restricts the metric usage to specified management zones. This field is mutually exclusive with the `entity_id` field
        ...
        :param pulumi.Input[builtins.str] unit_display_name: The display name of the metric's unit. Only applicable when the **unit** parameter is set to `UNSPECIFIED`
    ...
    def ignore_muted_requests(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ignore_muted_requests(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def unit_display_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def unit_display_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CalculatedServiceMetric(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            unit: Optional[pulumi.Input[builtins.str]] = None,
            unit_display_name: Optional[pulumi.Input[builtins.str]] = None,
            unknowns: Optional[pulumi.Input[builtins.str]] = None) -> 'CalculatedServiceMetric':
        """
    ...
    @property
    @pulumi.getter(name="ignoreMutedRequests")
    def ignore_muted_requests(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Metric should (true) or not (false) ignore muted requests.
        """
        return pulumi.get(self, "ignore_muted_requests")
    ...
    @property
    @pulumi.getter(name="unitDisplayName")
    def unit_display_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The display name of the metric's unit. Only applicable when the **unit** parameter is set to `UNSPECIFIED`
        """
        return pulumi.get(self, "unit_display_name")
