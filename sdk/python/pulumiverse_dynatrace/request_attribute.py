...
class RequestAttributeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] skip_personal_data_masking: Personal data masking flag. Set `true` to skip masking.   Warning: This will potentially access personalized data
    ...
    @_builtins.property
    @pulumi.getter
    def normalization(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def normalization(self, value: pulumi.Input[_builtins.str]):
...
class RequestAttribute(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def normalization(self) -> pulumi.Output[_builtins.str]:
        """
        String values transformation.   If the **dataType** is not `string`, set the `Original` here
        """
        return pulumi.get(self, "normalization")
    ...
    @_builtins.property
    @pulumi.getter(name="skipPersonalDataMasking")
    def skip_personal_data_masking(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Personal data masking flag. Set `true` to skip masking.   Warning: This will potentially access personalized data
        """
        return pulumi.get(self, "skip_personal_data_masking")
