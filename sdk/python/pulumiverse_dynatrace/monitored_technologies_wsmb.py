...
class MonitoredTechnologiesWsmb(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        - `terraform-provider-dynatrace -export MonitoredTechnologiesWsmb` downloads all existing IBM Integration Bus | IBM App Connect Enterprise monitoring configuration
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            enabled: Optional[pulumi.Input[_builtins.bool]] = None,
            host_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'MonitoredTechnologiesWsmb':
        """
