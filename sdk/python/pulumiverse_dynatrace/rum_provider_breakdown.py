...
class RumProviderBreakdownArgs:
    def __init__(__self__, *,
                 ...
                 report_public_improvement: pulumi.Input[builtins.bool],
        ...
        :param pulumi.Input[builtins.bool] report_public_improvement: Send the patterns of this provider to Dynatrace to help us improve 3rd-party detection.
        :param pulumi.Input[builtins.str] resource_name: Resource name
        :param pulumi.Input[builtins.str] resource_type: Possible Values: `FirstParty`, `ThirdParty`, `Cdn`
        :param pulumi.Input[builtins.str] icon_url: Specify an URL for the provider's brand icon
    ...
    def report_public_improvement(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def report_public_improvement(self, value: pulumi.Input[builtins.bool]):
...
class _RumProviderBreakdownState:
    def __init__(__self__, *,
                 ...
                 icon_url: Optional[pulumi.Input[builtins.str]] = None,
                 insert_after: Optional[pulumi.Input[builtins.str]] = None,
                 report_public_improvement: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="reportPublicImprovement")
    def report_public_improvement(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Send the patterns of this provider to Dynatrace to help us improve 3rd-party detection.
        """
        return pulumi.get(self, "report_public_improvement")
    ...
    @report_public_improvement.setter
    def report_public_improvement(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "report_public_improvement", value)
...
class RumProviderBreakdown(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            report_public_improvement: Optional[pulumi.Input[builtins.bool]] = None,
            resource_name_: Optional[pulumi.Input[builtins.str]] = None,
            resource_type: Optional[pulumi.Input[builtins.str]] = None) -> 'RumProviderBreakdown':
        """
    ...
    @property
    @pulumi.getter(name="reportPublicImprovement")
    def report_public_improvement(self) -> pulumi.Output[builtins.bool]:
        """
        Send the patterns of this provider to Dynatrace to help us improve 3rd-party detection.
        """
        return pulumi.get(self, "report_public_improvement")
