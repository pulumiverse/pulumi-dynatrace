...
class IamPolicyBindingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] policies: A list of IDs referring to policies bound to that group. It's not possible to mix policies here that are defined for different scopes (different accounts or environments) than specified via attributes `account` or `environment`.
        :param pulumi.Input[builtins.str] account: The UUID of the account (`urn:dtaccount:<account-uuid>`). The attribute `policies` must contain ONLY policies defined for that account. The prefix `urn:dtaccount:` MUST be omitted here.
        :param pulumi.Input[builtins.str] environment: The ID of the environment (https://\\n\\n.live.dynatrace.com). The attribute `policies` must contain ONLY policies defined for that environment.
        """
...
@pulumi.type_token("dynatrace:index/iamPolicyBindings:IamPolicyBindings")
class IamPolicyBindings(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            environment: Optional[pulumi.Input[builtins.str]] = None,
            group: Optional[pulumi.Input[builtins.str]] = None,
            policies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'IamPolicyBindings':
        """
