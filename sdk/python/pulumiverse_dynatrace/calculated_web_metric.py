...
class CalculatedWebMetricArgs:
    def __init__(__self__, *,
                 app_identifier: pulumi.Input[_builtins.str],
    ...
    def app_identifier(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def app_identifier(self, value: pulumi.Input[_builtins.str]):
...
class CalculatedWebMetric(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="appIdentifier")
    def app_identifier(self) -> pulumi.Output[_builtins.str]:
        """
        The Dynatrace entity ID of the application to which the metric belongs.
        """
        return pulumi.get(self, "app_identifier")
